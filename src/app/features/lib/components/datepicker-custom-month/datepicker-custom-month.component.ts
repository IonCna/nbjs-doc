...
export class DatepickerCustomMonthComponent implements IComponentController {
    ...
    static get $factory(): IComponentOptions { return { controller: DatepickerCustomMonthComponent, controllerAs: "example", templateUrl: "./datepicker-custom-month.component.html" } }
}
