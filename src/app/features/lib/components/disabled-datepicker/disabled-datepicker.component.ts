...
export class DisabledDatepickerComponent implements IComponentController {
    ...
    static get $factory(): IComponentOptions { return { controller: DisabledDatepickerComponent, controllerAs: "example", templateUrl: "./disabled-datepicker.component.html" } }
}
