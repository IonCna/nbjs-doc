...
`),e.put(`src/app/features/lib/pages/typeahead-examples-page/typeahead-examples-page.component.html`,`<docs-example-section fragment="simple-typeahead" title="Simple Typeahead" description="Debounce a local string search, require two characters and limit the result set." html-code="$.examples.simple.html" ts-code="$.examples.simple.typescript">\r
    <docs-simple-typeahead></docs-simple-typeahead>\r
</docs-example-section>\r
\r
<docs-example-section fragment="focus-typeahead" title="Open on focus" description="Merge an explicit focus stream with user input so an empty field can display suggestions immediately." html-code="$.examples.focus.html" ts-code="$.examples.focus.typescript">\r
    <docs-focus-typeahead></docs-focus-typeahead>\r
</docs-example-section>\r
\r
<docs-example-section fragment="formatted-typeahead" title="Formatted results" description="Transform result labels without changing the selected model value." html-code="$.examples.formatted.html" ts-code="$.examples.formatted.typescript">\r
    <docs-formatted-typeahead></docs-formatted-typeahead>\r
</docs-example-section>\r
\r
<docs-example-section fragment="exact-typeahead" title="Select on exact" description="Select an object automatically when its formatted label is the only exact match." html-code="$.examples.exact.html" ts-code="$.examples.exact.typescript">\r
    <docs-exact-typeahead></docs-exact-typeahead>\r
</docs-example-section>\r
\r
<docs-example-section fragment="wikipedia-typeahead" title="Wikipedia search" description="Retrieve remote suggestions through AngularJS $http with debounce, stale-response switching and error feedback." html-code="$.examples.wikipedia.html" ts-code="$.examples.wikipedia.typescript">\r
    <docs-wikipedia-typeahead></docs-wikipedia-typeahead>\r
</docs-example-section>\r
\r
<docs-example-section fragment="template-results-typeahead" title="Template for results" description="Render object results with a custom template, contextual term highlighting and additional metadata." html-code="$.examples.templateResults.html" ts-code="$.examples.templateResults.typescript">\r
    <docs-template-results-typeahead></docs-template-results-typeahead>\r
</docs-example-section>\r
\r
<docs-example-section fragment="non-editable-typeahead" title="Prevent manual entry" description="Keep the model null until the user chooses a valid object from the suggestion list." html-code="$.examples.nonEditable.html" ts-code="$.examples.nonEditable.typescript">\r
    <docs-non-editable-typeahead></docs-non-editable-typeahead>\r
</docs-example-section>\r
\r
<docs-example-section fragment="typeahead-global" title="Global configuration of typeaheads" description="Configure hint completion, exact selection and body container defaults through NgbTypeaheadConfig." html-code="$.examples.global.html" ts-code="$.examples.global.typescript">\r
    <docs-typeahead-global></docs-typeahead-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/tooltip-examples-page/tooltip-examples-page.component.html`,`<docs-example-section fragment="tooltip-placements" title="Quick and easy tooltips" description="Use the four primary Bootstrap placements with the default hover and focus triggers." html-code="$.examples.placements.html" ts-code="$.examples.placements.typescript">\r
    <docs-tooltip-placements></docs-tooltip-placements>\r
</docs-example-section>\r
\r
<docs-example-section fragment="tooltip-template" title="HTML and bindings in tooltips" description="Render an ng-template as tooltip content and keep its bindings synchronized." html-code="$.examples.template.html" ts-code="$.examples.template.typescript">\r
    <docs-tooltip-template></docs-tooltip-template>\r
</docs-example-section>\r
\r
<docs-example-section fragment="tooltip-triggers" title="Custom and manual triggers" description="Pair custom DOM events or control a tooltip directly through its public controller." html-code="$.examples.triggers.html" ts-code="$.examples.triggers.typescript">\r
    <docs-tooltip-triggers></docs-tooltip-triggers>\r
</docs-example-section>\r
\r
<docs-example-section fragment="tooltip-autoclose" title="Automatic closing with keyboard and mouse" description="Compare inside, outside and all-click closing while preserving Escape keyboard support." html-code="$.examples.autoclose.html" ts-code="$.examples.autoclose.typescript">\r
    <docs-tooltip-autoclose></docs-tooltip-autoclose>\r
</docs-example-section>\r
\r
<docs-example-section fragment="tooltip-context" title="Context and manual triggers" description="Pass template context at open time or provide a default tooltip-context." html-code="$.examples.context.html" ts-code="$.examples.context.typescript">\r
    <docs-tooltip-context></docs-tooltip-context>\r
</docs-example-section>\r
\r
<docs-example-section fragment="tooltip-custom-target" title="Custom target" description="Trigger the tooltip from one element while positioning it against another." html-code="$.examples.customTarget.html" ts-code="$.examples.customTarget.typescript">\r
    <docs-tooltip-custom-target></docs-tooltip-custom-target>\r
</docs-example-section>\r
\r
<docs-example-section fragment="tooltip-delays" title="Open and close delays" description="Delay opening and closing while allowing the pointer to move safely into the tooltip." html-code="$.examples.delays.html" ts-code="$.examples.delays.typescript">\r
    <docs-tooltip-delays></docs-tooltip-delays>\r
</docs-example-section>\r
\r
<docs-example-section fragment="tooltip-body" title="Append tooltip in the body" description="Escape a clipping container by appending the tooltip window directly to document.body." html-code="$.examples.body.html" ts-code="$.examples.body.typescript">\r
    <docs-tooltip-body></docs-tooltip-body>\r
</docs-example-section>\r
\r
<docs-example-section fragment="tooltip-custom-class" title="Tooltip with custom class" description="Apply a small custom theme through Bootstrap tooltip variables." html-code="$.examples.customClass.html" ts-code="$.examples.customClass.typescript" css-code="$.examples.customClass.css">\r
    <docs-tooltip-custom-class></docs-tooltip-custom-class>\r
</docs-example-section>\r
\r
<docs-example-section fragment="tooltip-global" title="Global configuration of tooltips" description="Set shared container, placement, trigger and delay defaults through NgbTooltipConfig." html-code="$.examples.global.html" ts-code="$.examples.global.typescript">\r
    <docs-tooltip-global></docs-tooltip-global>\r
</docs-example-section>\r
`),e.put(`src/app/shared/components/page-outline/page-outline.component.html`,`<aside class="position-sticky top-0 px-4 py-4">\r
    <nav ngb-scroll-spy-menu aria-label="On this page">\r
        <h2 class="small fw-semibold text-body-secondary mb-2">On this page</h2>\r
\r
        <div class="nav nav-underline flex-column align-items-start">\r
            <button\r
                class="nav-link rounded-0 px-0 py-1 text-start small"\r
                type="button"\r
                ng-repeat="section in $.sections track by section.id"\r
                ngb-scroll-spy-item="{{ section.id }}">\r
                {{ section.name }}\r
            </button>\r
        </div>\r
    </nav>\r
\r
    <div ng-if="$.bootstrapHref || $.ngBootstrapHref">\r
        <hr class="my-3">\r
\r
        <h2 class="small fw-semibold text-body-secondary mb-2">Official references</h2>\r
\r
        <nav class="nav flex-column" aria-label="Related documentation">\r
            <a\r
                class="nav-link d-flex align-items-center gap-2 px-0 py-1 small"\r
                ng-if="$.bootstrapHref"\r
                ng-href="{{ $.bootstrapHref }}"\r
                target="_blank"\r
                rel="noopener noreferrer">\r
                <span>Bootstrap documentation</span>\r
                <i class="bi bi-box-arrow-up-right small" aria-hidden="true"></i>\r
            </a>\r
\r
            <a\r
                class="nav-link d-flex align-items-center gap-2 px-0 py-1 small"\r
                ng-if="$.ngBootstrapHref"\r
                ng-href="{{ $.ngBootstrapHref }}"\r
                target="_blank"\r
                rel="noopener noreferrer">\r
                <span>ng-bootstrap documentation</span>\r
                <i class="bi bi-box-arrow-up-right small" aria-hidden="true"></i>\r
            </a>\r
        </nav>\r
    </div>\r
</aside>\r
`),e.put(`src/app/features/lib/pages/typeahead-api-page/typeahead-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-typeahead">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbTypeahead</code></h2><p class="text-body-secondary mb-0">Connects an input to an observable result source and manages the suggestion popup.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;input ng-model="value" ngb-typeahead="search"&gt;</code></dd><dt class="col-sm-3 fw-semibold">Requires</dt><dd class="col-sm-9 mb-0"><code>ng-model</code>.</dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Default</th><th>Description</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>ngb-typeahead</code></td><td><code>&lt;?</code></td><td>Required</td><td>Function that maps the text stream to an observable result collection.</td></tr>\r
            <tr><td><code>autocomplete</code></td><td><code>&lt;?</code></td><td>—</td><td>Sets the native autocomplete behavior.</td></tr>\r
            <tr><td><code>container</code></td><td><code>&lt;?</code></td><td><code>$config.container</code></td><td>Container used for the popup.</td></tr>\r
            <tr><td><code>editable</code></td><td><code>&lt;?</code></td><td><code>true</code></td><td>Allows values not present in the results.</td></tr>\r
            <tr><td><code>focus-first</code></td><td><code>&lt;?</code></td><td><code>true</code></td><td>Activates the first result when the popup opens.</td></tr>\r
            <tr><td><code>input-formatter</code></td><td><code>&lt;?</code></td><td>String conversion</td><td>Formats the selected model in the input.</td></tr>\r
            <tr><td><code>result-formatter</code></td><td><code>&lt;?</code></td><td>String conversion</td><td>Formats values in the result list.</td></tr>\r
            <tr><td><code>result-template</code></td><td><code>&lt;?</code></td><td>Default result</td><td>Provides custom result markup.</td></tr>\r
            <tr><td><code>placement</code></td><td><code>&lt;?</code></td><td><code>$config.placement</code></td><td>Preferred Popper placements.</td></tr>\r
            <tr><td><code>popper-options</code></td><td><code>&lt;?</code></td><td><code>$config.popperOptions</code></td><td>Transforms Popper options.</td></tr>\r
            <tr><td><code>popup-class</code></td><td><code>&lt;?</code></td><td>—</td><td>Adds a class to the results popup.</td></tr>\r
            <tr><td><code>select-on-exact</code></td><td><code>&lt;?</code></td><td><code>false</code></td><td>Selects automatically when only one exact result exists.</td></tr>\r
            <tr><td><code>show-hint</code></td><td><code>&lt;?</code></td><td><code>false</code></td><td>Shows the completion hint.</td></tr>\r
        </tbody>\r
    </table></div>\r
    <h3 class="h5 mt-4 mb-3">Outputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead><tbody>\r
        <tr><td><code>select-item</code></td><td><code>&amp;?</code></td><td><code>$event: NgbTypeaheadSelectItemEvent</code></td><td>A result is selected.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-highlight">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Component</p><h2 class="h3 mb-2"><code class="text-body">NgbHighlight</code></h2><p class="text-body-secondary mb-0">Highlights matching portions of a result label.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ngb-highlight result="label" term="query"&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>result</code></td><td><code>&lt;</code></td><td><code>string</code></td><td>Required</td></tr>\r
        <tr><td><code>term</code></td><td><code>&lt;</code></td><td><code>string</code></td><td>Required</td></tr>\r
        <tr><td><code>highlight-class</code></td><td><code>&lt;?</code></td><td><code>string</code></td><td><code>"ngb-highlight"</code></td></tr>\r
        <tr><td><code>accent-sensitive</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-typeahead-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbTypeaheadConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide typeahead defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>container</code></td><td><code>undefined</code></td></tr>\r
        <tr><td><code>editable</code>, <code>focusFirst</code></td><td><code>true</code></td></tr>\r
        <tr><td><code>selectOnExact</code>, <code>showHint</code></td><td><code>false</code></td></tr>\r
        <tr><td><code>placement</code></td><td><code>["bottom-start", "bottom-end", "top-start", "top-end"]</code></td></tr>\r
        <tr><td><code>popperOptions</code></td><td>Identity transform</td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/shared/components/copy-button/copy-button.component.html`,`<ng-template ng-ref="copyTooltip">\r
    <span>{{ copyButton.copied ? "Copied" : "Copy to clipboard" }}</span>\r
</ng-template>\r
\r
<button\r
    type="button"\r
    class="btn btn-link d-inline-flex align-items-center justify-content-center p-2 lh-1 {{ copyButton.buttonClass }}"\r
    ng-click="copyButton.copy()"\r
    ngb-tooltip="copyTooltip"\r
    placement="'top'"\r
    ng-attr-aria-label="{{ copyButton.copied ? 'Copied' : (copyButton.ariaLabel || 'Copy to clipboard') }}">\r
    <i\r
        class="bi fs-5"\r
        ng-class="copyButton.copied ? 'bi-check-lg text-success' : 'bi-clipboard'"\r
        aria-hidden="true">\r
    </i>\r
</button>\r
`),e.put(`src/app/shared/components/example-section/example-section.component.html`,`<section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="{{ example.fragment }}">\r
    <header class="d-flex align-items-start justify-content-between gap-3 mb-4">\r
        <div>\r
            <h2 class="h3 mb-2">{{ example.title }}</h2>\r
            <p class="text-body-secondary mb-0">{{ example.description }}</p>\r
        </div>\r
\r
        <button\r
            type="button"\r
            class="btn btn-outline-secondary btn-sm d-inline-flex align-items-center gap-2 flex-shrink-0"\r
            ng-click="example.toggleCode()"\r
            ng-attr-aria-expanded="{{ !example.codeCollapsed }}"\r
            ng-attr-aria-controls="{{ example.fragment }}-code">\r
            <i class="bi bi-code-slash" aria-hidden="true"></i>\r
            <span>{{ example.codeCollapsed ? 'View code' : 'Hide code' }}</span>\r
        </button>\r
    </header>\r
\r
...
\r
    <div\r
        class="mt-4"\r
        ngb-collapse="example.codeCollapsed"\r
        ng-attr-id="{{ example.fragment }}-code">\r
        <div class="border rounded-3 overflow-hidden">\r
            <div ng-if="!example.hasAdditionalCode">\r
                <div class="d-flex align-items-center justify-content-between bg-body-tertiary border-bottom ps-3 pe-2 py-1">\r
                    <span class="small fw-semibold">HTML</span>\r
                    <docs-copy-button\r
                        value="example.htmlCode"\r
                        button-class="text-body-secondary"\r
                        aria-label="Copy HTML code">\r
                    </docs-copy-button>\r
                </div>\r
                <pre class="bg-body-tertiary m-0 p-3 overflow-auto"><code ng-bind="example.htmlCode"></code></pre>\r
            </div>\r
\r
            <div ng-if="example.hasAdditionalCode">\r
                <div class="d-flex align-items-end justify-content-between bg-body-tertiary border-bottom pe-2">\r
                    <ul\r
                        class="nav nav-tabs border-bottom-0 px-3 pt-2"\r
                        ngb-nav\r
                        active-id="example.activeTab"\r
                        animation="false"\r
                        ng-ref="example.codeNav"\r
                        ng-ref-read="ngbNav">\r
                        <li ngb-nav-item="html">\r
                            <button type="button" ngb-nav-link>HTML</button>\r
                            <ng-template ngb-nav-content>\r
                                <pre class="bg-body-tertiary m-0 p-3 overflow-auto"><code ng-bind="example.htmlCode"></code></pre>\r
                            </ng-template>\r
                        </li>\r
                        <li ng-if="example.tsCode" ngb-nav-item="typescript">\r
                            <button type="button" ngb-nav-link>TypeScript</button>\r
                            <ng-template ngb-nav-content>\r
                                <pre class="bg-body-tertiary m-0 p-3 overflow-auto"><code ng-bind="example.tsCode"></code></pre>\r
                            </ng-template>\r
                        </li>\r
                        <li ng-if="example.cssCode" ngb-nav-item="css">\r
                            <button type="button" ngb-nav-link>CSS</button>\r
                            <ng-template ngb-nav-content>\r
                                <pre class="bg-body-tertiary m-0 p-3 overflow-auto"><code ng-bind="example.cssCode"></code></pre>\r
                            </ng-template>\r
                        </li>\r
                    </ul>\r
\r
                    <docs-copy-button\r
                        value="example.activeCode"\r
                        button-class="text-body-secondary"\r
                        aria-label="Copy active code">\r
                    </docs-copy-button>\r
                </div>\r
                <div ngb-nav-outlet="example.codeNav"></div>\r
            </div>\r
        </div>\r
    </div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/toast-examples-page/toast-examples-page.component.html`,`<docs-example-section fragment="inline-toast" title="Declarative inline usage" description="Render static body-only and text-header toasts directly in the page." html-code="$.examples.inline.html" ts-code="$.examples.inline.typescript">\r
    <docs-inline-toast></docs-inline-toast>\r
</docs-example-section>\r
\r
<docs-example-section fragment="template-header-toast" title="Using a Template as header" description="Project an ng-template to build a richer header with custom markup." html-code="$.examples.templateHeader.html" ts-code="$.examples.templateHeader.typescript">\r
    <docs-template-header-toast></docs-template-header-toast>\r
</docs-example-section>\r
\r
<docs-example-section fragment="closeable-toast" title="Closeable toast" description="Handle hidden to remove the toast and recreate it after a short delay." html-code="$.examples.closeable.html" ts-code="$.examples.closeable.typescript">\r
    <docs-closeable-toast></docs-closeable-toast>\r
</docs-example-section>\r
\r
<docs-example-section fragment="prevent-autohide-toast" title="Prevent autohide on mouseover" description="Pause the autohide timer while the pointer remains over the toast and restart it on mouseleave." html-code="$.examples.preventAutohide.html" ts-code="$.examples.preventAutohide.typescript">\r
    <docs-prevent-autohide-toast></docs-prevent-autohide-toast>\r
</docs-example-section>\r
\r
<docs-example-section fragment="toast-management" title="Toast management service" description="Create, remove and clear multiple notifications through a reusable AngularJS service." html-code="$.examples.management.html" ts-code="$.examples.management.typescript">\r
    <docs-toast-management></docs-toast-management>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/tooltip-api-page/tooltip-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-tooltip">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbTooltip</code></h2><p class="text-body-secondary mb-0">Attaches a positioned Bootstrap tooltip to any host element.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;button ngb-tooltip="'Help text'"&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>ngb-tooltip</code></td><td><code>&lt;?</code></td><td><code>string | TemplateRef</code></td><td>—</td><td>Tooltip content.</td></tr>\r
            <tr><td><code>tooltip-context</code></td><td><code>&lt;?</code></td><td><code>object</code></td><td>—</td><td>Context supplied to template content.</td></tr>\r
            <tr><td><code>animation</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td><td>Enables open and close transitions.</td></tr>\r
            <tr><td><code>auto-close</code></td><td><code>&lt;?</code></td><td><code>boolean | "inside" | "outside"</code></td><td><code>true</code></td><td>Controls automatic closing.</td></tr>\r
            <tr><td><code>placement</code></td><td><code>&lt;?</code></td><td><code>PlacementArray</code></td><td><code>"auto"</code></td><td>Preferred Popper placement.</td></tr>\r
            <tr><td><code>triggers</code></td><td><code>&lt;?</code></td><td><code>string</code></td><td><code>"hover focus"</code></td><td>Space-separated open and close triggers.</td></tr>\r
            <tr><td><code>container</code></td><td><code>&lt;?</code></td><td><code>string</code></td><td><code>$config.container</code></td><td>Container selector for the tooltip window.</td></tr>\r
            <tr><td><code>position-target</code></td><td><code>@?</code></td><td><code>string</code></td><td>Host element</td><td>Overrides the positioning target.</td></tr>\r
            <tr><td><code>tooltip-class</code></td><td><code>@?</code></td><td><code>string</code></td><td>—</td><td>Adds a class to the tooltip window.</td></tr>\r
            <tr><td><code>disable-tooltip</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Prevents the tooltip from opening.</td></tr>\r
            <tr><td><code>open-delay</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>0</code></td><td>Delay before opening in milliseconds.</td></tr>\r
            <tr><td><code>close-delay</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>0</code></td><td>Delay before closing in milliseconds.</td></tr>\r
            <tr><td><code>popper-options</code></td><td><code>&lt;?</code></td><td><code>function</code></td><td><code>$config.popperOptions</code></td><td>Transforms Popper options.</td></tr>\r
        </tbody>\r
    </table></div>\r
    <h3 class="h5 mt-4 mb-3">Outputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead><tbody>\r
        <tr><td><code>shown</code></td><td><code>&amp;?</code></td><td>None</td><td>The tooltip opens.</td></tr>\r
        <tr><td><code>hidden</code></td><td><code>&amp;?</code></td><td>None</td><td>The tooltip closes.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-tooltip-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbTooltipConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide tooltip defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>animation</code></td><td><code>$config.animation</code></td></tr>\r
        <tr><td><code>autoClose</code></td><td><code>true</code></td></tr>\r
        <tr><td><code>placement</code></td><td><code>"auto"</code></td></tr>\r
        <tr><td><code>triggers</code></td><td><code>"hover focus"</code></td></tr>\r
        <tr><td><code>disableTooltip</code></td><td><code>false</code></td></tr>\r
        <tr><td><code>openDelay</code>, <code>closeDelay</code></td><td><code>0</code></td></tr>\r
        <tr><td><code>container</code>, <code>tooltipClass</code></td><td><code>undefined</code></td></tr>\r
        <tr><td><code>popperOptions</code></td><td>Identity transform</td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/toast-api-page/toast-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-toast">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Component</p><h2 class="h3 mb-2"><code class="text-body">NgbToast</code></h2><p class="text-body-secondary mb-0">Displays an accessible notification with optional automatic dismissal.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ngb-toast&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>animation</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td><td>Enables show and hide transitions.</td></tr>\r
            <tr><td><code>autohide</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Automatically hides the toast.</td></tr>\r
            <tr><td><code>delay</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>5000</code></td><td>Autohide delay in milliseconds.</td></tr>\r
            <tr><td><code>header</code></td><td><code>@?</code></td><td><code>string</code></td><td>—</td><td>Sets the default header text.</td></tr>\r
        </tbody>\r
    </table></div>\r
    <h3 class="h5 mt-4 mb-3">Outputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0">\r
        <thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>shown</code></td><td><code>&amp;?</code></td><td>None</td><td>The show transition finishes.</td></tr>\r
            <tr><td><code>hidden</code></td><td><code>&amp;?</code></td><td>None</td><td>The hide transition finishes.</td></tr>\r
        </tbody>\r
    </table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-toast-header">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbToastHeader</code></h2><p class="text-body-secondary mb-0">Marks a custom template as the toast header.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ng-template ngb-toast-header&gt;</code></dd></dl>\r
    <p class="small text-body-secondary mt-3 mb-0">No public inputs or outputs.</p>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-toast-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbToastConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide toast defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Type</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>animation</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td></tr>\r
        <tr><td><code>ariaLive</code></td><td><code>"polite" | "assertive"</code></td><td><code>"polite"</code></td></tr>\r
        <tr><td><code>autohide</code></td><td><code>boolean</code></td><td><code>true</code></td></tr>\r
        <tr><td><code>delay</code></td><td><code>number</code></td><td><code>5000</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/timepicker-examples-page/timepicker-examples-page.component.html`,`<docs-example-section fragment="basic-timepicker" title="Basic timepicker" description="Bind an NgbTimeStruct model to the default timepicker." html-code="$.examples.basic.html" ts-code="$.examples.basic.typescript">\r
    <docs-basic-timepicker></docs-basic-timepicker>\r
</docs-example-section>\r
\r
<docs-example-section fragment="meridian-timepicker" title="Meridian" description="Switch between 24-hour and 12-hour input with a localized period selector." html-code="$.examples.meridian.html" ts-code="$.examples.meridian.typescript">\r
    <docs-meridian-timepicker></docs-meridian-timepicker>\r
</docs-example-section>\r
\r
<docs-example-section fragment="seconds-timepicker" title="Seconds" description="Show or hide the seconds field while preserving the same time model." html-code="$.examples.seconds.html" ts-code="$.examples.seconds.typescript">\r
    <docs-seconds-timepicker></docs-seconds-timepicker>\r
</docs-example-section>\r
\r
<docs-example-section fragment="spinners-timepicker" title="Spinners" description="Toggle the increment and decrement controls without disabling keyboard input." html-code="$.examples.spinners.html" ts-code="$.examples.spinners.typescript">\r
    <docs-spinners-timepicker></docs-spinners-timepicker>\r
</docs-example-section>\r
\r
<docs-example-section fragment="timepicker-custom-steps" title="Custom steps" description="Configure independent increments for hours, minutes and seconds." html-code="$.examples.steps.html" ts-code="$.examples.steps.typescript">\r
    <docs-timepicker-custom-steps></docs-timepicker-custom-steps>\r
</docs-example-section>\r
\r
<docs-example-section fragment="timepicker-validation" title="Custom validation" description="Add an AngularJS ngModel validator that only accepts times between 12:00 and 13:59." html-code="$.examples.validation.html" ts-code="$.examples.validation.typescript">\r
    <docs-timepicker-validation></docs-timepicker-validation>\r
</docs-example-section>\r
\r
<docs-example-section fragment="timepicker-custom-adapter" title="Custom time adapter" description="Implement NgbTimeAdapter to convert between NgbTimeStruct and an application-level HH:mm:ss string. Adapter providers are application-wide in AngularJS." html-code="$.examples.adapter.html" ts-code="$.examples.adapter.typescript">\r
    <docs-timepicker-custom-adapter></docs-timepicker-custom-adapter>\r
</docs-example-section>\r
\r
<docs-example-section fragment="timepicker-i18n" title="Internationalization" description="Replace NgbTimepickerI18n application-wide to supply custom Greek morning and afternoon labels." html-code="$.examples.i18n.html" ts-code="$.examples.i18n.typescript">\r
    <docs-timepicker-i18n></docs-timepicker-i18n>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/scrollspy-examples-page/scrollspy-examples-page.component.html`,`<docs-example-section fragment="basic-scrollspy" title="Basic" description="Observe fragments inside an independent scroll container and read the currently active id." html-code="$.examples.basic.html">\r
    <docs-basic-scrollspy></docs-basic-scrollspy>\r
</docs-example-section>\r
\r
<docs-example-section fragment="scrollspy-menu-items" title="Menu items" description="Connect Bootstrap list-group items to a scrollspy instance outside the observed container." html-code="$.examples.menuItems.html">\r
    <docs-scrollspy-menu-items></docs-scrollspy-menu-items>\r
</docs-example-section>\r
\r
<docs-example-section fragment="nested-scrollspy" title="Nested items" description="Group child fragments under parent menu items and keep both levels synchronized." html-code="$.examples.nested.html">\r
    <docs-nested-scrollspy></docs-nested-scrollspy>\r
</docs-example-section>\r
\r
<docs-example-section fragment="navbar-scrollspy" title="Navbar" description="Use a Bootstrap navbar as an external menu for a separate scroll container." html-code="$.examples.navbar.html">\r
    <docs-navbar-scrollspy></docs-navbar-scrollspy>\r
</docs-example-section>\r
\r
<docs-example-section fragment="scrollspy-service" title="Using the service" description="Start, stop and control observation programmatically with NgbScrollSpyService and ordinary DOM fragments." html-code="$.examples.service.html" ts-code="$.examples.service.typescript">\r
    <docs-scrollspy-service-demo></docs-scrollspy-service-demo>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/scrollspy-api-page/scrollspy-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-scrollspy">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbScrollSpy</code></h2><p class="text-body-secondary mb-0">Turns a scrollable element into an observed container and tracks its active fragment.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;main ngb-scroll-spy&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead><tbody>\r
            <tr><td><code>active</code></td><td><code>@?</code></td><td><code>string</code></td><td><code>""</code></td><td>Initial or requested active fragment id.</td></tr>\r
            <tr><td><code>process-changes</code></td><td><code>&lt;?</code></td><td><code>NgbScrollSpyProcessChanges</code></td><td><code>$config.processChanges</code></td><td>Determines the active fragment from observer changes.</td></tr>\r
            <tr><td><code>root-margin</code></td><td><code>@?</code></td><td><code>string</code></td><td>Browser default</td><td>IntersectionObserver root margin.</td></tr>\r
            <tr><td><code>scroll-behavior</code></td><td><code>@?</code></td><td><code>"auto" | "smooth"</code></td><td><code>"smooth"</code></td><td>Default behavior for programmatic scrolling.</td></tr>\r
            <tr><td><code>threshold</code></td><td><code>&lt;?</code></td><td><code>number | number[]</code></td><td>Browser default</td><td>IntersectionObserver thresholds.</td></tr>\r
        </tbody>\r
    </table></div>\r
    <h3 class="h5 mt-4 mb-3">Outputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead><tbody>\r
        <tr><td><code>active-change</code></td><td><code>&amp;?</code></td><td><code>$event: string</code></td><td>The active fragment changes.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-scrollspy-fragment">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbScrollSpyFragment</code></h2><p class="text-body-secondary mb-0">Registers a section with its ancestor scrollspy and assigns its DOM id.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;section ngb-scroll-spy-fragment="overview"&gt;</code></dd><dt class="col-sm-3 fw-semibold">Requires</dt><dd class="col-sm-9 mb-0">An ancestor <code>ngb-scroll-spy</code>.</dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>ngb-scroll-spy-fragment</code></td><td><code>@</code></td><td><code>string</code></td><td>Required</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-scrollspy-menu">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbScrollSpyMenu</code></h2><p class="text-body-secondary mb-0">Coordinates nested menu items and applies their active state.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;nav ngb-scroll-spy-menu&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Input</th><th>Binding</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>ngb-scroll-spy-menu</code></td><td><code>&lt;?</code></td><td>Optional explicit <code>NgbScrollSpy</code>; otherwise uses an ancestor or injected service.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-scrollspy-item">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbScrollSpyItem</code></h2><p class="text-body-secondary mb-0">Links a menu entry to a fragment, applies <code>active</code> and scrolls on click.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;a ngb-scroll-spy-item="overview"&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Input</th><th>Binding</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>ngb-scroll-spy-item</code></td><td><code>@?</code></td><td>Fragment id or shorthand item data.</td></tr>\r
        <tr><td><code>fragment</code></td><td><code>@?</code></td><td>Explicit fragment id.</td></tr>\r
        <tr><td><code>parent</code></td><td><code>@?</code></td><td>Parent fragment id for nested menus.</td></tr>\r
        <tr><td><code>scroll-spy</code></td><td><code>&lt;?</code></td><td>Explicit <code>NgbScrollSpy</code> controller.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-scrollspy-service">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbScrollSpyService</code></h2><p class="text-body-secondary mb-0">Provides programmatic scrollspy control without a directive host.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Members</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Member</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>active</code></td><td>Current fragment id.</td></tr>\r
        <tr><td><code>active$</code></td><td>Observable of distinct active fragment changes.</td></tr>\r
        <tr><td><code>start(options?)</code></td><td>Starts observation with optional root, fragments and IntersectionObserver settings.</td></tr>\r
        <tr><td><code>stop()</code></td><td>Stops observation and clears the active fragment.</td></tr>\r
        <tr><td><code>observe(fragment)</code></td><td>Adds a fragment to observation.</td></tr>\r
        <tr><td><code>unobserve(fragment)</code></td><td>Removes a fragment from observation.</td></tr>\r
        <tr><td><code>scrollTo(fragment, options?)</code></td><td>Scrolls to a registered id or element.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-scrollspy-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbScrollSpyConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide scrollspy defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>scrollBehavior</code></td><td><code>"smooth"</code></td></tr>\r
        <tr><td><code>processChanges</code></td><td>Built-in intersection processing function</td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/timepicker-api-page/timepicker-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-timepicker">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Component</p><h2 class="h3 mb-2"><code class="text-body">NgbTimepicker</code></h2><p class="text-body-secondary mb-0">Edits a time value through AngularJS forms with optional spinners, seconds and meridian mode.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ngb-timepicker ng-model="time"&gt;</code></dd><dt class="col-sm-3 fw-semibold">Requires</dt><dd class="col-sm-9 mb-0"><code>ng-model</code>; optionally reads <code>ng-disabled</code>.</dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>meridian</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Uses a 12-hour clock with period selector.</td></tr>\r
            <tr><td><code>spinners</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Shows increment and decrement controls.</td></tr>\r
            <tr><td><code>seconds</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Shows the seconds field.</td></tr>\r
            <tr><td><code>hour-step</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>1</code></td><td>Hours changed per step.</td></tr>\r
            <tr><td><code>minute-step</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>1</code></td><td>Minutes changed per step.</td></tr>\r
            <tr><td><code>second-step</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>1</code></td><td>Seconds changed per step.</td></tr>\r
            <tr><td><code>readonly-inputs</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Makes text fields readonly while keeping spinner controls active.</td></tr>\r
            <tr><td><code>size</code></td><td><code>&lt;?</code></td><td><code>"small" | "medium" | "large"</code></td><td><code>"medium"</code></td><td>Sets the control size.</td></tr>\r
            <tr><td><code>ng-disabled</code></td><td><code>ngDisabled</code></td><td><code>boolean</code></td><td><code>$config.disabled</code></td><td>Disables the timepicker.</td></tr>\r
        </tbody>\r
    </table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-timepicker-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbTimepickerConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide timepicker defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>meridian</code>, <code>seconds</code>, <code>disabled</code>, <code>readonlyInputs</code></td><td><code>false</code></td></tr>\r
        <tr><td><code>spinners</code></td><td><code>true</code></td></tr>\r
        <tr><td><code>hourStep</code>, <code>minuteStep</code>, <code>secondStep</code></td><td><code>1</code></td></tr>\r
        <tr><td><code>size</code></td><td><code>"medium"</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-time-adapter">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbTimeAdapter&lt;T&gt;</code></h2><p class="text-body-secondary mb-0">Converts between the application model and <code>NgbTimeStruct</code>.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Methods</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Method</th><th>Returns</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>fromModel(value)</code></td><td><code>NgbTimeStruct | null</code></td><td>Converts an application value for the timepicker.</td></tr>\r
        <tr><td><code>toModel(time)</code></td><td><code>T | null</code></td><td>Converts the timepicker value back to the application model.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-timepicker-i18n">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbTimepickerI18n</code></h2><p class="text-body-secondary mb-0">Supplies localized morning and afternoon period labels.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Methods</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Method</th><th>Returns</th></tr></thead><tbody>\r
        <tr><td><code>getMorningPeriod()</code></td><td><code>string</code></td></tr>\r
        <tr><td><code>getAfternoonPeriod()</code></td><td><code>string</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/rating-api-page/rating-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-rating">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Component</p><h2 class="h3 mb-2"><code class="text-body">NgbRating</code></h2><p class="text-body-secondary mb-0">Provides an accessible keyboard-driven rating control with customizable stars.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ngb-rating rate="rating"&gt;</code></dd><dt class="col-sm-3 fw-semibold">Integration</dt><dd class="col-sm-9 mb-0">Optionally reads <code>ng-disabled</code>.</dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>rate</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>0</code></td><td>Current rating value.</td></tr>\r
            <tr><td><code>max</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>10</code></td><td>Maximum number of rating items.</td></tr>\r
            <tr><td><code>readonly</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Prevents user changes.</td></tr>\r
            <tr><td><code>resettable</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Allows selecting the current value again to reset to zero.</td></tr>\r
            <tr><td><code>star-template</code></td><td><code>&lt;?</code></td><td><code>TemplateRef</code></td><td>Default star</td><td>Provides custom item markup.</td></tr>\r
            <tr><td><code>tabindex</code></td><td><code>&lt;?</code></td><td><code>number | string</code></td><td><code>0</code></td><td>Sets keyboard tab order.</td></tr>\r
            <tr><td><code>aria-value-text</code></td><td><code>&lt;?</code></td><td><code>function</code></td><td>Built-in formatter</td><td>Formats the accessible value text.</td></tr>\r
            <tr><td><code>ng-disabled</code></td><td><code>ngDisabled</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Disables interaction and focus.</td></tr>\r
        </tbody>\r
    </table></div>\r
    <h3 class="h5 mt-4 mb-3">Outputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0">\r
        <thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>rate-change</code></td><td><code>&amp;?</code></td><td><code>$event: number</code></td><td>The interactive rating changes.</td></tr>\r
            <tr><td><code>hover</code></td><td><code>&amp;?</code></td><td><code>$event: number</code></td><td>A rating item is hovered.</td></tr>\r
            <tr><td><code>leave</code></td><td><code>&amp;?</code></td><td><code>$event: number</code></td><td>The pointer leaves the rating.</td></tr>\r
        </tbody>\r
    </table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-rating-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbRatingConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide rating defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Type</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>max</code></td><td><code>number</code></td><td><code>10</code></td></tr>\r
        <tr><td><code>readonly</code>, <code>resettable</code></td><td><code>boolean</code></td><td><code>false</code></td></tr>\r
        <tr><td><code>tabindex</code></td><td><code>number | string</code></td><td><code>0</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/progressbar-examples-page/progressbar-examples-page.component.html`,`<docs-example-section fragment="simple-progressbar" title="Simple progress bars" description="Display simple values using Bootstrap contextual types." html-code="$.examples.simple.html" ts-code="$.examples.simple.typescript">\r
    <docs-simple-progressbar></docs-simple-progressbar>\r
</docs-example-section>\r
\r
<docs-example-section fragment="contextual-text-progressbar" title="Contextual text progress bars" description="Show the calculated percentage and choose a contextual foreground color." html-code="$.examples.contextual.html" ts-code="$.examples.contextual.typescript">\r
    <docs-contextual-text-progressbar></docs-contextual-text-progressbar>\r
</docs-example-section>\r
\r
<docs-example-section fragment="striped-progress-bar" title="Striped progress bars" description="Apply striped styling to contextual variants and optionally animate the stripes." html-code="$.examples.striped.html" ts-code="$.examples.striped.typescript">\r
    <docs-striped-progress-bar></docs-striped-progress-bar>\r
</docs-example-section>\r
\r
<docs-example-section fragment="custom-labels-progressbar" title="Custom labels" description="Project arbitrary HTML labels inside each progress bar." html-code="$.examples.labels.html" ts-code="$.examples.labels.typescript">\r
    <docs-custom-labels-progressbar></docs-custom-labels-progressbar>\r
</docs-example-section>\r
\r
<docs-example-section fragment="progress-height" title="Progress height" description="Set the progress container height through the height input." html-code="$.examples.height.html" ts-code="$.examples.height.typescript">\r
    <docs-progress-height></docs-progress-height>\r
</docs-example-section>\r
\r
<docs-example-section fragment="progress-bars-stacked" title="Stacked progress bars" description="Combine multiple contextual segments inside NgbProgressbarStacked." html-code="$.examples.stacked.html" ts-code="$.examples.stacked.typescript">\r
    <docs-progress-bars-stacked></docs-progress-bars-stacked>\r
</docs-example-section>\r
\r
<docs-example-section fragment="progressbar-global" title="Global configuration" description="Change NgbProgressbarConfig once to provide shared visual and value defaults." html-code="$.examples.global.html" ts-code="$.examples.global.typescript">\r
    <docs-progressbar-global></docs-progressbar-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/progressbar-api-page/progressbar-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-progressbar">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Component</p><h2 class="h3 mb-2"><code class="text-body">NgbProgressbar</code></h2><p class="text-body-secondary mb-0">Renders an accessible Bootstrap progress indicator for a numeric value.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ngb-progressbar value="progress"&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>value</code></td><td><code>&lt;</code></td><td><code>number</code></td><td>Required</td><td>Current progress value.</td></tr>\r
            <tr><td><code>max</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>100</code></td><td>Maximum value.</td></tr>\r
            <tr><td><code>animated</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Animates striped progress.</td></tr>\r
            <tr><td><code>striped</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Uses a striped background.</td></tr>\r
            <tr><td><code>show-value</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Displays the calculated percentage.</td></tr>\r
            <tr><td><code>type</code></td><td><code>@?</code></td><td><code>string</code></td><td><code>$config.type</code></td><td>Sets the bar contextual type.</td></tr>\r
            <tr><td><code>text-type</code></td><td><code>@?</code></td><td><code>string</code></td><td><code>$config.textType</code></td><td>Sets the label text color.</td></tr>\r
            <tr><td><code>height</code></td><td><code>@?</code></td><td><code>string</code></td><td><code>$config.height</code></td><td>Sets the progress container height.</td></tr>\r
            <tr><td><code>aria-label</code></td><td><code>@?</code></td><td><code>string</code></td><td><code>"progress bar"</code></td><td>Accessible label for the bar.</td></tr>\r
        </tbody>\r
    </table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-progressbar-stacked">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Component</p><h2 class="h3 mb-2"><code class="text-body">NgbProgressbarStacked</code></h2><p class="text-body-secondary mb-0">Groups multiple progress bars into a Bootstrap stacked progress container.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ngb-progressbar-stacked&gt;</code></dd></dl>\r
    <p class="small text-body-secondary mt-3 mb-0">No public inputs or outputs.</p>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-progressbar-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbProgressbarConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide progress bar defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Type</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>ariaLabel</code></td><td><code>string</code></td><td><code>"progress bar"</code></td></tr>\r
        <tr><td><code>animated</code>, <code>showValue</code>, <code>striped</code></td><td><code>boolean</code></td><td><code>false</code></td></tr>\r
        <tr><td><code>max</code></td><td><code>number</code></td><td><code>100</code></td></tr>\r
        <tr><td><code>height</code>, <code>textType</code>, <code>type</code></td><td><code>string | undefined</code></td><td><code>undefined</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/rating-examples-page/rating-examples-page.component.html`,`<docs-example-section fragment="basic-rating" title="Basic demo" description="Select a rating and synchronize its value through rate-change." html-code="$.examples.basic.html" ts-code="$.examples.basic.typescript">\r
    <docs-basic-rating></docs-basic-rating>\r
</docs-example-section>\r
\r
<docs-example-section fragment="rating-events" title="Events and readonly ratings" description="Observe hover and leave events and switch the same rating between editable and read-only states." html-code="$.examples.events.html" ts-code="$.examples.events.typescript">\r
    <docs-rating-events></docs-rating-events>\r
</docs-example-section>\r
\r
<docs-example-section fragment="rating-custom-template" title="Custom star template" description="Replace the default characters with a child ng-template using Bootstrap Icons." html-code="$.examples.customTemplate.html" ts-code="$.examples.customTemplate.typescript" css-code="$.examples.customTemplate.css">\r
    <docs-rating-custom-template></docs-rating-custom-template>\r
</docs-example-section>\r
\r
<docs-example-section fragment="rating-decimal" title="Custom decimal rating" description="Render fractional heart fills through star-template and provide accessible value text." html-code="$.examples.decimal.html" ts-code="$.examples.decimal.typescript" css-code="$.examples.decimal.css">\r
    <docs-rating-decimal></docs-rating-decimal>\r
</docs-example-section>\r
\r
<docs-example-section fragment="rating-form" title="Form integration" description="Synchronize rate and rate-change with an AngularJS form model while direct ng-model support remains pending." html-code="$.examples.form.html" ts-code="$.examples.form.typescript">\r
    <docs-rating-form></docs-rating-form>\r
</docs-example-section>\r
\r
<docs-example-section fragment="rating-global" title="Customized default values" description="Change NgbRatingConfig once to provide shared maximum, read-only and tabindex defaults." html-code="$.examples.global.html" ts-code="$.examples.global.typescript">\r
    <docs-rating-global></docs-rating-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/popover-examples-page/popover-examples-page.component.html`,`<docs-example-section fragment="popover-placements" title="Quick and easy popovers" description="Place a popover above, to the right, below or to the left of its trigger." html-code="$.examples.placements.html" ts-code="$.examples.placements.typescript">\r
    <docs-popover-placements></docs-popover-placements>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-template" title="HTML and bindings in popovers" description="Use ng-template for rich title and body content with live AngularJS bindings." html-code="$.examples.template.html" ts-code="$.examples.template.typescript">\r
    <docs-popover-template></docs-popover-template>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-triggers" title="Custom and manual triggers" description="Pair custom DOM events or take manual control with two buttons." html-code="$.examples.triggers.html" ts-code="$.examples.triggers.typescript">\r
    <docs-popover-triggers></docs-popover-triggers>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-manual-control" title="External manual controls" description="Open, close and toggle a target popover from independent controls." html-code="$.examples.manual.html" ts-code="$.examples.manual.typescript">\r
    <docs-popover-manual-control></docs-popover-manual-control>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-autoclose" title="Automatic closing with keyboard and mouse" description="Close on inside clicks, outside clicks, every click or the Escape key." html-code="$.examples.autoclose.html" ts-code="$.examples.autoclose.typescript">\r
    <docs-popover-autoclose></docs-popover-autoclose>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-context" title="Context and manual triggers" description="Supply template context while opening manually or through popover-context." html-code="$.examples.context.html" ts-code="$.examples.context.typescript">\r
    <docs-popover-context></docs-popover-context>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-custom-target" title="Custom target" description="Trigger a popover from one element while positioning it against another." html-code="$.examples.customTarget.html" ts-code="$.examples.customTarget.typescript">\r
    <docs-popover-custom-target></docs-popover-custom-target>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-delays" title="Open and close delays" description="Delay hover opening and keep content available while the pointer moves into it." html-code="$.examples.delays.html" ts-code="$.examples.delays.typescript">\r
    <docs-popover-delays></docs-popover-delays>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-events" title="Popover visibility events" description="Observe shown and hidden callbacks and record when each transition completes." html-code="$.examples.events.html" ts-code="$.examples.events.typescript">\r
    <docs-popover-events></docs-popover-events>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-body" title="Append popover in the body" description="Escape clipping containers by appending the popover window to document.body." html-code="$.examples.body.html" ts-code="$.examples.body.typescript">\r
    <docs-popover-body></docs-popover-body>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-custom-class" title="Popover with custom class" description="Layer a focused visual treatment over Bootstrap popover variables." html-code="$.examples.customClass.html" ts-code="$.examples.customClass.typescript" css-code="$.examples.customClass.css">\r
    <docs-popover-custom-class></docs-popover-custom-class>\r
</docs-example-section>\r
\r
<docs-example-section fragment="popover-global" title="Global configuration of popovers" description="Change NgbPopoverConfig once to provide shared trigger, placement, delay and container defaults." html-code="$.examples.global.html" ts-code="$.examples.global.typescript">\r
    <docs-popover-global></docs-popover-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/pagination-examples-page/pagination-examples-page.component.html`,`<docs-example-section fragment="basic-pagination" title="Basic pagination" description="Navigate a collection with the default pagination options." html-code="$.examples.basic.html" ts-code="$.examples.basic.typescript">\r
    <docs-basic-pagination></docs-basic-pagination>\r
</docs-example-section>\r
\r
<docs-example-section fragment="advanced-pagination" title="Advanced pagination" description="Limit visible pages, rotate the range and control boundary links and ellipses." html-code="$.examples.advanced.html" ts-code="$.examples.advanced.typescript">\r
    <docs-advanced-pagination></docs-advanced-pagination>\r
</docs-example-section>\r
\r
<docs-example-section fragment="custom-pagination" title="Custom links and pages" description="Replace the previous, next and page-number content with ng-template." html-code="$.examples.custom.html" ts-code="$.examples.custom.typescript">\r
    <docs-custom-pagination></docs-custom-pagination>\r
</docs-example-section>\r
\r
<docs-example-section fragment="pagination-size" title="Pagination size" description="Use Bootstrap small, default and large pagination sizes." html-code="$.examples.size.html" ts-code="$.examples.size.typescript">\r
    <docs-pagination-size></docs-pagination-size>\r
</docs-example-section>\r
\r
<docs-example-section fragment="pagination-alignment" title="Pagination alignment" description="Align pagination at the start, center or end using Bootstrap flex utilities." html-code="$.examples.alignment.html" ts-code="$.examples.alignment.typescript">\r
    <docs-pagination-alignment></docs-pagination-alignment>\r
</docs-example-section>\r
\r
<docs-example-section fragment="disabled-pagination" title="Disabled pagination" description="Disable every pagination action through the ng-disabled directive." html-code="$.examples.disabled.html" ts-code="$.examples.disabled.typescript">\r
    <docs-disabled-pagination></docs-disabled-pagination>\r
</docs-example-section>\r
\r
<docs-example-section fragment="pagination-global" title="Global configuration" description="Change NgbPaginationConfig once to provide shared pagination defaults." html-code="$.examples.global.html" ts-code="$.examples.global.typescript">\r
    <docs-pagination-global></docs-pagination-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/pagination-api-page/pagination-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-pagination">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Component</p><h2 class="h3 mb-2"><code class="text-body">NgbPagination</code></h2><p class="text-body-secondary mb-0">Builds accessible page navigation for a collection.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ngb-pagination collection-size="total" page="page"&gt;</code></dd><dt class="col-sm-3 fw-semibold">Integration</dt><dd class="col-sm-9 mb-0">Optionally reads <code>ng-disabled</code>.</dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>collection-size</code></td><td><code>&lt;</code></td><td><code>number</code></td><td>Required</td><td>Total number of collection items.</td></tr>\r
            <tr><td><code>page</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>1</code></td><td>Current page.</td></tr>\r
            <tr><td><code>page-size</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>10</code></td><td>Items represented by each page.</td></tr>\r
            <tr><td><code>max-size</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>0</code></td><td>Maximum number of visible page links; zero is unlimited.</td></tr>\r
            <tr><td><code>boundary-links</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Shows first and last links.</td></tr>\r
            <tr><td><code>direction-links</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Shows previous and next links.</td></tr>\r
            <tr><td><code>ellipses</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Shows ellipses for omitted ranges.</td></tr>\r
            <tr><td><code>rotate</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Centers the current page within the visible range.</td></tr>\r
            <tr><td><code>size</code></td><td><code>&lt;?</code></td><td><code>string | null</code></td><td><code>$config.size</code></td><td>Sets the Bootstrap pagination size.</td></tr>\r
            <tr><td><code>ng-disabled</code></td><td><code>ngDisabled</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Disables page navigation.</td></tr>\r
        </tbody>\r
    </table></div>\r
    <h3 class="h5 mt-4 mb-3">Outputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead><tbody>\r
        <tr><td><code>page-change</code></td><td><code>&amp;?</code></td><td><code>$event: number</code></td><td>The user selects a page.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-pagination-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbPaginationConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide pagination defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>disabled</code>, <code>boundaryLinks</code>, <code>rotate</code></td><td><code>false</code></td></tr>\r
        <tr><td><code>directionLinks</code>, <code>ellipses</code></td><td><code>true</code></td></tr>\r
        <tr><td><code>maxSize</code></td><td><code>0</code></td></tr>\r
        <tr><td><code>pageSize</code></td><td><code>10</code></td></tr>\r
        <tr><td><code>size</code></td><td><code>undefined</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/offcanvas-examples-page/offcanvas-examples-page.component.html`,`<docs-example-section\r
    fragment="offcanvas-default"\r
    title="Offcanvas with default options"\r
    description="Open a TemplateRef panel without passing local options."\r
    html-code="$.examples.defaults.html"\r
    ts-code="$.examples.defaults.typescript">\r
    <docs-offcanvas-default></docs-offcanvas-default>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="offcanvas-component-content"\r
    title="Components as content"\r
    description="Open a registered component and close or dismiss it through NgbActiveOffcanvas."\r
    html-code="$.examples.componentContent.html"\r
    ts-code="$.examples.componentContent.typescript">\r
    <docs-offcanvas-component-content></docs-offcanvas-component-content>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="offcanvas-focus"\r
    title="Focus management"\r
    description="Focus the first interactive element automatically or choose another element with ngbAutofocus."\r
    html-code="$.examples.focus.html"\r
    ts-code="$.examples.focus.typescript">\r
    <docs-offcanvas-focus></docs-offcanvas-focus>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="offcanvas-options"\r
    title="Offcanvas with options"\r
    description="Try custom classes, a static backdrop, every panel position and body scrolling."\r
    html-code="$.examples.options.html"\r
    ts-code="$.examples.options.typescript"\r
    css-code="$.examples.options.css">\r
    <docs-offcanvas-options></docs-offcanvas-options>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="offcanvas-global"\r
    title="Global configuration"\r
    description="Change NgbOffcanvasConfig once to provide shared defaults when opening a panel."\r
    html-code="$.examples.global.html"\r
    ts-code="$.examples.global.typescript">\r
    <docs-offcanvas-global></docs-offcanvas-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/popover-api-page/popover-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-popover">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbPopover</code></h2><p class="text-body-secondary mb-0">Attaches a positioned Bootstrap popover to any host element.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;button ngb-popover="'Content'"&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>ngb-popover</code></td><td><code>&lt;?</code></td><td><code>string | TemplateRef</code></td><td>—</td><td>Popover body content.</td></tr>\r
            <tr><td><code>popover-title</code></td><td><code>&lt;?</code></td><td><code>string | TemplateRef</code></td><td>—</td><td>Optional title content.</td></tr>\r
            <tr><td><code>popover-context</code></td><td><code>&lt;?</code></td><td><code>object</code></td><td>—</td><td>Context supplied to template content.</td></tr>\r
            <tr><td><code>animation</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td><td>Enables open and close transitions.</td></tr>\r
            <tr><td><code>auto-close</code></td><td><code>&lt;?</code></td><td><code>boolean | "inside" | "outside"</code></td><td><code>true</code></td><td>Controls automatic closing.</td></tr>\r
            <tr><td><code>placement</code></td><td><code>&lt;?</code></td><td><code>PlacementArray</code></td><td><code>"auto"</code></td><td>Preferred Popper placement.</td></tr>\r
            <tr><td><code>triggers</code></td><td><code>&lt;?</code></td><td><code>string</code></td><td><code>"click"</code></td><td>Space-separated open and close triggers.</td></tr>\r
            <tr><td><code>container</code></td><td><code>&lt;?</code></td><td><code>string</code></td><td><code>$config.container</code></td><td>Container selector for the popover window.</td></tr>\r
            <tr><td><code>position-target</code></td><td><code>&lt;?</code></td><td><code>HTMLElement | string</code></td><td>Host element</td><td>Overrides the positioning target.</td></tr>\r
            <tr><td><code>popover-class</code></td><td><code>@?</code></td><td><code>string</code></td><td>—</td><td>Adds a class to the popover window.</td></tr>\r
            <tr><td><code>disable-popover</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Prevents the popover from opening.</td></tr>\r
            <tr><td><code>open-delay</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>0</code></td><td>Delay before opening in milliseconds.</td></tr>\r
            <tr><td><code>close-delay</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>0</code></td><td>Delay before closing in milliseconds.</td></tr>\r
            <tr><td><code>popper-options</code></td><td><code>&lt;?</code></td><td><code>function</code></td><td><code>$config.popperOptions</code></td><td>Transforms Popper options.</td></tr>\r
        </tbody>\r
    ...
    <h3 class="h5 mt-4 mb-3">Outputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead><tbody>\r
        <tr><td><code>shown</code></td><td><code>&amp;?</code></td><td>None</td><td>The popover opens.</td></tr>\r
        <tr><td><code>hidden</code></td><td><code>&amp;?</code></td><td>None</td><td>The popover closes.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-popover-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbPopoverConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide popover defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>animation</code></td><td><code>$config.animation</code></td></tr>\r
        <tr><td><code>autoClose</code></td><td><code>true</code></td></tr>\r
        <tr><td><code>placement</code></td><td><code>"auto"</code></td></tr>\r
        <tr><td><code>triggers</code></td><td><code>"click"</code></td></tr>\r
        <tr><td><code>disablePopover</code></td><td><code>false</code></td></tr>\r
        <tr><td><code>openDelay</code>, <code>closeDelay</code></td><td><code>0</code></td></tr>\r
        <tr><td><code>container</code>, <code>popoverClass</code></td><td><code>undefined</code></td></tr>\r
        <tr><td><code>popperOptions</code></td><td>Identity transform</td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/nav-api-page/nav-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-nav">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbNav</code></h2><p class="text-body-secondary mb-0">Coordinates nav items, selection, keyboard behavior and panel transitions.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ul ngb-nav active-id="activeId"&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>active-id</code></td><td><code>=?</code></td><td><code>string</code></td><td>First enabled item</td><td>Two-way active item id.</td></tr>\r
            <tr><td><code>animation</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td><td>Enables panel transitions.</td></tr>\r
            <tr><td><code>destroy-on-hide</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Removes inactive panel views.</td></tr>\r
            <tr><td><code>keyboard</code></td><td><code>&lt;?</code></td><td><code>boolean | "changeWithArrows"</code></td><td><code>true</code></td><td>Controls arrow-key navigation.</td></tr>\r
            <tr><td><code>orientation</code></td><td><code>&lt;?</code></td><td><code>"horizontal" | "vertical"</code></td><td><code>"horizontal"</code></td><td>Sets keyboard orientation.</td></tr>\r
            <tr><td><code>roles</code></td><td><code>&lt;?</code></td><td><code>"tablist" | false</code></td><td><code>"tablist"</code></td><td>Enables or disables tab ARIA roles.</td></tr>\r
        </tbody>\r
    </table></div>\r
    <h3 class="h5 mt-4 mb-3">Outputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Output</th><th>Payload</th><th>Emitted when</th></tr></thead><tbody>\r
        <tr><td><code>active-id-change</code></td><td><code>$event: string</code></td><td>The active id changes.</td></tr>\r
        <tr><td><code>nav-change</code></td><td><code>$event: NgbNavChangeEvent</code></td><td>Before selection changes; the event can prevent it.</td></tr>\r
        <tr><td><code>shown</code></td><td><code>$event: string</code></td><td>The next panel finishes appearing.</td></tr>\r
        <tr><td><code>hidden</code></td><td><code>$event: string</code></td><td>The previous panel finishes hiding.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-nav-item">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbNavItem</code></h2><p class="text-body-secondary mb-0">Defines one selectable item and its associated content.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;li ngb-nav-item="overview"&gt;</code></dd><dt class="col-sm-3 fw-semibold">Requires</dt><dd class="col-sm-9 mb-0">An ancestor <code>ngb-nav</code>; optionally reads <code>ng-disabled</code>.</dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Bindings</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Name</th><th>Binding</th><th>Default</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>ngb-nav-item</code></td><td><code>@?</code></td><td>Generated id</td><td>Identifies the item.</td></tr>\r
        <tr><td><code>dom-id</code></td><td><code>@?</code></td><td>Generated id</td><td>Overrides the DOM id.</td></tr>\r
        <tr><td><code>destroy-on-hide</code></td><td><code>&lt;?</code></td><td>Inherited</td><td>Overrides panel lifecycle for this item.</td></tr>\r
        <tr><td><code>shown</code>, <code>hidden</code></td><td><code>&amp;?</code></td><td>—</td><td>Item-level panel lifecycle callbacks.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-nav-link">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbNavLink</code></h2><p class="text-body-secondary mb-0">Turns an anchor or button into the interactive trigger for its nav item.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;button ngb-nav-link&gt;</code></dd><dt class="col-sm-3 fw-semibold">Requires</dt><dd class="col-sm-9 mb-0">Ancestor <code>ngb-nav-item</code> and <code>ngb-nav</code> controllers.</dd></dl>\r
    <p class="small text-body-secondary mt-3 mb-0">No public inputs or outputs.</p>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-nav-content">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbNavContent</code></h2><p class="text-body-secondary mb-0">Marks the template rendered for a nav item.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ng-template ngb-nav-content&gt;</code></dd></dl>\r
    <p class="small text-body-secondary mt-3 mb-0">No public inputs or outputs.</p>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-nav-outlet">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbNavOutlet</code></h2><p class="text-body-secondary mb-0">Renders the active panel for a nav controller.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;div ngb-nav-outlet="navController"&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Input</th><th>Binding</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>ngb-nav-outlet</code></td><td><code>&lt;</code></td><td>The <code>NgbNav</code> controller to render.</td></tr>\r
        <tr><td><code>pane-role</code></td><td><code>&lt;?</code></td><td>Overrides the generated panel role.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-nav-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbNavConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide nav defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>animation</code></td><td><code>$config.animation</code></td></tr>\r
        <tr><td><code>destroyOnHide</code></td><td><code>true</code></td></tr>\r
        <tr><td><code>orientation</code></td><td><code>"horizontal"</code></td></tr>\r
        <tr><td><code>roles</code></td><td><code>"tablist"</code></td></tr>\r
        <tr><td><code>keyboard</code></td><td><code>true</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/offcanvas-api-page/offcanvas-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-offcanvas">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbOffcanvas</code></h2><p class="text-body-secondary mb-0">Creates and coordinates offcanvas panels from templates or components.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Members</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Member</th><th>Returns</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>open(content, options?)</code></td><td><code>NgbOffcanvasRef</code></td><td>Opens content with options merged over <code>NgbOffcanvasConfig</code>.</td></tr>\r
        <tr><td><code>activeInstance</code></td><td>Active instance</td><td>Exposes the currently open offcanvas instance.</td></tr>\r
        <tr><td><code>dismiss(reason?)</code></td><td><code>void</code></td><td>Dismisses the active panel.</td></tr>\r
        <tr><td><code>hasOpenOffcanvas()</code></td><td><code>boolean</code></td><td>Reports whether a panel is open.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-offcanvas-ref">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Class</p><h2 class="h3 mb-2"><code class="text-body">NgbOffcanvasRef</code></h2><p class="text-body-secondary mb-0">Controls one panel and exposes its result and lifecycle streams.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Members</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Member</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>close(result?)</code></td><td>Resolves <code>result</code> and closes the panel.</td></tr>\r
        <tr><td><code>dismiss(reason?)</code></td><td>Rejects <code>result</code> and dismisses the panel.</td></tr>\r
        <tr><td><code>result</code></td><td>AngularJS promise settled by close or dismiss.</td></tr>\r
        <tr><td><code>closed</code>, <code>dismissed</code>, <code>shown</code>, <code>hidden</code></td><td>Observable lifecycle streams.</td></tr>\r
        <tr><td><code>componentInstance</code></td><td>Component controller instance when component content is used.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-active-offcanvas">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbActiveOffcanvas</code></h2><p class="text-body-secondary mb-0">Allows offcanvas content to control the panel that contains it.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Methods</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Method</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>close(result?)</code></td><td>Closes with an optional result.</td></tr>\r
        <tr><td><code>dismiss(reason?)</code></td><td>Dismisses with an optional reason.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-offcanvas-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbOffcanvasConfig</code></h2><p class="text-body-secondary mb-0">Provides defaults merged into every <code>open()</code> call.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Options</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Option</th><th>Default</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>animation</code></td><td><code>$config.animation</code></td><td>Enables panel and backdrop transitions.</td></tr>\r
        <tr><td><code>backdrop</code></td><td><code>true</code></td><td>Accepts <code>true</code>, <code>false</code> or <code>"static"</code>.</td></tr>\r
        <tr><td><code>keyboard</code></td><td><code>true</code></td><td>Allows Escape-key dismissal.</td></tr>\r
        <tr><td><code>position</code></td><td><code>"start"</code></td><td>Accepts <code>"start"</code>, <code>"end"</code>, <code>"top"</code> or <code>"bottom"</code>.</td></tr>\r
        <tr><td><code>scroll</code></td><td><code>false</code></td><td>Allows body scrolling while open.</td></tr>\r
        <tr><td><code>ariaLabelledBy</code>, <code>ariaDescribedBy</code></td><td><code>undefined</code></td><td>Connect accessible label and description elements.</td></tr>\r
        <tr><td><code>container</code>, <code>bindings</code></td><td><code>undefined</code></td><td>Control content creation and placement.</td></tr>\r
        <tr><td><code>panelClass</code>, <code>backdropClass</code></td><td><code>undefined</code></td><td>Add custom classes.</td></tr>\r
        <tr><td><code>beforeDismiss</code></td><td><code>undefined</code></td><td>Can cancel dismissal synchronously or asynchronously.</td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/modal-examples-page/modal-examples-page.component.html`,`<docs-example-section\r
    fragment="modal-default"\r
    title="Modal with default options"\r
    description="Open a TemplateRef modal without passing local options."\r
    html-code="$.examples.defaults.html"\r
    ts-code="$.examples.defaults.typescript">\r
    <docs-modal-default></docs-modal-default>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="modal-component-content"\r
    title="Components as content"\r
    description="Open a registered component, pass bindings to it and close or dismiss through NgbActiveModal."\r
    html-code="$.examples.componentContent.html"\r
    ts-code="$.examples.componentContent.typescript">\r
    <docs-modal-component-content></docs-modal-component-content>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="modal-focus"\r
    title="Focus management"\r
    description="Focus the first interactive element automatically or choose another element with ngbAutofocus."\r
    html-code="$.examples.focus.html"\r
    ts-code="$.examples.focus.typescript">\r
    <docs-modal-focus></docs-modal-focus>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="modal-options"\r
    title="Modal with options"\r
    description="Open modal variants for custom classes, backdrops, sizes, fullscreen, centering and scrollable content."\r
    html-code="$.examples.options.html"\r
    ts-code="$.examples.options.typescript"\r
    css-code="$.examples.options.css">\r
    <docs-modal-options></docs-modal-options>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="modal-updatable"\r
    title="Updatable options"\r
    description="Change ARIA references, layout, size and custom classes after the modal has opened."\r
    html-code="$.examples.updatable.html"\r
    ts-code="$.examples.updatable.typescript"\r
    css-code="$.examples.updatable.css">\r
    <docs-modal-updatable></docs-modal-updatable>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="modal-stacked"\r
    title="Stacked modals"\r
    description="Open multiple modal layers and dismiss the complete stack from the modal service."\r
    html-code="$.examples.stacked.html"\r
    ts-code="$.examples.stacked.typescript">\r
    <docs-modal-stacked></docs-modal-stacked>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="modal-global"\r
    title="Global configuration"\r
    description="Change NgbModalConfig once to provide defaults for every modal opened in this example."\r
    html-code="$.examples.global.html"\r
    ts-code="$.examples.global.typescript">\r
    <docs-modal-global></docs-modal-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/nav-examples-page/nav-examples-page.component.html`,`<docs-example-section\r
    fragment="simple-nav"\r
    title="Simple nav"\r
    description="A basic tabbed nav with three items and an associated content outlet."\r
    html-code="$.examples.simple.html"\r
    ts-code="$.examples.simple.typescript">\r
    <docs-simple-nav></docs-simple-nav>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="alternative-nav"\r
    title="Alternative markup"\r
    description="Use div elements instead of lists and interchange buttons and anchors as nav links."\r
    html-code="$.examples.alternative.html"\r
    ts-code="$.examples.alternative.typescript">\r
    <docs-alternative-nav></docs-alternative-nav>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="vertical-nav"\r
    title="Vertical pills"\r
    description="Combine vertical orientation with Bootstrap nav pills and a side-by-side outlet."\r
    html-code="$.examples.vertical.html"\r
    ts-code="$.examples.vertical.typescript">\r
    <docs-vertical-nav></docs-vertical-nav>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="selecting-nav"\r
    title="Selecting navs"\r
    description="Select any nav item programmatically through the NgbNav controller."\r
    html-code="$.examples.selecting.html"\r
    ts-code="$.examples.selecting.typescript">\r
    <docs-selecting-nav></docs-selecting-nav>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="keep-content-nav"\r
    title="Keep content"\r
    description="Disable content destruction so form state remains in the DOM while another tab is active."\r
    html-code="$.examples.keepContent.html"\r
    ts-code="$.examples.keepContent.typescript">\r
    <docs-keep-content-nav></docs-keep-content-nav>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="dynamic-nav"\r
    title="Dynamic navs"\r
    description="Add new tabs at runtime and safely remove the currently active item."\r
    html-code="$.examples.dynamic.html"\r
    ts-code="$.examples.dynamic.typescript">\r
    <docs-dynamic-nav></docs-dynamic-nav>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="custom-nav"\r
    title="Custom style"\r
    description="Build a distinct nav appearance with a small custom class layered over NgbJS behavior."\r
    html-code="$.examples.custom.html"\r
    ts-code="$.examples.custom.typescript"\r
    css-code="$.examples.custom.css">\r
    <docs-custom-nav></docs-custom-nav>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="nav-global"\r
    title="Global configuration"\r
    description="Change NgbNavConfig once to provide orientation, keyboard and content defaults."\r
    html-code="$.examples.global.html"\r
    ts-code="$.examples.global.typescript">\r
    <docs-nav-global></docs-nav-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/dropdown-examples-page/dropdown-examples-page.component.html`,`<docs-example-section\r
    fragment="simple-dropdown"\r
    title="Simple dropdown"\r
    description="Two basic menus that prefer bottom and top placement respectively."\r
    html-code="$.examples.simple.html">\r
    <docs-simple-dropdown></docs-simple-dropdown>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="manual-dropdown"\r
    title="Manual triggers"\r
    description="Use the dropdown controller to open, close or toggle a menu without a toggle trigger."\r
    html-code="$.examples.manual.html"\r
    ts-code="$.examples.manual.typescript">\r
    <docs-manual-dropdown></docs-manual-dropdown>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="dropdown-button-groups"\r
    title="Button groups and split buttons"\r
    description="Place dropdown toggles inside Bootstrap button groups, including a split action."\r
    html-code="$.examples.buttonGroups.html">\r
    <docs-dropdown-button-groups></docs-dropdown-button-groups>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="dropdown-disabled-items"\r
    title="Disabled items"\r
    description="Use ng-disabled to update disabled dropdown items dynamically."\r
    html-code="$.examples.disabledItems.html"\r
    ts-code="$.examples.disabledItems.typescript">\r
    <docs-dropdown-disabled-items></docs-dropdown-disabled-items>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="dropdown-form"\r
    title="Dropdown form"\r
    description="Place an AngularJS form inside the menu and keep it open while interacting with its fields."\r
    html-code="$.examples.form.html"\r
    ts-code="$.examples.form.typescript">\r
    <docs-dropdown-form></docs-dropdown-form>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="dropdown-body"\r
    title="Body container"\r
    description="Append the menu to the document body when an ancestor clips overflowing content."\r
    html-code="$.examples.body.html">\r
    <docs-dropdown-body></docs-dropdown-body>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="dropdown-navbar"\r
    title="Dynamic positioning in a navbar"\r
    description="Override the navbar's static default with dynamic Popper positioning."\r
    html-code="$.examples.navbar.html">\r
    <docs-dropdown-navbar></docs-dropdown-navbar>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="dropdown-global"\r
    title="Global configuration"\r
    description="Change NgbDropdownConfig once to provide shared defaults without local inputs."\r
    html-code="$.examples.global.html"\r
    ts-code="$.examples.global.typescript">\r
    <docs-dropdown-global></docs-dropdown-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/datepicker-examples-page/datepicker-examples-page.component.html`,`<docs-example-section fragment="basic-datepicker" title="Basic datepicker" description="Bind an NgbDateStruct model to an inline calendar." html-code="$.examples.basic.html" ts-code="$.examples.basic.typescript"><docs-basic-datepicker></docs-basic-datepicker></docs-example-section>\r
<docs-example-section fragment="popup-datepicker" title="Datepicker in a popup" description="Attach the datepicker to an input and control its popup from a compact calendar button." html-code="$.examples.popup.html" ts-code="$.examples.popup.typescript"><docs-popup-datepicker></docs-popup-datepicker></docs-example-section>\r
<docs-example-section fragment="multiple-months-datepicker" title="Multiple months" description="Display two consecutive months while keeping a single date model." html-code="$.examples.multiple.html" ts-code="$.examples.multiple.typescript"><docs-multiple-months-datepicker></docs-multiple-months-datepicker></docs-example-section>\r
<docs-example-section fragment="range-datepicker" title="Range selection" description="Compose a date range from dateSelect and a custom day template with hover feedback." html-code="$.examples.range.html" ts-code="$.examples.range.typescript" css-code="$.examples.range.css"><docs-range-datepicker></docs-range-datepicker></docs-example-section>\r
<docs-example-section fragment="range-popup-datepicker" title="Range selection in a popup" description="Use the same range state and custom day view inside an input datepicker." html-code="$.examples.rangePopup.html" ts-code="$.examples.rangePopup.typescript" css-code="$.examples.rangePopup.css"><docs-range-popup-datepicker></docs-range-popup-datepicker></docs-example-section>\r
<docs-example-section fragment="disabled-datepicker" title="Disabled datepicker" description="Drive the disabled state through AngularJS ng-disabled." html-code="$.examples.disabled.html" ts-code="$.examples.disabled.typescript"><docs-disabled-datepicker></docs-disabled-datepicker></docs-example-section>\r
<docs-example-section fragment="datepicker-custom-adapter" title="Custom date adapter and formatter" description="Keep a string application model while presenting and parsing a different input format." html-code="$.examples.adapter.html" ts-code="$.examples.adapter.typescript"><docs-datepicker-custom-adapter></docs-datepicker-custom-adapter></docs-example-section>\r
<docs-example-section fragment="datepicker-i18n" title="Internationalization of datepickers" description="Supply labels and accessible date descriptions per datepicker instance through NgbDatepickerI18n." html-code="$.examples.i18n.html" ts-code="$.examples.i18n.typescript"><docs-datepicker-i18n></docs-datepicker-i18n></docs-example-section>\r
<docs-example-section fragment="datepicker-custom-day" title="Custom day view" description="Render weekends, today, selection and focus states with a custom day template." html-code="$.examples.customDay.html" ts-code="$.examples.customDay.typescript" css-code="$.examples.customDay.css"><docs-datepicker-custom-day></docs-datepicker-custom-day></docs-example-section>\r
<docs-example-section fragment="datepicker-custom-month" title="Custom month layout" description="Replace the datepicker content while reusing its public month view and navigation API." html-code="$.examples.customMonth.html" ts-code="$.examples.customMonth.typescript" css-code="$.examples.customMonth.css"><docs-datepicker-custom-month></docs-datepicker-custom-month></docs-example-section>\r
<docs-example-section fragment="datepicker-footer" title="Footer template" description="Add Today and Clear actions below the calendar with a footer template." html-code="$.examples.footer.html" ts-code="$.examples.footer.typescript"><docs-datepicker-footer></docs-datepicker-footer></docs-example-section>\r
<docs-example-section fragment="datepicker-position-target" title="Position target" description="Trigger the popup from an input while positioning it against a separate element." html-code="$.examples.position.html" ts-code="$.examples.position.typescript"><docs-datepicker-position-target></docs-datepicker-position-target></docs-example-section>\r
<docs-example-section fragment="datepicker-keyboard" title="Custom keyboard navigation" description="Add application-specific month navigation keys without removing the built-in keyboard behavior." html-code="$.examples.keyboard.html" ts-code="$.examples.keyboard.typescript"><docs-datepicker-keyboard></docs-datepicker-keyboard></docs-example-section>\r
<docs-example-section fragment="datepicker-global" title="Global configuration of datepickers" description="Change defaults for inline and input datepickers through their configuration services." html-code="$.examples.global.html" ts-code="$.examples.global.typescript"><docs-datepicker-global></docs-datepicker-global></docs-example-section>\r
`),e.put(`src/app/features/lib/pages/dropdown-api-page/dropdown-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-dropdown">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Directive</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbDropdown</code></h2>\r
        <p class="text-body-secondary mb-0">Root controller for open state, positioning, focus and auto-close behavior.</p>\r
    </header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;div ngb-dropdown&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
        <tbody>\r
            <tr><td><code>auto-close</code></td><td><code>&lt;?</code></td><td><code>boolean | "inside" | "outside"</code></td><td><code>true</code></td><td>Controls which interactions close the menu.</td></tr>\r
            <tr><td><code>animation</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>undefined</code></td><td>Exposed by the directive factory; it currently has no runtime effect.</td></tr>\r
            <tr><td><code>container</code></td><td><code>@?</code></td><td><code>null | "body"</code></td><td><code>null</code></td><td>Moves the menu to the document body.</td></tr>\r
            <tr><td><code>display</code></td><td><code>&lt;?</code></td><td><code>"dynamic" | "static"</code></td><td>Contextual</td><td>Enables or bypasses Popper positioning.</td></tr>\r
            <tr><td><code>dropdown-class</code></td><td><code>&lt;?</code></td><td><code>string</code></td><td>—</td><td>Adds a class to the dropdown container.</td></tr>\r
            <tr><td><code>open</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Sets the open state.</td></tr>\r
            <tr><td><code>placement</code></td><td><code>&lt;?</code></td><td><code>Placement[]</code></td><td><code>$config.placement</code></td><td>Preferred Popper placements.</td></tr>\r
            <tr><td><code>popper-options</code></td><td><code>&lt;?</code></td><td><code>function</code></td><td><code>$config.popperOptions</code></td><td>Transforms Popper options.</td></tr>\r
        </tbody>\r
    </table></div>\r
    <h3 class="h5 mt-4 mb-3">Outputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0">\r
        <thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead>\r
        <tbody><tr><td><code>open-change</code></td><td><code>&amp;?</code></td><td><code>$event: boolean</code></td><td>The dropdown opens or closes.</td></tr></tbody>\r
    </table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-dropdown-anchor">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbDropdownAnchor</code></h2><p class="text-body-secondary mb-0">Marks the element used for positioning without adding click behavior.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;button ngb-dropdown-anchor&gt;</code></dd><dt class="col-sm-3 fw-semibold">Requires</dt><dd class="col-sm-9 mb-0">An ancestor <code>ngb-dropdown</code>.</dd></dl>\r
    <p class="small text-body-secondary mt-3 mb-0">No public inputs or outputs.</p>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-dropdown-toggle">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbDropdownToggle</code></h2><p class="text-body-secondary mb-0">Extends the anchor with click and keyboard toggle behavior.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;button ngb-dropdown-toggle&gt;</code></dd><dt class="col-sm-3 fw-semibold">Requires</dt><dd class="col-sm-9 mb-0">An ancestor <code>ngb-dropdown</code>.</dd></dl>\r
    <p class="small text-body-secondary mt-3 mb-0">No public inputs or outputs.</p>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-dropdown-menu">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbDropdownMenu</code></h2><p class="text-body-secondary mb-0">Hosts menu items and coordinates keyboard navigation with the root dropdown.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;div ngb-dropdown-menu&gt;</code></dd><dt class="col-sm-3 fw-semibold">Requires</dt><dd class="col-sm-9 mb-0">An ancestor <code>ngb-dropdown</code>.</dd></dl>\r
    <p class="small text-body-secondary mt-3 mb-0">No public inputs or outputs.</p>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-dropdown-item">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbDropdownItem</code></h2><p class="text-body-secondary mb-0">Marks an interactive menu entry and integrates with <code>ng-disabled</code>.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;button ngb-dropdown-item&gt;</code></dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>tabindex</code></td><td><code>&lt;?</code></td><td><code>string | number</code></td><td><code>0</code></td><td>Sets the enabled tab order.</td></tr>\r
        <tr><td><code>ng-disabled</code></td><td><code>ngDisabled</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Disables focus and activation.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-dropdown-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbDropdownConfig</code></h2><p class="text-body-secondary mb-0">Provides application-wide dropdown defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Type</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>autoClose</code></td><td><code>boolean | "inside" | "outside"</code></td><td><code>true</code></td></tr>\r
        <tr><td><code>container</code></td><td><code>null | "body"</code></td><td><code>null</code></td></tr>\r
        <tr><td><code>placement</code></td><td><code>Placement[]</code></td><td><code>["bottom-start", "bottom-end", "top-start", "top-end"]</code></td></tr>\r
        <tr><td><code>popperOptions</code></td><td><code>function</code></td><td>Identity transform</td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/modal-api-page/modal-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-modal">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbModal</code></h2><p class="text-body-secondary mb-0">Creates and coordinates modal instances from templates or components.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Members</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Member</th><th>Returns</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>open(content, options?)</code></td><td><code>NgbModalRef</code></td><td>Opens content with options merged over <code>NgbModalConfig</code>.</td></tr>\r
        <tr><td><code>activeInstances</code></td><td>Active modal collection</td><td>Exposes the currently open modal instances.</td></tr>\r
        <tr><td><code>dismissAll(reason?)</code></td><td><code>void</code></td><td>Dismisses every open modal.</td></tr>\r
        <tr><td><code>hasOpenModals()</code></td><td><code>boolean</code></td><td>Reports whether a modal is open.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-modal-ref">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Class</p><h2 class="h3 mb-2"><code class="text-body">NgbModalRef</code></h2><p class="text-body-secondary mb-0">Controls one modal and exposes its result and lifecycle streams.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Members</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Member</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>close(result?)</code></td><td>Resolves <code>result</code> and closes the modal.</td></tr>\r
        <tr><td><code>dismiss(reason?)</code></td><td>Rejects <code>result</code> and dismisses the modal.</td></tr>\r
        <tr><td><code>update(options)</code></td><td>Updates supported window and backdrop options.</td></tr>\r
        <tr><td><code>result</code></td><td>AngularJS promise settled by close or dismiss.</td></tr>\r
        <tr><td><code>closed</code>, <code>dismissed</code>, <code>shown</code>, <code>hidden</code></td><td>Observable lifecycle streams.</td></tr>\r
        <tr><td><code>componentInstance</code></td><td>Component controller instance when component content is used.</td></tr>\r
    </tbody></table></div>\r
...
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-active-modal">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbActiveModal</code></h2><p class="text-body-secondary mb-0">Allows modal content to control the modal that contains it.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Methods</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Method</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>close(result?)</code></td><td>Closes with an optional result.</td></tr>\r
        <tr><td><code>dismiss(reason?)</code></td><td>Dismisses with an optional reason.</td></tr>\r
        <tr><td><code>update(options)</code></td><td>Updates supported modal options.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-modal-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbModalConfig</code></h2><p class="text-body-secondary mb-0">Provides defaults merged into every <code>open()</code> call.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Options</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Option</th><th>Default</th><th>Description</th></tr></thead><tbody>\r
        <tr><td><code>animation</code></td><td><code>$config.animation</code></td><td>Enables modal and backdrop transitions.</td></tr>\r
        <tr><td><code>backdrop</code></td><td><code>true</code></td><td>Accepts <code>true</code>, <code>false</code> or <code>"static"</code>.</td></tr>\r
        <tr><td><code>keyboard</code></td><td><code>true</code></td><td>Allows Escape-key dismissal.</td></tr>\r
        <tr><td><code>centered</code>, <code>scrollable</code></td><td><code>undefined</code></td><td>Controls dialog layout.</td></tr>\r
        <tr><td><code>fullscreen</code></td><td><code>false</code></td><td>Enables full-screen mode at an optional breakpoint.</td></tr>\r
        <tr><td><code>role</code></td><td><code>"dialog"</code></td><td>Sets the dialog ARIA role.</td></tr>\r
        <tr><td><code>size</code></td><td><code>undefined</code></td><td>Accepts <code>"sm"</code>, <code>"lg"</code> or <code>"xl"</code>.</td></tr>\r
        <tr><td><code>ariaLabelledBy</code>, <code>ariaDescribedBy</code></td><td><code>undefined</code></td><td>Connect accessible label and description elements.</td></tr>\r
        <tr><td><code>container</code>, <code>injector</code>, <code>bindings</code></td><td><code>undefined</code></td><td>Control content creation and placement.</td></tr>\r
        <tr><td><code>windowClass</code>, <code>modalDialogClass</code>, <code>backdropClass</code></td><td><code>undefined</code></td><td>Add custom classes.</td></tr>\r
        <tr><td><code>beforeDismiss</code></td><td><code>undefined</code></td><td>Can cancel dismissal synchronously or asynchronously.</td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/collapse-api-page/collapse-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-collapse">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Directive</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbCollapse</code></h2>\r
        <p class="text-body-secondary mb-0">\r
            Controls the visible state of an element and runs vertical or horizontal Bootstrap collapse transitions.\r
        </p>\r
    </header>\r
\r
    <dl class="row gy-2 mb-0">\r
        <dt class="col-sm-3 fw-semibold">Markup</dt>\r
        <dd class="col-sm-9 mb-0"><code>&lt;div ngb-collapse="isCollapsed"&gt;</code></dd>\r
    </dl>\r
\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive">\r
        <table class="table table-sm align-middle">\r
            <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
            <tbody>\r
                <tr><td><code>ngb-collapse</code></td><td><code>&lt;</code></td><td><code>boolean</code></td><td>Required</td><td>Sets whether the host is collapsed.</td></tr>\r
                <tr><td><code>animation</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td><td>Enables transition animation.</td></tr>\r
                <tr><td><code>horizontal</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Uses width instead of height for the transition.</td></tr>\r
            </tbody>\r
        </table>\r
    </div>\r
\r
    ...
    <div class="table-responsive">\r
        <table class="table table-sm align-middle mb-0">\r
            <thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead>\r
            <tbody>\r
                <tr><td><code>ngb-collapse-change</code></td><td><code>&amp;?</code></td><td><code>$event: boolean</code></td><td><code>toggle()</code> changes the collapsed state.</td></tr>\r
                <tr><td><code>shown</code></td><td><code>&amp;?</code></td><td>None</td><td>The expand transition finishes.</td></tr>\r
                <tr><td><code>ngb-hidden</code></td><td><code>&amp;?</code></td><td>None</td><td>The collapse transition finishes.</td></tr>\r
            </tbody>\r
        </table>\r
    </div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-collapse-config">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Service</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbCollapseConfig</code></h2>\r
        <p class="text-body-secondary mb-0">Provides application-wide defaults for collapse directives.</p>\r
    </header>\r
\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive">\r
        <table class="table table-sm align-middle mb-0">\r
            <thead><tr><th>Property</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
            <tbody>\r
                <tr><td><code>animation</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td><td>Default transition animation state.</td></tr>\r
                <tr><td><code>horizontal</code></td><td><code>boolean</code></td><td><code>false</code></td><td>Default transition orientation.</td></tr>\r
            </tbody>\r
        </table>\r
    </div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/carousel-examples-page/carousel-examples-page.component.html`,`<docs-example-section\r
    fragment="carousel-simple"\r
    title="Simple carousel"\r
    description="A carousel using the default options, including navigation arrows and indicators."\r
    html-code="$.examples.simple.html">\r
    <docs-carousel-simple></docs-carousel-simple>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="carousel-keyboard"\r
    title="Keyboard navigation"\r
    description="A carousel without visible controls or indicators that moves only with the left and right arrow keys."\r
    html-code="$.examples.keyboard.html">\r
    <docs-carousel-keyboard></docs-carousel-keyboard>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="carousel-controls"\r
    title="Pause controls"\r
    description="Try the native hover and focus options, then compose navigation behavior from slide events."\r
    html-code="$.examples.controls.html"\r
    ts-code="$.examples.controls.typescript">\r
    <docs-carousel-controls></docs-carousel-controls>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="carousel-global"\r
    title="Global configuration"\r
    description="Change NgbCarouselConfig once to define carousel defaults without adding local inputs."\r
    html-code="$.examples.global.html"\r
    ts-code="$.examples.global.typescript">\r
    <docs-carousel-global></docs-carousel-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/datepicker-api-page/datepicker-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-datepicker">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Component</p><h2 class="h3 mb-2"><code class="text-body">NgbDatepicker</code></h2><p class="text-body-secondary mb-0">Renders an inline calendar and integrates its selected date with AngularJS forms.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ngb-datepicker ng-model="date"&gt;</code></dd><dt class="col-sm-3 fw-semibold">Integration</dt><dd class="col-sm-9 mb-0">Optionally reads <code>ng-model</code> and <code>ng-disabled</code>.</dd></dl>\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Default</th><th>Description</th></tr></thead><tbody>\r
            <tr><td><code>calendar</code></td><td><code>&lt;?</code></td><td><code>NgbCalendarGregorian</code></td><td>Calendar system used for date arithmetic.</td></tr>\r
            <tr><td><code>date-adapter</code></td><td><code>&lt;?</code></td><td><code>NgbDateStructAdapter</code></td><td>Converts between the model and <code>NgbDateStruct</code>.</td></tr>\r
            <tr><td><code>i18n</code></td><td><code>&lt;?</code></td><td><code>NgbDatepickerI18nDefault</code></td><td>Supplies localized labels.</td></tr>\r
            <tr><td><code>display-months</code></td><td><code>&lt;?</code></td><td><code>1</code></td><td>Number of visible months.</td></tr>\r
            <tr><td><code>first-day-of-week</code></td><td><code>&lt;?</code></td><td><code>1</code></td><td>First weekday, from 1 (Monday) to 7 (Sunday).</td></tr>\r
            <tr><td><code>min-date</code>, <code>max-date</code></td><td><code>&lt;?</code></td><td><code>undefined</code></td><td>Selectable date boundaries.</td></tr>\r
            <tr><td><code>start-date</code></td><td><code>&lt;?</code></td><td><code>undefined</code></td><td>Initial month displayed when no model is selected.</td></tr>\r
            <tr><td><code>navigation</code></td><td><code>@?</code></td><td><code>"select"</code></td><td>Accepts <code>"select"</code>, <code>"arrows"</code> or <code>"none"</code>.</td></tr>\r
            <tr><td><code>outside-days</code></td><td><code>@?</code></td><td><code>"visible"</code></td><td>Controls days outside the current month.</td></tr>\r
            <tr><td><code>weekdays</code></td><td><code>&lt;?</code></td><td><code>"narrow"</code></td><td>Controls weekday labels and width.</td></tr>\r
            <tr><td><code>show-week-numbers</code></td><td><code>&lt;?</code></td><td><code>false</code></td><td>Displays week numbers.</td></tr>\r
            <tr><td><code>mark-disabled</code></td><td><code>&lt;?</code></td><td><code>undefined</code></td><td>Function that disables individual dates.</td></tr>\r
            <tr><td><code>day-template</code>, <code>footer-template</code>, <code>content-template</code></td><td><code>&lt;?</code></td><td>Built-in templates</td><td>Customize calendar rendering.</td></tr>\r
            <tr><td><code>day-template-data</code></td><td><code>&lt;?</code></td><td><code>undefined</code></td><td>Supplies custom data to day templates.</td></tr>\r
        </tbody>\r
    </table></div>\r
    <h3 class="h5 mt-4 mb-3">Outputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Output</th><th>Payload</th><th>Emitted when</th></tr></thead><tbody>\r
        <tr><td><code>date-select</code></td><td><code>$event: NgbDate</code></td><td>A date is selected.</td></tr>\r
        <tr><td><code>navigate</code></td><td><code>$event: NgbDatepickerNavigateEvent</code></td><td>The visible month changes.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-input-datepicker">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Directive</p><h2 class="h3 mb-2"><code class="text-body">NgbInputDatepicker</code></h2><p class="text-body-secondary mb-0">Adds a popup calendar to an input while preserving AngularJS model parsing and validation.</p></header>\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;input ng-model="date" ngb-datepicker&gt;</code></dd><dt class="col-sm-3 fw-semibold">Requires</dt><dd class="col-sm-9 mb-0"><code>ng-model</code>; optionally reads <code>ng-disabled</code>.</dd></dl>\r
    <p class="small text-body-secondary mt-3 mb-0">Accepts the calendar inputs above plus the popup-specific inputs below.</p>\r
    <h3 class="h5 mt-4 mb-3">Popup inputs</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle">\r
        <thead><tr><th>Input</th><th>Binding</th><th>Default</th><th>Description</th></tr></thead><tbody>\r
            <tr><td><code>auto-close</code></td><td><code>&lt;?</code></td><td><code>true</code></td><td>Controls which selections or outside clicks close the popup.</td></tr>\r
            <tr><td><code>container</code></td><td><code>@?</code></td><td><code>null</code></td><td>Accepts <code>"body"</code> to move the popup.</td></tr>\r
            <tr><td><code>placement</code></td><td><code>&lt;?</code></td><td><code>$config.placement</code></td><td>Preferred Popper placements.</td></tr>\r
            <tr><td><code>popper-options</code></td><td><code>&lt;?</code></td><td><code>$config.popperOptions</code></td><td>Transforms Popper options.</td></tr>\r
            <tr><td><code>position-target</code></td><td><code>&lt;?</code></td><td>Input element</td><td>Overrides the positioning target.</td></tr>\r
            <tr><td><code>restore-focus</code></td><td><code>&lt;?</code></td><td><code>true</code></td><td>Restores focus after closing.</td></tr>\r
            <tr><td><code>datepicker-class</code></td><td><code>@?</code></td><td>—</td><td>Adds a class to the popup calendar.</td></tr>\r
            <tr><td><code>parser-formatter</code></td><td><code>&lt;?</code></td><td><code>NgbDateISOParserFormatter</code></td><td>Parses and formats the input text.</td></tr>\r
            <tr><td><code>disabled</code></td><td><code>&lt;?</code></td><td><code>false</code></td><td>Disables input behavior.</td></tr>\r
        </tbody>\r
    </table></div>\r
    <h3 class="h5 mt-4 mb-3">Additional output</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Output</th><th>Payload</th><th>Emitted when</th></tr></thead><tbody>\r
        <tr><td><code>closed</code></td><td>None</td><td>The popup calendar closes.</td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-datepicker-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbDatepickerConfig</code></h2><p class="text-body-secondary mb-0">Provides defaults for inline and popup calendars.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>displayMonths</code>, <code>firstDayOfWeek</code></td><td><code>1</code></td></tr>\r
        <tr><td><code>navigation</code></td><td><code>"select"</code></td></tr>\r
        <tr><td><code>outsideDays</code></td><td><code>"visible"</code></td></tr>\r
        <tr><td><code>weekdays</code></td><td><code>"narrow"</code></td></tr>\r
        <tr><td><code>showWeekNumbers</code></td><td><code>false</code></td></tr>\r
        <tr><td><code>minDate</code>, <code>maxDate</code>, <code>startDate</code>, templates and callbacks</td><td><code>undefined</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-input-datepicker-config">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Service</p><h2 class="h3 mb-2"><code class="text-body">NgbInputDatepickerConfig</code></h2><p class="text-body-secondary mb-0">Extends <code>NgbDatepickerConfig</code> with popup defaults.</p></header>\r
    <h3 class="h5 mt-4 mb-3">Additional properties</h3>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Property</th><th>Default</th></tr></thead><tbody>\r
        <tr><td><code>autoClose</code></td><td><code>true</code></td></tr>\r
        <tr><td><code>container</code></td><td><code>null</code></td></tr>\r
        <tr><td><code>placement</code></td><td><code>["bottom-start", "bottom-end", "top-start", "top-end"]</code></td></tr>\r
        <tr><td><code>popperOptions</code></td><td>Identity transform</td></tr>\r
        <tr><td><code>restoreFocus</code></td><td><code>true</code></td></tr>\r
        <tr><td><code>positionTarget</code></td><td><code>undefined</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-datepicker-extension-contracts">\r
    <header class="mb-3"><p class="small fw-semibold text-primary mb-1">Interfaces</p><h2 class="h3 mb-2">Calendar and formatting contracts</h2><p class="text-body-secondary mb-0">Pass custom implementations through the corresponding datepicker inputs.</p></header>\r
    <div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>Contract</th><th>Purpose</th><th>Core methods</th></tr></thead><tbody>\r
        <tr><td><code>NgbCalendar</code></td><td>Date arithmetic and calendar rules.</td><td><code>getNext()</code>, <code>getPrev()</code>, <code>getToday()</code>, <code>isValid()</code></td></tr>\r
        <tr><td><code>NgbDateAdapter&lt;D&gt;</code></td><td>Application model conversion.</td><td><code>fromModel()</code>, <code>toModel()</code></td></tr>\r
        <tr><td><code>NgbDateParserFormatter</code></td><td>Popup input text conversion.</td><td><code>parse()</code>, <code>format()</code></td></tr>\r
        <tr><td><code>NgbDatepickerI18n</code></td><td>Localized month, weekday, day and ARIA labels.</td><td><code>getWeekdayLabel()</code>, <code>getMonthFullName()</code>, <code>getDayAriaLabel()</code></td></tr>\r
    </tbody></table></div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/carousel-api-page/carousel-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-carousel">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Component</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbCarousel</code></h2>\r
        <p class="text-body-secondary mb-0">Coordinates slides, navigation, cycling, pause behavior and transitions.</p>\r
    </header>\r
\r
    <dl class="row gy-2 mb-0"><dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ngb-carousel&gt;</code></dd></dl>\r
\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive">\r
        <table class="table table-sm align-middle">\r
            <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
            <tbody>\r
                <tr><td><code>active-id</code></td><td><code>@?</code></td><td><code>string</code></td><td>First slide</td><td>Identifies the active slide.</td></tr>\r
                <tr><td><code>animation</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td><td>Enables slide transitions.</td></tr>\r
                <tr><td><code>interval</code></td><td><code>&lt;?</code></td><td><code>number</code></td><td><code>5000</code></td><td>Delay between automatic slides in milliseconds; <code>0</code> disables cycling.</td></tr>\r
                <tr><td><code>keyboard</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Enables keyboard navigation.</td></tr>\r
                <tr><td><code>pause-on-focus</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Pauses cycling while focused.</td></tr>\r
                <tr><td><code>pause-on-hover</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Pauses cycling while hovered.</td></tr>\r
                <tr><td><code>show-navigation-arrows</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Displays previous and next controls.</td></tr>\r
                <tr><td><code>show-navigation-indicators</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Displays slide indicators.</td></tr>\r
                <tr><td><code>wrap</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Wraps navigation at the first and last slide.</td></tr>\r
            </tbody>\r
        </table>\r
    </div>\r
\r
    ...
    <div class="table-responsive">\r
        <table class="table table-sm align-middle mb-0">\r
            <thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead>\r
            <tbody>\r
                <tr><td><code>slide</code></td><td><code>&amp;?</code></td><td><code>$event: NgbSlideEvent</code></td><td>A slide transition starts.</td></tr>\r
                <tr><td><code>slid</code></td><td><code>&amp;?</code></td><td><code>$event: NgbSlideEvent</code></td><td>A slide transition finishes.</td></tr>\r
            </tbody>\r
        </table>\r
    </div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-slide">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Directive</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbSlide</code></h2>\r
        <p class="text-body-secondary mb-0">Marks projected content as a carousel slide.</p>\r
    </header>\r
    <dl class="row gy-2 mb-0">\r
        <dt class="col-sm-3 fw-semibold">Markup</dt><dd class="col-sm-9 mb-0"><code>&lt;ng-template ngb-slide&gt;</code></dd>\r
        <dt class="col-sm-3 fw-semibold">Requires</dt><dd class="col-sm-9 mb-0">An ancestor <code>ngb-carousel</code>.</dd>\r
    </dl>\r
    <h3 class="h5 mt-4 mb-3">Bindings</h3>\r
    <div class="table-responsive">\r
        <table class="table table-sm align-middle mb-0">\r
            <thead><tr><th>Name</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
            <tbody>\r
                <tr><td><code>id</code></td><td><code>@?</code></td><td><code>string</code></td><td>Generated id</td><td>Identifies the slide.</td></tr>\r
                <tr><td><code>slid</code></td><td><code>&amp;?</code></td><td><code>$event: NgbSingleSlideEvent</code></td><td>—</td><td>Runs when this slide completes a transition.</td></tr>\r
            </tbody>\r
        </table>\r
    </div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-carousel-config">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Service</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbCarouselConfig</code></h2>\r
        <p class="text-body-secondary mb-0">Provides application-wide carousel defaults.</p>\r
    </header>\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive">\r
        <table class="table table-sm align-middle mb-0">\r
            <thead><tr><th>Property</th><th>Type</th><th>Default</th></tr></thead>\r
            <tbody>\r
                <tr><td><code>animation</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td></tr>\r
                <tr><td><code>interval</code></td><td><code>number</code></td><td><code>5000</code></td></tr>\r
                <tr><td><code>wrap</code>, <code>keyboard</code>, <code>pauseOnFocus</code>, <code>pauseOnHover</code></td><td><code>boolean</code></td><td><code>true</code></td></tr>\r
                <tr><td><code>showNavigationArrows</code>, <code>showNavigationIndicators</code></td><td><code>boolean</code></td><td><code>true</code></td></tr>\r
            </tbody>\r
        </table>\r
    </div>\r
</section>\r
`),e.put(`src/app/features/lib/pages/collapse-examples-page/collapse-examples-page.component.html`,`<docs-example-section\r
    fragment="simple-collapse"\r
    title="Simple collapse"\r
    description="Control the same panel by calling toggle() on its controller or by changing the bound collapsed value."\r
    html-code="$.examples.simple.html"\r
    ts-code="$.examples.simple.typescript">\r
    <docs-simple-collapse></docs-simple-collapse>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="horizontal-collapse"\r
    title="Horizontal collapse"\r
    description="Set horizontal to true to animate the element's width instead of its height."\r
    html-code="$.examples.horizontal.html"\r
    ts-code="$.examples.horizontal.typescript">\r
    <docs-horizontal-collapse></docs-horizontal-collapse>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="navbar-collapse"\r
    title="Responsive navbar"\r
    description="Combine NgbCollapse with Bootstrap's navbar classes to provide compact navigation on smaller viewports."\r
    html-code="$.examples.navbar.html"\r
    ts-code="$.examples.navbar.typescript">\r
    <docs-navbar-collapse></docs-navbar-collapse>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/accordion-examples-page/accordion-examples-page.component.html`,`<docs-example-section\r
    fragment="accordion-simple"\r
    title="Basic accordion"\r
    description="Three items with a regular header, a header rendered from a template and a disabled item."\r
    html-code="$.examples.simple.html">\r
    <docs-accordion-simple></docs-accordion-simple>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="one-panel-accordion"\r
    title="One panel at a time"\r
    description="Opening an item automatically closes the previously expanded panel."\r
    html-code="$.examples.onePanel.html">\r
    <docs-one-panel-accordion></docs-one-panel-accordion>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="accordion-toggle-panels"\r
    title="Programmatic controls"\r
    description="Use the accordion controller to expand, collapse or toggle panels by id."\r
    html-code="$.examples.togglePanels.html"\r
    ts-code="$.examples.togglePanels.typescript">\r
    <docs-accordion-toggle-panels></docs-accordion-toggle-panels>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="accordion-custom-header"\r
    title="Custom headers"\r
    description="Build richer triggers with Bootstrap utilities while keeping the accordion behavior and accessibility state."\r
    html-code="$.examples.customHeader.html">\r
    <docs-accordion-custom-header></docs-accordion-custom-header>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="accordion-content"\r
    title="Preserve panel content"\r
    description="Keep collapsed content mounted when its local state must survive closing and reopening the panel."\r
    html-code="$.examples.content.html"\r
    ts-code="$.examples.content.typescript">\r
    <docs-accordion-content></docs-accordion-content>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="accordion-global"\r
    title="Global configuration"\r
    description="Change NgbAccordionConfig once to define defaults for accordions that do not provide local values."\r
    html-code="$.examples.global.html"\r
    ts-code="$.examples.global.typescript">\r
    <docs-accordion-global></docs-accordion-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/alert-examples-page/alert-examples-page.component.html`,`<docs-example-section\r
    fragment="simple-alert"\r
    title="Simple alert"\r
    description="A basic alert with a fixed type and no dismiss button."\r
    html-code="$.examples.simple.html">\r
    <docs-simple-alert></docs-simple-alert>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="alert-closeable"\r
    title="Closeable alerts"\r
    description="Four dismissible alerts: two close with animation and two close immediately."\r
    html-code="$.examples.closeable.html"\r
    ts-code="$.examples.closeable.typescript">\r
    <docs-alert-closeable></docs-alert-closeable>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="self-closing-alert"\r
    title="Self-closing alert"\r
    description="A timeout updates the countdown and closes the alert when it reaches zero."\r
    html-code="$.examples.selfClosing.html"\r
    ts-code="$.examples.selfClosing.typescript">\r
    <docs-self-closing-alert></docs-self-closing-alert>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="alert-custom"\r
    title="Custom alert"\r
    description="A custom alert type styled through the alert-custom class and Bootstrap variables."\r
    html-code="$.examples.custom.html"\r
    css-code="$.examples.custom.css">\r
    <docs-alert-custom></docs-alert-custom>\r
</docs-example-section>\r
\r
<docs-example-section\r
    fragment="alert-global"\r
    title="Global configuration"\r
    description="Change NgbAlertConfig once to define defaults for alerts without local inputs."\r
    html-code="$.examples.global.html"\r
    ts-code="$.examples.global.typescript">\r
    <docs-alert-global></docs-alert-global>\r
</docs-example-section>\r
`),e.put(`src/app/features/lib/pages/accordion-api-page/accordion-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-accordion">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Directive</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbAccordion</code></h2>\r
        <p class="text-body-secondary mb-0">\r
            Root directive that coordinates all accordion items. It applies the Bootstrap accordion structure,\r
            controls whether multiple items may remain open and exposes methods for toggling items by id.\r
        </p>\r
    </header>\r
\r
    <dl class="row gy-3 mb-0">\r
        <dt class="col-sm-3 fw-semibold">Markup</dt>\r
        <dd class="col-sm-9 mb-0"><code>&lt;div ngb-accordion&gt;</code></dd>\r
\r
    </dl>\r
\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive">\r
        <table class="table table-sm align-middle">\r
            <thead>\r
                <tr>\r
                    <th scope="col">Input</th>\r
                    <th scope="col">Binding</th>\r
                    <th scope="col">Type</th>\r
                    <th scope="col">Default</th>\r
                    <th scope="col">Description</th>\r
                </tr>\r
            </thead>\r
            <tbody>\r
                <tr>\r
                    <td><code>animation</code></td>\r
                    <td><code>&lt;?</code></td>\r
                    <td><code>boolean</code></td>\r
                    <td><code>$config.animation</code></td>\r
                    <td>Enables the collapse transition.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>close-others</code></td>\r
                    <td><code>&lt;?</code></td>\r
                    <td><code>boolean</code></td>\r
                    <td><code>false</code></td>\r
                    <td>Closes the currently expanded item before another one opens.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>destroy-on-hide</code></td>\r
                    <td><code>&lt;?</code></td>\r
                    <td><code>boolean</code></td>\r
                    <td><code>true</code></td>\r
                    <td>Removes a collapsed item's body view from the DOM.</td>\r
                </tr>\r
            </tbody>\r
        </table>\r
    </div>\r
\r
    ...
    <div class="table-responsive">\r
        <table class="table table-sm align-middle mb-0">\r
            <thead>\r
                <tr>\r
                    <th scope="col">Output</th>\r
                    <th scope="col">Binding</th>\r
                    <th scope="col">Payload</th>\r
                    <th scope="col">Emitted when</th>\r
                </tr>\r
            </thead>\r
            <tbody>\r
                <tr>\r
                    <td><code>show</code></td>\r
                    <td><code>&amp;?</code></td>\r
                    <td><code>$event: string</code></td>\r
                    <td>An item starts expanding; <code>$event</code> is its id.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>shown</code></td>\r
                    <td><code>&amp;?</code></td>\r
                    <td><code>$event: string</code></td>\r
                    <td>An item finishes expanding.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>hide</code></td>\r
                    <td><code>&amp;?</code></td>\r
                    <td><code>$event: string</code></td>\r
                    <td>An item starts collapsing.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>hidden</code></td>\r
                    <td><code>&amp;?</code></td>\r
                    <td><code>$event: string</code></td>\r
                    <td>An item finishes collapsing.</td>\r
                </tr>\r
            </tbody>\r
        </table>\r
    </div>\r
...
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-accordion-item">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Directive</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbAccordionItem</code></h2>\r
        <p class="text-body-secondary mb-0">\r
            Represents one collapsible item. It owns the item id and collapsed state, applies per-item\r
            <code>destroyOnHide</code> behavior and emits the item lifecycle events.\r
        </p>\r
    </header>\r
\r
    <dl class="row gy-3 mb-0">\r
        <dt class="col-sm-3 fw-semibold">Markup</dt>\r
        <dd class="col-sm-9 mb-0"><code>&lt;div ngb-accordion-item="'details'"&gt;</code></dd>\r
\r
        <dt class="col-sm-3 fw-semibold">Requires</dt>\r
        <dd class="col-sm-9 mb-0">\r
            An ancestor <code>ngb-accordion</code>; optionally reads <code>ng-disabled</code>.\r
        </dd>\r
\r
    </dl>\r
\r
    ...
    <div class="table-responsive">\r
        <table class="table table-sm align-middle">\r
            ...
            <tbody>\r
                <tr>\r
                    <td><code>ngb-accordion-item</code></td>\r
                    <td><code>&lt;?</code></td>\r
                    <td><code>string</code></td>\r
                    <td>Generated id</td>\r
                    <td>Expression that identifies the item in the parent accordion.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>collapsed</code></td>\r
                    <td><code>&lt;?</code></td>\r
                    <td><code>boolean</code></td>\r
                    <td><code>true</code></td>\r
                    <td>Controls the initial and current collapsed state.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>destroy-on-hide</code></td>\r
                    <td><code>&lt;?</code></td>\r
                    <td><code>boolean</code></td>\r
                    <td>Inherited</td>\r
                    <td>Overrides the parent accordion setting for this item.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>ng-disabled</code></td>\r
                    <td><code>ngDisabled</code></td>\r
                    <td><code>boolean</code></td>\r
                    <td><code>false</code></td>\r
                    <td>Prevents the item's trigger from changing its state.</td>\r
                </tr>\r
            </tbody>\r
        </table>\r
    </div>\r
        ...
        <table class="table table-sm align-middle mb-0">\r
            ...
            <tbody>\r
                <tr>\r
                    ...
                    <td><code>&amp;?</code></td>\r
                    <td>None</td>\r
                    <td>This item starts expanding.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>shown</code></td>\r
                    <td><code>&amp;?</code></td>\r
                    <td>None</td>\r
                    <td>This item finishes expanding.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>hide</code></td>\r
                    <td><code>&amp;?</code></td>\r
                    <td>None</td>\r
                    <td>This item starts collapsing.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>hidden</code></td>\r
                    <td><code>&amp;?</code></td>\r
                    <td>None</td>\r
                    <td>This item finishes collapsing.</td>\r
                </tr>\r
            </tbody>\r
        </table>\r
    </div>\r
...
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-accordion-header">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Directive</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbAccordionHeader</code></h2>\r
        <p class="text-body-secondary mb-0">\r
            Marks an item's heading container. It adds the Bootstrap header class and heading semantics, and\r
            mirrors the collapsed state without handling the toggle action itself.\r
        </p>\r
    </header>\r
\r
    <dl class="row gy-3 mb-0">\r
        <dt class="col-sm-3 fw-semibold">Markup</dt>\r
        <dd class="col-sm-9 mb-0"><code>&lt;h2 ngb-accordion-header&gt;</code></dd>\r
\r
        <dt class="col-sm-3 fw-semibold">Requires</dt>\r
        <dd class="col-sm-9 mb-0">An ancestor <code>ngb-accordion-item</code>.</dd>\r
    </dl>\r
\r
    <p class="small text-body-secondary mt-3 mb-0">No public inputs or outputs.</p>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-accordion-button">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Directive</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbAccordionButton</code></h2>\r
        <p class="text-body-secondary mb-0">\r
            Provides the standard Bootstrap accordion trigger. It configures the button type, classes and ARIA\r
            state, respects <code>ng-disabled</code> and toggles its containing item when clicked.\r
        </p>\r
    </header>\r
\r
    <dl class="row gy-3 mb-0">\r
        <dt class="col-sm-3 fw-semibold">Markup</dt>\r
        <dd class="col-sm-9 mb-0"><code>&lt;button ngb-accordion-button&gt;</code></dd>\r
\r
        <dt class="col-sm-3 fw-semibold">Requires</dt>\r
        <dd class="col-sm-9 mb-0">\r
            Ancestor controllers for <code>ngb-accordion-item</code> and <code>ngb-accordion</code>.\r
        </dd>\r
    </dl>\r
\r
    <p class="small text-body-secondary mt-3 mb-0">No public inputs or outputs.</p>\r
...
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-accordion-toggle">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Directive</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbAccordionToggle</code></h2>\r
        <p class="text-body-secondary mb-0">\r
            Adds toggle behavior and accessible state to custom header markup. Use it when the trigger should not\r
            receive the standard <code>accordion-button</code> presentation supplied by\r
            <code>NgbAccordionButton</code>.\r
        </p>\r
    </header>\r
\r
    <dl class="row gy-3 mb-0">\r
        <dt class="col-sm-3 fw-semibold">Markup</dt>\r
        <dd class="col-sm-9 mb-0"><code>&lt;span ngb-accordion-toggle&gt;</code></dd>\r
\r
        <dt class="col-sm-3 fw-semibold">Requires</dt>\r
        <dd class="col-sm-9 mb-0">\r
            Ancestor controllers for <code>ngb-accordion-item</code> and <code>ngb-accordion</code>.\r
...
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-accordion-body">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Directive</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbAccordionBody</code></h2>\r
        <p class="text-body-secondary mb-0">\r
            Hosts the item's body template. Content is supplied through a child <code>ng-template</code> and its\r
            embedded view is created or destroyed according to the item state and <code>destroyOnHide</code>.\r
        </p>\r
    </header>\r
\r
    <dl class="row gy-3 mb-0">\r
        <dt class="col-sm-3 fw-semibold">Markup</dt>\r
        <dd class="col-sm-9 mb-0"><code>&lt;div ngb-accordion-body&gt;</code></dd>\r
\r
        <dt class="col-sm-3 fw-semibold">Requires</dt>\r
        <dd class="col-sm-9 mb-0">An ancestor <code>ngb-accordion-item</code>.</dd>\r
    </dl>\r
...
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-accordion-config">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Service</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbAccordionConfig</code></h2>\r
        <p class="text-body-secondary mb-0">\r
            Provides application-wide default values for accordions. Configure it once during application setup;\r
            values supplied directly to an <code>ngb-accordion</code> instance take precedence.\r
        </p>\r
    </header>\r
\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
        ...
        <table class="table table-sm align-middle mb-0">\r
            ...
            <tbody>\r
                <tr>\r
                    ...
                    <td><code>boolean</code></td>\r
                    <td><code>$config.animation</code></td>\r
                    <td>Sets the default animation behavior for every accordion.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>closeOthers</code></td>\r
                    <td><code>boolean</code></td>\r
                    <td><code>false</code></td>\r
                    <td>Sets whether opening an item closes the previously expanded item.</td>\r
                </tr>\r
                <tr>\r
                    <td><code>destroyOnHide</code></td>\r
                    <td><code>boolean</code></td>\r
                    <td><code>true</code></td>\r
                    <td>Sets whether hidden body views are removed from the DOM.</td>\r
                </tr>\r
            </tbody>\r
        </table>\r
    </div>\r
</section>\r
`),e.put(`src/app/features/lib/components/wikipedia-typeahead/wikipedia-typeahead.component.html`,`<label class="form-label" for="wikipedia-typeahead">Search for a Wikipedia page</label>\r
...
`),e.put(`src/app/features/lib/components/vertical-nav/vertical-nav.component.html`,`<div class="d-flex align-items-start gap-3">\r
    <div\r
        ngb-nav\r
...
`),e.put(`src/app/features/lib/components/typeahead-global/typeahead-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
...
`),e.put(`src/app/features/lib/pages/alert-api-page/alert-api-page.component.html`,`<div class="d-flex flex-wrap gap-2 mb-5" aria-label="Binding legend">\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&lt;?</code> input</span>\r
    <span class="badge bg-body-tertiary border text-body fw-normal px-3 py-2"><code>&amp;?</code> callback</span>\r
</div>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-alert">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Component</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbAlert</code></h2>\r
        <p class="text-body-secondary mb-0">\r
            Displays contextual feedback and optionally provides a dismiss action with an animated close transition.\r
        </p>\r
    </header>\r
\r
    <dl class="row gy-2 mb-0">\r
        <dt class="col-sm-3 fw-semibold">Markup</dt>\r
        <dd class="col-sm-9 mb-0"><code>&lt;ngb-alert&gt;</code></dd>\r
    </dl>\r
\r
    <h3 class="h5 mt-4 mb-3">Inputs</h3>\r
    <div class="table-responsive">\r
        <table class="table table-sm align-middle">\r
            <thead><tr><th>Input</th><th>Binding</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
            <tbody>\r
                <tr><td><code>animation</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td><td>Enables the close transition.</td></tr>\r
                <tr><td><code>dismissible</code></td><td><code>&lt;?</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Shows the dismiss button.</td></tr>\r
                <tr><td><code>type</code></td><td><code>@?</code></td><td><code>string</code></td><td><code>"warning"</code></td><td>Sets the Bootstrap contextual type.</td></tr>\r
            </tbody>\r
        </table>\r
    </div>\r
\r
    ...
    <div class="table-responsive">\r
        <table class="table table-sm align-middle mb-0">\r
            <thead><tr><th>Output</th><th>Binding</th><th>Payload</th><th>Emitted when</th></tr></thead>\r
            <tbody>\r
                <tr><td><code>closed</code></td><td><code>&amp;?</code></td><td>None</td><td>The close transition finishes.</td></tr>\r
            </tbody>\r
        </table>\r
    </div>\r
</section>\r
\r
<section class="pb-4 mb-4 border-bottom" ngb-scroll-spy-fragment="ngb-alert-config">\r
    <header class="mb-3">\r
        <p class="small fw-semibold text-primary mb-1">Service</p>\r
        <h2 class="h3 mb-2"><code class="text-body">NgbAlertConfig</code></h2>\r
        <p class="text-body-secondary mb-0">Provides application-wide defaults for alert instances.</p>\r
    </header>\r
\r
    <h3 class="h5 mt-4 mb-3">Properties</h3>\r
    <div class="table-responsive">\r
        <table class="table table-sm align-middle mb-0">\r
            <thead><tr><th>Property</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>\r
            <tbody>\r
                <tr><td><code>animation</code></td><td><code>boolean</code></td><td><code>$config.animation</code></td><td>Default close animation state.</td></tr>\r
                <tr><td><code>dismissible</code></td><td><code>boolean</code></td><td><code>true</code></td><td>Default dismissible state.</td></tr>\r
                <tr><td><code>type</code></td><td><code>string</code></td><td><code>"warning"</code></td><td>Default contextual type.</td></tr>\r
            </tbody>\r
        </table>\r
    </div>\r
</section>\r
`),e.put(`src/app/features/lib/components/tooltip-triggers/tooltip-triggers.component.html`,`<p class="mb-3">Custom events can be paired as <code>mouseenter:mouseleave</code>.</p>\r
...
`),e.put(`src/app/features/lib/components/tooltip-global/tooltip-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
    <div>\r
        <p class="fw-semibold mb-1">Global defaults used by this example</p>\r
...
`),e.put(`src/app/features/lib/components/tooltip-template/tooltip-template.component.html`,`<ng-template ng-ref="example.contentTemplate">\r
...
`),e.put(`src/app/features/lib/components/tooltip-placements/tooltip-placements.component.html`,`<div class="d-flex flex-wrap gap-2">\r
...
`),e.put(`src/app/features/lib/components/tooltip-custom-target/tooltip-custom-target.component.html`,`<div class="d-flex flex-wrap align-items-baseline gap-2">\r
...
`),e.put(`src/app/features/lib/components/tooltip-custom-class/tooltip-custom-class.component.html`,`<button type="button" class="btn btn-outline-primary" ngb-tooltip="'A custom skin layered on top of Bootstrap tooltip variables.'" tooltip-class="docs-tooltip-custom">\r
    Tooltip with custom class\r
</button>\r
`),e.put(`src/app/features/lib/components/tooltip-delays/tooltip-delays.component.html`,`<p>Move the pointer into the tooltip before its close delay expires to keep it open.</p>\r
<div class="d-flex flex-wrap gap-2">\r
...
`),e.put(`src/app/features/lib/components/tooltip-body/tooltip-body.component.html`,`<div class="overflow-hidden border rounded p-4" style="max-width: 24rem">\r
...
`),e.put(`src/app/features/lib/components/tooltip-autoclose/tooltip-autoclose.component.html`,`<ng-template ng-ref="example.contentTemplate">\r
...
`),e.put(`src/app/features/lib/components/tooltip-context/tooltip-context.component.html`,`<ng-template ng-ref="example.contentTemplate" let-greeting="greeting">{{ greeting }}, <strong>{{ example.name }}</strong>!</ng-template>\r
\r
...
`),e.put(`src/app/features/lib/components/timepicker-validation/timepicker-validation.component.html`,`<p>Select a time between 12:00 and 13:59.</p>\r
\r
...
`),e.put(`src/app/features/lib/components/toast-management/toast-management.component.html`,`<div class="d-flex flex-wrap gap-2 mb-3">\r
...
`),e.put(`src/app/features/lib/components/timepicker-custom-steps/timepicker-custom-steps.component.html`,`<div class="d-flex flex-column align-items-start gap-3">\r
...
`),e.put(`src/app/features/lib/components/timepicker-i18n/timepicker-i18n.component.html`,`<div class="alert alert-light border" role="note">\r
...
`),e.put(`src/app/features/lib/components/timepicker-custom-adapter/timepicker-custom-adapter.component.html`,`<p>This adapter represents the application model as an <code>HH:mm:ss</code> string.</p>\r
...
`),e.put(`src/app/features/lib/components/template-header-toast/template-header-toast.component.html`,`<div class="toast-container position-static">\r
...
`),e.put(`src/app/features/lib/components/template-results-typeahead/template-results-typeahead.component.html`,`<ng-template ng-ref="example.resultTemplate" let-result="result" let-term="term">\r
...
`),e.put(`src/app/features/lib/components/striped-progress-bar/striped-progress-bar.component.html`,`<div class="vstack gap-3">\r
...
`),e.put(`src/app/features/lib/components/spinners-timepicker/spinners-timepicker.component.html`,`<div class="d-flex flex-column align-items-start gap-3">\r
...
`),e.put(`src/app/features/lib/components/simple-progressbar/simple-progressbar.component.html`,`<div class="vstack gap-3">\r
...
`),e.put(`src/app/features/lib/pages/datepicker-calendars-page/datepicker-calendars-page.component.html`,`<div class="alert alert-light border mb-5" role="note">\r
    <div class="d-flex gap-3 align-items-start">\r
        <i class="bi bi-calendar3 text-primary mt-1" aria-hidden="true"></i>\r
        <div>\r
            <h2 class="h5 mb-2">Calendar implementations</h2>\r
            <p class="text-body-secondary mb-0"><code>NgbDatepicker</code> delegates date calculations to the abstract <code>NgbCalendar</code>. Gregorian is the default, but each instance can receive a calendar and its matching internationalization strategy.</p>\r
        </div>\r
    </div>\r
</div>\r
\r
<section id="calendar-hebrew" class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="calendar-hebrew">\r
    <h2 class="h3 mb-2">Hebrew</h2><p class="text-body-secondary mb-4"><code>NgbCalendarHebrew</code> with <code>NgbDatepickerI18nHebrew</code>, including Hebrew month names and numerals.</p>\r
    <div dir="rtl" class="d-inline-block"><ngb-datepicker ng-model="$.calendars.hebrew.date" calendar="$.calendars.hebrew.calendar" i18n="$.calendars.hebrew.i18n"></ngb-datepicker></div>\r
</section>\r
\r
<section id="calendar-jalali" class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="calendar-jalali">\r
    <h2 class="h3 mb-2">Jalali</h2><p class="text-body-secondary mb-4"><code>NgbCalendarPersian</code> performs Persian calendar calculations; the labels are supplied independently through <code>NgbDatepickerI18n</code>.</p>\r
    <div dir="rtl" class="d-inline-block"><ngb-datepicker ng-model="$.calendars.jalali.date" calendar="$.calendars.jalali.calendar" i18n="$.calendars.jalali.i18n"></ngb-datepicker></div>\r
</section>\r
\r
<section id="calendar-islamic-civil" class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="calendar-islamic-civil">\r
    <h2 class="h3 mb-2">Islamic Civil</h2><p class="text-body-secondary mb-4"><code>NgbCalendarIslamicCivil</code> uses the tabular civil Hijri calculation.</p>\r
    <div dir="rtl" class="d-inline-block"><ngb-datepicker ng-model="$.calendars.islamicCivil.date" calendar="$.calendars.islamicCivil.calendar" i18n="$.calendars.islamicCivil.i18n"></ngb-datepicker></div>\r
</section>\r
\r
<section id="calendar-islamic-umalqura" class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="calendar-islamic-umalqura">\r
    <h2 class="h3 mb-2">Islamic Umm al-Qura</h2><p class="text-body-secondary mb-4"><code>NgbCalendarIslamicUmalqura</code> uses the Umm al-Qura calendar data while sharing the Hijri presentation layer.</p>\r
    <div dir="rtl" class="d-inline-block"><ngb-datepicker ng-model="$.calendars.islamicUmalqura.date" calendar="$.calendars.islamicUmalqura.calendar" i18n="$.calendars.islamicUmalqura.i18n"></ngb-datepicker></div>\r
</section>\r
\r
<section id="calendar-buddhist" class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="calendar-buddhist">\r
    <h2 class="h3 mb-2">Buddhist</h2><p class="text-body-secondary mb-4"><code>NgbCalendarBuddhist</code> keeps Gregorian month rules and presents years in the Buddhist era.</p>\r
    <ngb-datepicker ng-model="$.calendars.buddhist.date" calendar="$.calendars.buddhist.calendar" i18n="$.calendars.buddhist.i18n"></ngb-datepicker>\r
</section>\r
\r
<section id="calendar-ethiopian" class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="calendar-ethiopian">\r
    <h2 class="h3 mb-2">Ethiopian</h2><p class="text-body-secondary mb-4"><code>NgbCalendarEthiopian</code> and <code>NgbDatepickerI18nAmharic</code> include the thirteenth Ethiopian month.</p>\r
    <ngb-datepicker ng-model="$.calendars.ethiopian.date" calendar="$.calendars.ethiopian.calendar" i18n="$.calendars.ethiopian.i18n"></ngb-datepicker>\r
</section>\r
\r
<section id="calendar-intergalactic" class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="calendar-intergalactic">\r
    <h2 class="h3 mb-2">Intergalactic Standard <span class="small fw-normal text-body-secondary">(just for fun)</span></h2>\r
    <p class="text-body-secondary mb-4">A custom <code>NgbDatepickerI18n</code> translates Gregorian labels into the Standard Galactic Alphabet. The calendar math stays Gregorian—space-time remains someone else's problem.</p>\r
    <ngb-datepicker ng-model="$.calendars.intergalactic.date" calendar="$.calendars.intergalactic.calendar" i18n="$.calendars.intergalactic.i18n"></ngb-datepicker>\r
</section>\r
`),e.put(`src/app/features/lib/components/simple-typeahead/simple-typeahead.component.html`,`<label class="form-label" for="simple-typeahead">Search for a state</label>\r
...
<p class="small text-body-secondary mt-2 mb-0">Model: <strong>{{ example.model || 'empty' }}</strong></p>\r
`),e.put(`src/app/features/lib/components/simple-dropdown/simple-dropdown.component.html`,`<div class="d-flex flex-wrap align-items-center gap-3 py-5">\r
...
`),e.put(`src/app/features/lib/components/simple-collapse/simple-collapse.component.html`,`<div class="d-flex flex-wrap gap-2 mb-3">\r
    <button\r
        type="button"\r
...
`),e.put(`src/app/features/lib/components/simple-alert/simple-alert.component.html`,`<ngb-alert type="primary" dismissible="false" animation="false">\r
    <strong>Heads up!</strong> This is a simple alert rendered with NgbJS.\r
</ngb-alert>\r
`),e.put(`src/app/features/lib/components/self-closing-alert/self-closing-alert.component.html`,`<div class="d-flex align-items-center justify-content-between gap-3 mb-3">\r
...
`),e.put(`src/app/features/lib/components/selecting-nav/selecting-nav.component.html`,`<div class="d-flex flex-wrap gap-2 mb-3">\r
...
`),e.put(`src/app/features/lib/components/scrollspy-service-demo/scrollspy-service-demo.component.html`,`<div class="d-flex flex-wrap align-items-center gap-2 mb-3">\r
...
`),e.put(`src/app/features/lib/components/scrollspy-menu-items/scrollspy-menu-items.component.html`,`<div class="row g-3">\r
...
`),e.put(`src/app/features/lib/components/rating-form/rating-form.component.html`,`<form name="example.form" novalidate>\r
...
`),e.put(`src/app/features/lib/components/seconds-timepicker/seconds-timepicker.component.html`,`<div class="d-flex flex-column align-items-start gap-3">\r
...
`),e.put(`src/app/features/lib/components/rating-decimal/rating-decimal.component.html`,`<ng-template ng-ref="example.heartTemplate" let-fill="fill">\r
...
`),e.put(`src/app/features/lib/components/rating-events/rating-events.component.html`,`<ngb-rating rate="example.selected" rate-change="example.setSelected($event)" hover="example.setHovered($event)" leave="example.setHovered(0)" readonly="example.readonly"></ngb-rating>\r
<hr>\r
<dl class="row mb-3">\r
...
`),e.put(`src/app/features/lib/components/simple-nav/simple-nav.component.html`,`<ul\r
    ngb-nav\r
    ng-ref="example.nav"\r
    ng-ref-read="ngbNav"\r
    active-id="example.activeId"\r
...
\r
<div ngb-nav-outlet="example.nav"></div>\r
`),e.put(`src/app/features/lib/components/range-popup-datepicker/range-popup-datepicker.component.html`,`<ng-template ng-ref="example.day" let-date let-focused="focused">\r
...
`),e.put(`src/app/features/lib/components/rating-global/rating-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
...
`),e.put(`src/app/features/lib/components/rating-custom-template/rating-custom-template.component.html`,`<p>Bootstrap Icons are rendered through a child <code>ng-template</code>.</p>\r
...
`),e.put(`src/app/features/lib/components/progressbar-global/progressbar-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
...
`),e.put(`src/app/features/lib/components/range-datepicker/range-datepicker.component.html`,`<ng-template ng-ref="example.day" let-date let-focused="focused">\r
...
<p class="small text-body-secondary mt-3 mb-0">From <code>{{ example.fromDate | json }}</code> to <code>{{ example.toDate | json }}</code></p>\r
`),e.put(`src/app/features/lib/components/progress-bars-stacked/progress-bars-stacked.component.html`,`<ngb-progressbar-stacked>\r
...
`),e.put(`src/app/features/lib/components/prevent-autohide-toast/prevent-autohide-toast.component.html`,`<p>Show the toast and keep the pointer over it to pause autohide.</p>\r
\r
...
`),e.put(`src/app/features/lib/components/progress-height/progress-height.component.html`,`<div class="vstack gap-3">\r
...
`),e.put(`src/app/features/lib/components/popup-datepicker/popup-datepicker.component.html`,`<label class="form-label" for="popup-datepicker-input">Choose a date</label>\r
...
`),e.put(`src/app/features/lib/components/popover-triggers/popover-triggers.component.html`,`<p class="mb-3">Custom events can be paired as <code>mouseenter:mouseleave</code>.</p>\r
...
`),e.put(`src/app/features/lib/components/popover-template/popover-template.component.html`,`<ng-template ng-ref="example.titleTemplate">\r
...
`),e.put(`src/app/features/lib/components/popover-placements/popover-placements.component.html`,`<div class="d-flex flex-wrap gap-2">\r
...
`),e.put(`src/app/features/lib/components/popover-global/popover-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
...
`),e.put(`src/app/features/lib/components/popover-events/popover-events.component.html`,`<button type="button" class="btn btn-outline-primary" placement="'top'" ngb-popover="'Watch the event log below.'" popover-title="'Visibility events'" shown="example.record('shown')" hidden="example.record('hidden')" ng-ref="example.popover" ng-ref-read="ngbPopover">\r
    Toggle popover\r
</button>\r
\r
<div class="mt-4">\r
...
`),e.put(`src/app/features/lib/components/popover-delays/popover-delays.component.html`,`<p>Move the pointer into the popover before its close delay expires to keep it open.</p>\r
<div class="d-flex flex-wrap gap-2">\r
...
`),e.put(`src/app/features/lib/components/popover-custom-class/popover-custom-class.component.html`,`<button type="button" class="btn btn-outline-primary" ngb-popover="'A small custom skin layered on top of Bootstrap variables.'" popover-title="'NgbJS popover'" popover-class="docs-popover-custom">\r
    Popover with custom class\r
</button>\r
`),e.put(`src/app/features/lib/components/popover-context/popover-context.component.html`,`<ng-template ng-ref="example.contentTemplate" let-greeting="greeting">{{ greeting }}, <strong>{{ example.name }}</strong>!</ng-template>\r
...
`),e.put(`src/app/features/lib/components/popover-manual-control/popover-manual-control.component.html`,`<button type="button" class="btn btn-primary mb-3" ngb-popover="'This target is controlled by the buttons below'" popover-title="'External controls'" triggers="'manual'" auto-close="false" ng-ref="example.popover" ng-ref-read="ngbPopover">\r
    Popover target\r
</button>\r
<div class="d-flex flex-wrap gap-2">\r
...
`),e.put(`src/app/features/lib/components/popover-body/popover-body.component.html`,`<div class="overflow-hidden border rounded p-4" style="max-width: 24rem">\r
    <p class="small text-body-secondary">This container clips overflowing descendants.</p>\r
    <div class="d-flex flex-wrap gap-2">\r
...
`),e.put(`src/app/features/lib/components/popover-autoclose/popover-autoclose.component.html`,`<p>Every popover also closes with <kbd>Esc</kbd>.</p>\r
...
`),e.put(`src/app/features/lib/components/pagination-size/pagination-size.component.html`,`<div class="vstack gap-4">\r
    <div>\r
...
`),e.put(`src/app/features/lib/components/pagination-global/pagination-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
    <div>\r
        <p class="fw-semibold mb-1">Global defaults used by this example</p>\r
        <p class="small text-body-secondary mb-0">\r
...
`),e.put(`src/app/features/lib/components/one-panel-accordion/one-panel-accordion.component.html`,`<div ngb-accordion animation="true" close-others="true" destroy-on-hide="true">\r
...
`),e.put(`src/app/features/lib/components/offcanvas-options/offcanvas-options.component.html`,`<div class="d-flex flex-wrap gap-2">\r
...
`),e.put(`src/app/features/lib/components/offcanvas-global/offcanvas-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
    <div>\r
        <p class="fw-semibold mb-1">Global defaults used by this example</p>\r
        <p class="small text-body-secondary mb-0">\r
...
`),e.put(`src/app/features/lib/components/pagination-alignment/pagination-alignment.component.html`,`<div class="vstack gap-4">\r
    <div>\r
...
`),e.put(`src/app/features/lib/components/popover-custom-target/popover-custom-target.component.html`,`<div class="d-flex flex-wrap align-items-baseline gap-2">\r
...
`),e.put(`src/app/features/lib/components/offcanvas-focus/offcanvas-focus.component.html`,`<p class="text-body-secondary">\r
...
`),e.put(`src/app/features/lib/components/offcanvas-demo-content/offcanvas-demo-content.component.html`,`<div class="offcanvas-header">\r
...
`),e.put(`src/app/features/lib/components/offcanvas-default/offcanvas-default.component.html`,`<button type="button" class="btn btn-primary" ng-click="example.open()">Open default offcanvas</button>\r
\r
...
`),e.put(`src/app/features/lib/components/offcanvas-component-content/offcanvas-component-content.component.html`,`<button type="button" class="btn btn-primary" ng-click="example.open()">Open component offcanvas</button>\r
<p class="small text-body-secondary mt-2 mb-0">{{ example.lastResult }}</p>\r
`),e.put(`src/app/features/lib/components/non-editable-typeahead/non-editable-typeahead.component.html`,`<p>Manual text is not accepted; the model changes only after selecting a suggestion.</p>\r
...
<pre class="mt-3 mb-0">Model: {{ example.model | json }}</pre>\r
`),e.put(`src/app/features/lib/components/nested-scrollspy/nested-scrollspy.component.html`,`<div class="row g-3">\r
    <div class="col-md-8 order-2">\r
        <div\r
            class="bg-body-tertiary border rounded p-3"\r
...
`),e.put(`src/app/features/lib/components/offcanvas-focus-content/offcanvas-focus-content.component.html`,`<div class="offcanvas-header">\r
...
`),e.put(`src/app/features/lib/components/navbar-scrollspy/navbar-scrollspy.component.html`,`<div class="d-flex flex-column">\r
    <div\r
...
`),e.put(`src/app/features/lib/components/navbar-collapse/navbar-collapse.component.html`,`<p class="text-body-secondary mb-3">\r
...
`),e.put(`src/app/features/lib/components/nav-global/nav-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
    <div>\r
        <p class="fw-semibold mb-1">Global defaults used by this example</p>\r
        <p class="small text-body-secondary mb-0">\r
...
`),e.put(`src/app/features/lib/components/multiple-months-datepicker/multiple-months-datepicker.component.html`,`<div class="overflow-auto pb-2">\r
    <ngb-datepicker ng-model="example.date" display-months="2" outside-days="hidden"></ngb-datepicker>\r
</div>\r
`),e.put(`src/app/features/lib/components/modal-stacked-content/modal-stacked-content.component.html`,`<div class="modal-header">\r
...
`),e.put(`src/app/features/lib/components/modal-updatable/modal-updatable.component.html`,`<button type="button" class="btn btn-primary" ng-click="example.open()">Open updatable modal</button>\r
`),e.put(`src/app/features/lib/components/modal-updatable-content/modal-updatable-content.component.html`,`<div class="modal-header">\r
...
`),e.put(`src/app/features/lib/components/modal-stacked/modal-stacked.component.html`,`<button type="button" class="btn btn-primary" ng-click="example.openStack()">Open three modals</button>\r
`),e.put(`src/app/features/lib/components/modal-options/modal-options.component.html`,`<div class="d-flex flex-wrap gap-2">\r
...
`),e.put(`src/app/features/lib/components/modal-global/modal-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
    <div>\r
        <p class="fw-semibold mb-1">Global defaults used by this example</p>\r
        <p class="small text-body-secondary mb-0">\r
...
`),e.put(`src/app/features/lib/components/modal-focus/modal-focus.component.html`,`<p class="text-body-secondary">\r
    The first focusable element receives focus by default. Add <code>ngbAutofocus</code> to choose another target.\r
</p>\r
\r
<div class="d-flex flex-wrap gap-2">\r
...
`),e.put(`src/app/features/lib/components/modal-demo-content/modal-demo-content.component.html`,`<div class="modal-header">\r
...
`),e.put(`src/app/features/lib/components/modal-focus-content/modal-focus-content.component.html`,`<div class="modal-header">\r
...
`),e.put(`src/app/features/lib/components/modal-default/modal-default.component.html`,`<button type="button" class="btn btn-primary" ng-click="example.open()">Open default modal</button>\r
\r
<ng-template ng-ref="content" let-close="close" let-dismiss="dismiss">\r
...
`),e.put(`src/app/features/lib/components/meridian-timepicker/meridian-timepicker.component.html`,`<div class="d-flex flex-column align-items-start gap-3">\r
...
`),e.put(`src/app/features/lib/components/manual-dropdown/manual-dropdown.component.html`,`<div class="d-flex flex-wrap gap-2 mb-3">\r
...
`),e.put(`src/app/features/lib/components/modal-component-content/modal-component-content.component.html`,`<button type="button" class="btn btn-primary" ng-click="example.open()">Open component modal</button>\r
<p class="small text-body-secondary mt-2 mb-0">{{ example.lastResult }}</p>\r
`),e.put(`src/app/features/lib/components/keep-content-nav/keep-content-nav.component.html`,`<ul\r
    ngb-nav\r
    ng-ref="example.nav"\r
    ng-ref-read="ngbNav"\r
    active-id="example.activeId"\r
...
\r
<div ngb-nav-outlet="example.nav"></div>\r
`),e.put(`src/app/features/lib/components/inline-toast/inline-toast.component.html`,`<div class="toast-container position-static d-flex flex-column gap-3">\r
    <div>\r
...
`),e.put(`src/app/features/lib/components/horizontal-collapse/horizontal-collapse.component.html`,`<button\r
    type="button"\r
...
`),e.put(`src/app/features/lib/components/exact-typeahead/exact-typeahead.component.html`,`<label class="form-label" for="exact-typeahead">Search for a state</label>\r
...
<pre class="mt-3 mb-0">Model: {{ example.model | json }}</pre>\r
`),e.put(`src/app/features/lib/components/focus-typeahead/focus-typeahead.component.html`,`<label class="form-label" for="focus-typeahead">Search for a state</label>\r
...
<p class="small text-body-secondary mt-2 mb-0">Model: <strong>{{ example.model || 'empty' }}</strong></p>\r
`),e.put(`src/app/features/lib/components/dynamic-nav/dynamic-nav.component.html`,`<div class="d-flex flex-wrap gap-2 mb-3">\r
...
\r
<div ngb-nav-outlet="example.nav"></div>\r
`),e.put(`src/app/features/lib/components/formatted-typeahead/formatted-typeahead.component.html`,`<label class="form-label" for="formatted-typeahead">Search for a state</label>\r
...
<p class="small text-body-secondary mt-2 mb-0">Model: <strong>{{ example.model || 'empty' }}</strong></p>\r
`),e.put(`src/app/features/lib/components/dropdown-navbar/dropdown-navbar.component.html`,`<nav class="navbar bg-body-tertiary border rounded px-3">\r
...
`),e.put(`src/app/features/lib/components/dropdown-global/dropdown-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
    <div>\r
        <p class="fw-semibold mb-1">Global defaults used by this example</p>\r
        <p class="small text-body-secondary mb-0">\r
...
`),e.put(`src/app/features/lib/components/dropdown-form/dropdown-form.component.html`,`<div ngb-dropdown auto-close="'outside'">\r
...
`),e.put(`src/app/features/lib/components/dropdown-disabled-items/dropdown-disabled-items.component.html`,`<div class="form-check form-switch mb-3">\r
    <input\r
        class="form-check-input"\r
        type="checkbox"\r
        role="switch"\r
...
`),e.put(`src/app/features/lib/components/dropdown-button-groups/dropdown-button-groups.component.html`,`<div class="d-flex flex-wrap gap-3">\r
...
`),e.put(`src/app/features/lib/components/dropdown-body/dropdown-body.component.html`,`<div class="border rounded p-3 overflow-hidden">\r
...
`),e.put(`src/app/features/lib/components/disabled-pagination/disabled-pagination.component.html`,`<div class="form-check form-switch mb-3">\r
...
`),e.put(`src/app/features/lib/components/disabled-datepicker/disabled-datepicker.component.html`,`<div class="form-check form-switch mb-3">\r
...
`),e.put(`src/app/features/lib/components/datepicker-position-target/datepicker-position-target.component.html`,`<div class="row g-3 align-items-end">\r
...
`),e.put(`src/app/features/lib/components/datepicker-i18n/datepicker-i18n.component.html`,`<ngb-datepicker ng-model="example.date" i18n="example.i18n" weekdays="'short'"></ngb-datepicker>\r
`),e.put(`src/app/features/lib/components/datepicker-keyboard/datepicker-keyboard.component.html`,`<p class="small text-body-secondary">Focus the calendar and press <kbd>[</kbd> or <kbd>]</kbd> to navigate by month. The built-in arrow, Home, End and Page keys continue to work.</p>\r
...
`),e.put(`src/app/features/lib/components/datepicker-custom-day/datepicker-custom-day.component.html`,`<ng-template ng-ref="example.customDay" let-date let-data="data" let-selected="selected" let-today="today" let-focused="focused">\r
...
`),e.put(`src/app/features/lib/components/datepicker-global/datepicker-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
...
`),e.put(`src/app/features/lib/components/datepicker-footer/datepicker-footer.component.html`,`<ng-template ng-ref="example.footer">\r
...
<p class="small text-body-secondary mt-3 mb-0">Selected date: <code>{{ example.date | json }}</code></p>\r
`),e.put(`src/app/features/lib/components/custom-nav/custom-nav.component.html`,`<div\r
    ngb-nav\r
    ng-ref="example.nav"\r
    ng-ref-read="ngbNav"\r
    active-id="example.activeId"\r
...
\r
<div ngb-nav-outlet="example.nav"></div>\r
`),e.put(`src/app/features/lib/components/custom-pagination/custom-pagination.component.html`,`<ngb-pagination\r
...
`),e.put(`src/app/features/lib/components/datepicker-custom-adapter/datepicker-custom-adapter.component.html`,`<label class="form-label" for="custom-adapter-input">Date using <code>dd.mm.yyyy</code></label>\r
<div class="input-group" style="max-width: 22rem">\r
...
`),e.put(`src/app/features/lib/components/custom-labels-progressbar/custom-labels-progressbar.component.html`,`<div class="vstack gap-3">\r
...
`),e.put(`src/app/features/lib/components/datepicker-custom-month/datepicker-custom-month.component.html`,`<ng-template ng-ref="example.content" let-datepicker>\r
...
`),e.put(`src/app/features/lib/components/contextual-text-progressbar/contextual-text-progressbar.component.html`,`<div class="vstack gap-3">\r
...
`),e.put(`src/app/features/lib/components/carousel-simple/carousel-simple.component.html`,`<ngb-carousel aria-label="Featured landscapes">\r
...
`),e.put(`src/app/features/lib/components/closeable-toast/closeable-toast.component.html`,`<div class="toast-container position-static">\r
...
`),e.put(`src/app/features/lib/components/carousel-keyboard/carousel-keyboard.component.html`,`<p class="small text-body-secondary mb-3">\r
...
`),e.put(`src/app/features/lib/components/carousel-global/carousel-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
    <div>\r
        <p class="fw-semibold mb-1">Global defaults used by this example</p>\r
        <p class="small text-body-secondary mb-0">\r
...
`),e.put(`src/app/features/lib/components/carousel-controls/carousel-controls.component.html`,`<div class="d-flex flex-column gap-3">\r
    <div class="row g-3">\r
...
`),e.put(`src/app/features/lib/components/basic-scrollspy/basic-scrollspy.component.html`,`<div\r
...
`),e.put(`src/app/features/lib/components/basic-timepicker/basic-timepicker.component.html`,`<div class="d-flex flex-column align-items-start gap-3">\r
    <ngb-timepicker ng-model="example.time"></ngb-timepicker>\r
    <hr class="w-100 my-0">\r
    <pre class="w-100 mb-0">Selected time: {{ example.time | json }}</pre>\r
</div>\r
`),e.put(`src/app/features/lib/components/basic-pagination/basic-pagination.component.html`,`<ngb-pagination\r
    collection-size="70"\r
    page="example.page"\r
    page-change="example.selectPage($event)">\r
</ngb-pagination>\r
...
`),e.put(`src/app/features/lib/components/alert-global/alert-global.component.html`,`<div class="alert alert-light border d-flex align-items-start gap-3" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
    <div>\r
        <p class="fw-semibold mb-1">Global defaults used by this example</p>\r
        <p class="small text-body-secondary mb-0">\r
...
`),e.put(`src/app/features/lib/components/alternative-nav/alternative-nav.component.html`,`<nav\r
    ngb-nav\r
    ng-ref="example.nav"\r
    ng-ref-read="ngbNav"\r
    active-id="example.activeId"\r
...
\r
<div ngb-nav-outlet="example.nav"></div>\r
`),e.put(`src/app/features/lib/components/alert-custom/alert-custom.component.html`,`<ngb-alert type="custom" dismissible="false" animation="false">\r
    <div class="d-flex align-items-start gap-3">\r
...
`),e.put(`src/app/features/lib/components/advanced-pagination/advanced-pagination.component.html`,`<div class="vstack gap-4">\r
    <div>\r
...
`),e.put(`src/app/features/lib/components/basic-rating/basic-rating.component.html`,`<ngb-rating rate="example.rating" rate-change="example.setRating($event)"></ngb-rating>\r
<hr>\r
<p class="mb-0">Rate: <strong>{{ example.rating }}</strong></p>\r
`),e.put(`src/app/features/lib/components/basic-datepicker/basic-datepicker.component.html`,`<ngb-datepicker ng-model="example.date"></ngb-datepicker>\r
<p class="small text-body-secondary mt-3 mb-0">Selected date: <code>{{ example.date | json }}</code></p>\r
`),e.put(`src/app/features/lib/components/alert-closeable/alert-closeable.component.html`,`<div class="d-flex justify-content-end mb-3">\r
...
`),e.put(`src/app/features/lib/components/accordion-toggle-panels/accordion-toggle-panels.component.html`,`<div class="d-flex flex-wrap gap-2 mb-3">\r
...
`),e.put(`src/app/features/lib/components/accordion-content/accordion-content.component.html`,`<div ngb-accordion animation="true" close-others="false" destroy-on-hide="false">\r
...
`),e.put(`src/app/features/lib/components/accordion-simple/accordion-simple.component.html`,`<ng-template ng-ref="templateHeader">\r
...
`),e.put(`src/app/features/home/pages/home-page/home-page.component.html`,`<docs-header show-menu="false"></docs-header>\r
\r
<docs-home-hero></docs-home-hero>\r
\r
<section class="container px-4 text-center">\r
    <div class="row justify-content-center mb-5">\r
        <div class="col-md-10 col-lg-9 col-xl-8">\r
            <p class="small text-body-secondary mb-2">\r
                Install with npm\r
            </p>\r
\r
            <div class="d-flex align-items-center gap-3 rounded-3 border border-secondary bg-black px-3 py-3 text-start shadow-sm">\r
                <code class="flex-grow-1 fs-5 text-light">{{ $.installCommand }}</code>\r
\r
                <docs-copy-button\r
                    value="$.installCommand"\r
                    button-class="text-light"\r
                    aria-label="Copy install command">\r
                </docs-copy-button>\r
            </div>\r
        </div>\r
    </div>\r
</section>\r
`),e.put(`src/app/features/lib/components/accordion-global/accordion-global.component.html`,`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">\r
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>\r
    <div>\r
        <p class="fw-semibold mb-1">Global defaults used by this example</p>\r
        <p class="small text-body-secondary mb-0">\r
...
`),e.put(`src/app/features/guide/pages/why-ngbjs-page/why-ngbjs-page.component.html`,`<article>\r
    <header class="pb-4 mb-5 border-bottom">\r
        <p class="small fw-semibold text-uppercase text-primary mb-2">Guide</p>\r
        <h1 class="display-5 fw-bold lh-sm text-body-emphasis mb-3">Why NgbJS?</h1>\r
        <p class="lead text-body-secondary mb-0">\r
            Because a legacy application can still be critical, actively developed, and expected to\r
            deliver a modern experience.\r
        </p>\r
    </header>\r
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="the-legacy-reality">\r
        <h2 class="h3 mb-3">The legacy reality</h2>\r
        <p class="lead text-body-secondary">\r
            A full migration is not always the next available step.\r
        </p>\r
        <p>\r
            Large AngularJS applications often contain years of business rules, integrations, and\r
            operational knowledge. Replacing them can demand more time, budget, and coordination than a\r
            team currently has, even while users continue to expect new features and current interfaces.\r
        </p>\r
        <p class="mb-0">\r
            Without a modern component library, teams must either stop improving the interface or rebuild\r
            common interactions themselves. Neither option makes the legacy application easier to maintain\r
            or eventually migrate.\r
        </p>\r
    </section>\r
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="before-and-after">\r
        <h2 class="h3 mb-4">From repeated adaptation to a shared model</h2>\r
\r
        <div class="row g-4">\r
            <div class="col-lg-6">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <div class="d-flex align-items-center gap-2 mb-3">\r
                        <i class="bi bi-copy text-body-secondary" aria-hidden="true"></i>\r
                        <h3 class="h5 mb-0">Without NgbJS</h3>\r
                    </div>\r
                    <ul class="text-body-secondary mb-0 ps-3">\r
                        <li class="mb-2">Copy the modern component markup.</li>\r
                        <li class="mb-2">Translate it to AngularJS syntax.</li>\r
                        <li class="mb-2">Rebuild interactions and state by hand.</li>\r
                        <li class="mb-2">Accept incomplete or inconsistent behavior.</li>\r
                        <li>Maintain two unrelated implementations over time.</li>\r
                    </ul>\r
                </div>\r
            </div>\r
\r
            <div class="col-lg-6">\r
                <div class="h-100 rounded-3 border border-primary bg-primary-subtle p-4">\r
                    <div class="d-flex align-items-center gap-2 mb-3">\r
                        <i class="bi bi-link-45deg text-primary" aria-hidden="true"></i>\r
                        <h3 class="h5 mb-0">With NgbJS</h3>\r
                    </div>\r
                    <ul class="mb-0 ps-3">\r
                        <li class="mb-2">Start from a familiar ng-bootstrap API.</li>\r
                        <li class="mb-2">Reuse the same component model and terminology.</li>\r
                        <li class="mb-2">Rely on packaged, documented behavior.</li>\r
                        <li class="mb-2">Reduce differences between both applications.</li>\r
                        <li>Make later migration work more predictable.</li>\r
                    </ul>\r
                </div>\r
            </div>\r
        </div>\r
...
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="what-it-unlocks">\r
        <h2 class="h3 mb-3">What NgbJS unlocks</h2>\r
        <p class="text-body-secondary mb-4">\r
            The value is not only in the components themselves, but in the consistency they create.\r
        </p>\r
\r
        <div class="row g-3">\r
            <div class="col-md-6 col-xl-4">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-window fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">Modern interfaces</h3>\r
                    <p class="small text-body-secondary mb-0">\r
                        Give active AngularJS products current Bootstrap components and interactions.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6 col-xl-4">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-person-check fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">A familiar API</h3>\r
                    <p class="small text-body-secondary mb-0">\r
                        Let ng-bootstrap experience remain useful when developers work in AngularJS.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6 col-xl-4">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-arrows-angle-contract fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">Less divergence</h3>\r
                    <p class="small text-body-secondary mb-0">\r
                        Keep parallel applications closer in terminology, behavior, and implementation.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6 col-xl-4">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-tools fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">Less custom maintenance</h3>\r
                    <p class="small text-body-secondary mb-0">\r
                        Replace one-off, partially implemented components with reusable library behavior.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6 col-xl-4">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-journal-code fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">Transferable knowledge</h3>\r
                    <p class="small text-body-secondary mb-0">\r
                        Share concepts, documentation patterns, and conventions across framework versions.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6 col-xl-4">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-signpost-2 fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">A clearer migration path</h3>\r
                    <p class="small text-body-secondary mb-0">\r
                        Reduce the conceptual changes required when a component eventually moves to Angular.\r
                    </p>\r
                </div>\r
            </div>\r
        </div>\r
...
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="when-to-use-ngbjs">\r
        <h2 class="h3 mb-4">When should you use NgbJS?</h2>\r
\r
        <div class="row g-4">\r
            <div class="col-lg-6">\r
                <div class="h-100 rounded-3 border border-success-subtle bg-success-subtle p-4">\r
                    <div class="d-flex align-items-center gap-2 mb-3">\r
                        <i class="bi bi-check-circle-fill text-success" aria-hidden="true"></i>\r
                        <h3 class="h5 mb-0">A strong fit</h3>\r
                    </div>\r
                    <ul class="mb-0 ps-3">\r
                        <li class="mb-2">Your AngularJS application will remain active.</li>\r
                        <li class="mb-2">A complete migration is not currently realistic.</li>\r
                        <li class="mb-2">Modern and legacy applications must stay consistent.</li>\r
                        <li class="mb-2">Your team already knows ng-bootstrap.</li>\r
                        <li>You want to make a gradual migration less disruptive.</li>\r
                    </ul>\r
                </div>\r
            </div>\r
\r
            <div class="col-lg-6">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <div class="d-flex align-items-center gap-2 mb-3">\r
                        <i class="bi bi-x-circle-fill text-body-secondary" aria-hidden="true"></i>\r
                        <h3 class="h5 mb-0">Probably not the right fit</h3>\r
                    </div>\r
                    <ul class="text-body-secondary mb-0 ps-3">\r
                        <li class="mb-2">You are starting a new application.</li>\r
                        <li class="mb-2">You can use modern Angular and ng-bootstrap directly.</li>\r
                        <li class="mb-2">Your product does not use Bootstrap.</li>\r
                        <li>Your legacy application is already close to retirement.</li>\r
                    </ul>\r
                </div>\r
            </div>\r
        </div>\r
...
\r
    <section class="pb-4" ngb-scroll-spy-fragment="a-bridge-not-a-destination">\r
        <div class="rounded-4 bg-body-tertiary border p-4 p-md-5 text-center">\r
            <i class="bi bi-signpost-split fs-2 text-primary" aria-hidden="true"></i>\r
            <h2 class="h3 mt-3">A bridge, not a destination</h2>\r
            <p class="text-body-secondary mx-auto mb-4" style="max-width: 42rem;">\r
                NgbJS does not make AngularJS the right choice for new products, and it does not replace a\r
                migration strategy. It helps valuable existing applications move forward while that\r
                strategy becomes possible.\r
            </p>\r
            <a class="btn btn-primary" ui-sref="docs.dashboard.accordion">\r
                Explore the components\r
                <i class="bi bi-arrow-right ms-2" aria-hidden="true"></i>\r
            </a>\r
        </div>\r
    </section>\r
</article>\r
`),e.put(`src/app/features/home/components/home-hero/home-hero.component.html`,`<section class="container px-4 py-5 text-center">\r
    <div class="row justify-content-center pt-5 mt-lg-5">\r
        <div class="col-lg-11 col-xl-10">\r
            <p class="h4 fw-bold text-primary mb-4">\r
                NgbJS\r
                <small class="fs-6 fw-normal text-body-secondary ms-2">Beta 1.0</small>\r
            </p>\r
\r
            <h1 class="display-2 fw-bold lh-1 mb-4 text-body-emphasis">\r
                <span class="text-primary">Parity</span> is Priority.\r
            </h1>\r
\r
            <p class="lead fs-4 text-body-secondary mb-0">\r
                ng-bootstrap components and APIs, thoughtfully ported to AngularJS with\r
                Bootstrap-native styling and behavior.\r
            </p>\r
        </div>\r
    </div>\r
\r
    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center mt-5 mb-5">\r
        <a ui-sref="docs.dashboard.introduction" class="btn btn-primary btn-lg px-4">\r
            Get started\r
        </a>\r
\r
        <a ui-sref="docs.dashboard.accordion" class="btn btn-outline-secondary btn-lg px-4">\r
            Documentation\r
        </a>\r
    </div>\r
</section>\r
`),e.put(`src/app/features/guide/pages/philosophy-page/philosophy-page.component.html`,`<article>\r
    <header class="pb-4 mb-5 border-bottom">\r
        <p class="small fw-semibold text-uppercase text-primary mb-2">Guide</p>\r
        <h1 class="display-5 fw-bold lh-sm text-body-emphasis mb-3">Philosophy</h1>\r
        <p class="lead text-body-secondary mb-0">\r
            NgbJS favors a familiar, predictable path between AngularJS and modern Angular.\r
        </p>\r
    </header>\r
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="parity-is-priority">\r
        <div class="rounded-4 bg-primary text-white p-4 p-md-5">\r
            <p class="small fw-semibold text-uppercase opacity-75 mb-3">The guiding principle</p>\r
            <h2 class="display-6 fw-bold mb-3">Parity is Priority.</h2>\r
            <p class="lead mb-0 opacity-75">\r
                The closer NgbJS stays to ng-bootstrap, the less developers need to relearn, rewrite,\r
                or reinterpret when moving between AngularJS and Angular.\r
            </p>\r
        </div>\r
    </section>\r
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="what-parity-means">\r
        <h2 class="h3 mb-3">What parity means</h2>\r
        <p class="text-body-secondary mb-4">\r
            Parity is not limited to matching how a component looks. It is pursued across the entire\r
...
\r
        <div class="row g-3">\r
            <div class="col-md-6">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-braces fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">API parity</h3>\r
                    <p class="text-body-secondary mb-0">\r
                        Components, services, configuration options, and public names should remain\r
                        recognizable to developers coming from ng-bootstrap.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-code-square fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">Syntax parity</h3>\r
                    <p class="text-body-secondary mb-0">\r
                        Templates should express the same intent with as little framework-specific\r
                        translation as possible.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-toggles fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">Behavioral parity</h3>\r
                    <p class="text-body-secondary mb-0">\r
                        Interaction, state, defaults, and edge cases should behave consistently across\r
                        both libraries.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-lightbulb fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">Conceptual parity</h3>\r
                    <p class="text-body-secondary mb-0">\r
                        The same mental model should apply, so knowledge gained in one codebase remains\r
                        useful in the other.\r
                    </p>\r
                </div>\r
            </div>\r
        </div>\r
...
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="familiar-by-design">\r
        <div class="row g-4">\r
            <div class="col-lg-7">\r
                <h2 class="h3 mb-3">Familiar by design</h2>\r
                <p>\r
                    NgbJS does not introduce a different API simply because it runs on AngularJS. When\r
                    ng-bootstrap already provides a well-understood solution, reproducing that solution\r
                    is more valuable than inventing a new abstraction.\r
                </p>\r
                <p class="mb-0">\r
                    Familiarity reduces context switching for teams maintaining both generations of an\r
                    application. Documentation, examples, and previous experience become transferable\r
                    instead of being tied to only one framework.\r
                </p>\r
            </div>\r
\r
            <div class="col-lg-5">\r
                <aside class="h-100 rounded-3 bg-body-tertiary border p-4">\r
                    <p class="h5 mb-3">A simple decision rule</p>\r
                    <blockquote class="mb-0">\r
                        <p class="mb-2">\r
                            If ng-bootstrap users already know how a component should work, NgbJS should\r
                            make that knowledge useful.\r
                        </p>\r
                    </blockquote>\r
                </aside>\r
            </div>\r
...
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="a-migration-bridge">\r
        <h2 class="h3 mb-3">A bridge between codebases</h2>\r
        <p class="text-body-secondary mb-4">\r
            Parity makes day-to-day development easier now and makes a future migration more predictable.\r
        </p>\r
\r
        <div class="row g-3 align-items-stretch text-center">\r
            <div class="col-md">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <span class="badge text-bg-secondary mb-3">Legacy</span>\r
                    <h3 class="h5">AngularJS</h3>\r
                    <p class="small text-body-secondary mb-0">Existing application and business logic</p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-auto d-flex align-items-center justify-content-center">\r
                <i class="bi bi-arrow-right fs-4 text-body-secondary d-none d-md-block" aria-hidden="true"></i>\r
                <i class="bi bi-arrow-down fs-4 text-body-secondary d-md-none" aria-hidden="true"></i>\r
            </div>\r
\r
            <div class="col-md">\r
                <div class="h-100 rounded-3 border border-primary bg-primary-subtle p-4">\r
                    <span class="badge text-bg-primary mb-3">Bridge</span>\r
                    <h3 class="h5">NgbJS</h3>\r
                    <p class="small text-body-secondary mb-0">Familiar components, APIs, and behavior</p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-auto d-flex align-items-center justify-content-center">\r
...
\r
            <div class="col-md">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <span class="badge text-bg-secondary mb-3">Modern</span>\r
                    <h3 class="h5">Angular</h3>\r
                    <p class="small text-body-secondary mb-0">ng-bootstrap and the target architecture</p>\r
                </div>\r
            </div>\r
        </div>\r
    </section>\r
\r
    <section class="pb-4" ngb-scroll-spy-fragment="when-parity-is-hard">\r
        <h2 class="h3 mb-3">When exact parity is difficult</h2>\r
        <p>\r
            AngularJS and Angular have different component models, template syntax, and runtime\r
            capabilities. Small differences are sometimes unavoidable, but they should be deliberate,\r
            limited, and easy to understand.\r
        </p>\r
        <p>\r
            A feature is not rejected only because AngularJS cannot reproduce it directly. NgbJS first\r
            looks for a compatible implementation that preserves the original behavior. Some of those\r
            efforts required supporting libraries such as <code>ngjs-core</code> to provide capabilities\r
            that AngularJS did not have on its own.\r
        </p>\r
\r
        <div class="alert alert-primary d-flex gap-3 mb-0" role="note">\r
            <i class="bi bi-bullseye flex-shrink-0" aria-hidden="true"></i>\r
            <div>\r
                Some parts of ng-bootstrap could be reused directly, while others had to be adapted or\r
                reimplemented for AngularJS. In every case, the goal is to preserve the closest practical\r
                parity in API, intent, and behavior.\r
            </div>\r
        </div>\r
    </section>\r
</article>\r
`),e.put(`src/app/core/layouts/components/menu/menu.component.html`,`<ng-template ng-ref="menuContent">\r
    <nav class="px-3 py-2" aria-label="Documentation navigation">\r
        <section class="mb-4" aria-labelledby="guide-navigation-title">\r
            <h2 id="guide-navigation-title" class="small fw-semibold text-uppercase text-body-secondary px-2 mb-2">\r
                Guide\r
            </h2>\r
\r
            <ul class="nav nav-pills flex-column gap-1">\r
                <li class="nav-item">\r
                    <a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.introduction" ui-sref-active="active">Introduction</a>\r
                </li>\r
                <li class="nav-item">\r
                    <a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.philosophy" ui-sref-active="active">Philosophy</a>\r
                </li>\r
                <li class="nav-item">\r
                    <a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.whyNgbJs" ui-sref-active="active">Why ngb-js</a>\r
                </li>\r
            </ul>\r
        </section>\r
\r
        <section aria-labelledby="components-navigation-title">\r
            <h2 id="components-navigation-title" class="small fw-semibold text-uppercase text-body-secondary px-2 mb-2">\r
                Components\r
            </h2>\r
\r
            <ul class="nav nav-pills flex-column gap-1">\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.accordion" ui-sref-active="active">Accordion</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.alert" ui-sref-active="active">Alert</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.carousel" ui-sref-active="active">Carousel</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.collapse" ui-sref-active="active">Collapse</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.datepicker" ui-sref-active="active">Datepicker</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.dropdown" ui-sref-active="active">Dropdown</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.modal" ui-sref-active="active">Modal</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.nav" ui-sref-active="active">Nav</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.offcanvas" ui-sref-active="active">Offcanvas</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.pagination" ui-sref-active="active">Pagination</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.popover" ui-sref-active="active">Popover</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.progressbar" ui-sref-active="active">Progress bar</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.rating" ui-sref-active="active">Rating</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.scrollspy" ui-sref-active="active">Scrollspy</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.timepicker" ui-sref-active="active">Timepicker</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.toast" ui-sref-active="active">Toast</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.tooltip" ui-sref-active="active">Tooltip</a></li>\r
                <li class="nav-item"><a class="nav-link rounded-2 px-2 py-1" ui-sref="docs.dashboard.typeahead" ui-sref-active="active">Typeahead</a></li>\r
            </ul>\r
        </section>\r
    </nav>\r
</ng-template>\r
\r
<div class="h-100 d-flex flex-column bg-body" ng-if="$.mode === 'mobile'">\r
    <div class="offcanvas-header border-bottom px-4 py-3">\r
        <div>\r
            <h2 id="docs-mobile-menu-title" class="offcanvas-title h5 mb-0">Documentation</h2>\r
            <p class="small text-body-secondary mb-0">ngb-js</p>\r
        </div>\r
\r
        <button\r
            type="button"\r
            class="btn-close"\r
            aria-label="Close menu"\r
            ng-click="$.ngbActiveOffcanvas.dismiss('Cross click')">\r
        </button>\r
    </div>\r
\r
    <div class="offcanvas-body overflow-y-auto p-2">\r
        <ng-container ng-template-outlet="menuContent"></ng-container>\r
    </div>\r
</div>\r
\r
<aside class="d-none d-lg-block w-100 h-100 py-3" ng-if="$.mode === 'desktop'">\r
    <ng-container ng-template-outlet="menuContent"></ng-container>\r
</aside>\r
`),e.put(`src/app/features/lib/components/accordion-custom-header/accordion-custom-header.component.html`,`<div ngb-accordion animation="true" close-others="false" destroy-on-hide="true">\r
...
`),e.put(`src/app/features/guide/pages/introduction-page/introduction-page.component.html`,`<article>\r
    <header class="pb-4 mb-5 border-bottom">\r
        <p class="small fw-semibold text-uppercase text-primary mb-2">Guide</p>\r
        <h1 class="display-5 fw-bold lh-sm text-body-emphasis mb-3">Introduction</h1>\r
        <p class="lead text-body-secondary mb-0">\r
            Modern Bootstrap components for AngularJS, shaped by the API and behavior of ng-bootstrap.\r
        </p>\r
    </header>\r
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="origin">\r
        <div class="row g-4 align-items-stretch">\r
            <div class="col-lg-8">\r
                <h2 class="h3 mb-3">Born from a real legacy application</h2>\r
\r
                <p>\r
                    NgbJS began inside a large AngularJS application that was still essential to the\r
                    business, but too complex to migrate all at once. The application needed to keep\r
                    evolving and deliver a modern interface while staying aligned with another product\r
                    built with modern Angular and ng-bootstrap.\r
                </p>\r
\r
                <p>\r
                    A feature created for the modern application, such as a payment flow, also needed an\r
                    AngularJS counterpart. In the modern codebase, ng-bootstrap provided the components\r
                    and their behavior. In the legacy application, the same work meant copying markup,\r
                    adapting it to the older stack, and rebuilding interactions by hand—often only\r
                    partially.\r
                </p>\r
\r
                <p class="mb-0">\r
                    NgbJS grew out of that repeated translation work: bring the ng-bootstrap experience\r
                    to AngularJS and reduce the distance between both applications.\r
                </p>\r
            </div>\r
\r
            <div class="col-lg-4 d-flex">\r
                <aside class="h-100 w-100 d-flex flex-column justify-content-center rounded-3 bg-body-tertiary border p-4">\r
                    <i class="bi bi-arrow-left-right fs-3 text-primary" aria-hidden="true"></i>\r
                    <p class="h5 mt-3 mb-2">One component model</p>\r
                    <p class="small text-body-secondary mb-0">\r
                        Build familiar experiences across AngularJS and Angular without reinventing every\r
                        component for the legacy application.\r
                    </p>\r
\r
                    <div class="d-grid gap-3 mt-4 pt-4 border-top text-center">\r
                        <div class="rounded-3 border bg-body px-3 py-3">\r
                            <span class="badge rounded-pill bg-primary-subtle text-primary-emphasis">Modern</span>\r
                            <p class="small fw-semibold mt-2 mb-0">Angular + ng-bootstrap</p>\r
                        </div>\r
\r
                        <div class="text-body-secondary lh-1" aria-hidden="true">\r
                            <i class="bi bi-arrow-down-up"></i>\r
                        </div>\r
\r
                        <div class="rounded-3 border bg-body px-3 py-3">\r
                            <span class="badge rounded-pill bg-primary-subtle text-primary-emphasis">Legacy</span>\r
                            <p class="small fw-semibold mt-2 mb-0">AngularJS + NgbJS</p>\r
                        </div>\r
                    </div>\r
                </aside>\r
            </div>\r
...
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="what-is-ngbjs">\r
        <h2 class="h3 mb-3">What is NgbJS?</h2>\r
\r
        <p class="lead text-body-secondary">\r
            NgbJS is a port of ng-bootstrap for AngularJS, designed to preserve its API and behavior as\r
            closely as the differences between the two frameworks allow.\r
        </p>\r
\r
        <p>\r
            It is more than a collection of visually similar components. NgbJS aims to preserve the same\r
            mental model: developers who know ng-bootstrap should recognize its components, services,\r
            options, and interaction patterns, then move between AngularJS and Angular with fewer changes.\r
        </p>\r
\r
        <p class="mb-0">\r
            Features that initially appeared difficult to reproduce were not simply discarded. Supporting\r
            them also led to complementary infrastructure such as <code>ngjs-core</code>, which brings\r
            capabilities required by NgbJS into the AngularJS environment.\r
        </p>\r
    </section>\r
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="who-is-it-for">\r
        <h2 class="h3 mb-3">Who is it for?</h2>\r
        <p class="text-body-secondary mb-4">\r
            NgbJS is intended for teams whose AngularJS applications still need to grow, even when a full\r
            migration is not immediately possible.\r
        </p>\r
\r
        <div class="row g-3">\r
            <div class="col-md-6">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-buildings fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">Long-lived applications</h3>\r
                    <p class="text-body-secondary mb-0">\r
                        Critical AngularJS systems that will remain in production and continue receiving\r
                        features for years.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-layers fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">Mixed technology stacks</h3>\r
                    <p class="text-body-secondary mb-0">\r
                        Products where AngularJS and modern Angular applications must provide consistent\r
                        interfaces and behavior.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-signpost-split fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">Gradual migrations</h3>\r
                    <p class="text-body-secondary mb-0">\r
                        Teams preparing for a future migration while working within current time, budget,\r
                        or architectural constraints.\r
                    </p>\r
                </div>\r
            </div>\r
\r
            <div class="col-md-6">\r
                <div class="h-100 rounded-3 border p-4">\r
                    <i class="bi bi-bootstrap fs-4 text-primary" aria-hidden="true"></i>\r
                    <h3 class="h5 mt-3">ng-bootstrap developers</h3>\r
                    <p class="text-body-secondary mb-0">\r
                        Developers who want familiar Bootstrap components and APIs when moving between\r
                        modern Angular and AngularJS codebases.\r
                    </p>\r
                </div>\r
            </div>\r
        </div>\r
\r
        <div class="alert alert-secondary d-flex gap-3 mt-4 mb-0" role="note">\r
            <i class="bi bi-info-circle-fill flex-shrink-0" aria-hidden="true"></i>\r
            <div>\r
                NgbJS is not a reason to choose AngularJS for a new application. It exists to help\r
                established AngularJS systems modernize and move forward.\r
            </div>\r
        </div>\r
    </section>\r
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="project-status">\r
        <div class="rounded-3 border border-warning-subtle bg-warning-subtle p-4">\r
            <div class="d-flex align-items-center gap-2 mb-2">\r
                <span class="badge text-bg-warning">Beta</span>\r
                <h2 class="h4 mb-0">Project status</h2>\r
            </div>\r
\r
            <p class="mb-0">\r
                NgbJS is in beta because some components are still under review and may contain known bugs\r
                or edge cases that are not yet fully covered. Its syntax and intended behavior follow\r
                ng-bootstrap and are not expected to change as part of this review; ongoing work focuses on\r
                validation, fixes, and bringing each implementation to full parity.\r
            </p>\r
        </div>\r
    </section>\r
\r
    <section class="pb-5 mb-5 border-bottom" ngb-scroll-spy-fragment="installation">\r
        <h2 class="h3 mb-3">Installation</h2>\r
        <p class="text-body-secondary mb-4">\r
            Add NgbJS to your project with your preferred package manager.\r
        </p>\r
\r
        <div class="rounded-3 border overflow-hidden">\r
            <div class="bg-body-tertiary border-bottom px-3 pt-2">\r
                <ul\r
                    class="nav nav-tabs border-bottom-0"\r
                    ngb-nav\r
                    active-id="$.activePackageManager"\r
                    animation="false"\r
                    ng-ref="$.packageManagerNav"\r
                    ng-ref-read="ngbNav">\r
                    <li\r
                        ng-repeat="manager in $.packageManagers track by manager.id"\r
                        ngb-nav-item="{{ manager.id }}">\r
                        <button type="button" ngb-nav-link>{{ manager.name }}</button>\r
\r
                        <ng-template ngb-nav-content>\r
                            <div class="d-flex align-items-center gap-3 bg-black px-3 py-3">\r
                                <code class="flex-grow-1 text-light">{{ manager.command }}</code>\r
                                <docs-copy-button\r
                                    value="manager.command"\r
                                    button-class="text-light"\r
                                    aria-label="Copy {{ manager.name }} install command">\r
                                </docs-copy-button>\r
                            </div>\r
                        </ng-template>\r
                    </li>\r
...
\r
            <div ngb-nav-outlet="$.packageManagerNav"></div>\r
        </div>\r
    </section>\r
\r
    <section class="pb-4" ngb-scroll-spy-fragment="acknowledgements">\r
        <div class="row g-4 align-items-start">\r
            <div class="col-md-auto">\r
                <div class="d-inline-flex align-items-center justify-content-center rounded-circle bg-primary-subtle text-primary" style="width: 3rem; height: 3rem;">\r
                    <i class="bi bi-heart-fill" aria-hidden="true"></i>\r
                </div>\r
            </div>\r
\r
            <div class="col">\r
                <h2 class="h3 mb-3">Built on the work of ng-bootstrap</h2>\r
                <p>\r
                    NgbJS exists thanks to the outstanding work of the\r
                    <a href="https://github.com/ng-bootstrap/ng-bootstrap" target="_blank" rel="noopener noreferrer">ng-bootstrap team and community</a>.\r
                    Its API, architecture, components, and documentation have been the primary reference\r
                    for this port.\r
                </p>\r
                <p>\r
                    Portions of this documentation are adapted from the\r
                    <a href="https://ng-bootstrap.github.io/" target="_blank" rel="noopener noreferrer">official ng-bootstrap documentation</a>,\r
                    licensed under\r
                    <a href="https://creativecommons.org/licenses/by/3.0/" target="_blank" rel="noopener noreferrer">CC BY 3.0</a>.\r
                    Changes were made to reflect AngularJS, the NgbJS API, and this project's examples.\r
                </p>\r
                <p>\r
                    Parts of NgbJS are derived from and adapted from the ng-bootstrap source code, used under\r
                    the terms of its\r
                    <a href="https://github.com/ng-bootstrap/ng-bootstrap/blob/master/LICENSE" target="_blank" rel="noopener noreferrer">MIT License</a>.\r
                </p>\r
                <p class="text-body-secondary mb-0">\r
                    NgbJS is an independent project and is not part of the official ng-bootstrap project.\r
                    It is built with deep respect and gratitude for the people who created and continue to\r
                    maintain the original library.\r
                </p>\r
            </div>\r
        </div>\r
    </section>\r
</article>\r
`),e.put(`src/app/core/layouts/pages/menu-abstract-page/menu-abstract-page.component.html`,`<div class="vh-100 d-flex flex-column overflow-hidden">\r
    <docs-header></docs-header>\r
\r
    <main class="container-fluid flex-grow-1 overflow-hidden px-0">\r
        <section class="row g-0 h-100">\r
            <div class="col-lg-3 col-xl-2 d-none d-lg-block h-100 overflow-y-auto bg-body-tertiary border-end">\r
                <docs-menu mode="desktop"></docs-menu>\r
            </div>\r
\r
            <div\r
                id="docs-content-scroll"\r
                class="col-12 col-lg-9 col-xl-10 h-100 overflow-y-auto"\r
                ngb-scroll-spy\r
                root-margin="0px 0px -60%">\r
                <div class="row g-0 min-vh-100">\r
                    <div class="col-12 col-xl-9 d-flex flex-column min-vh-100">\r
                        <div class="container-xl flex-grow-1 px-3 px-md-4 px-xl-5 py-4 py-lg-5">\r
                            <docs-title-heading></docs-title-heading>\r
                            <ui-view></ui-view>\r
                        </div>\r
\r
                        <docs-footer></docs-footer>\r
                    </div>\r
\r
                    <docs-page-outline class="col-xl-3 d-none d-xl-block border-start"></docs-page-outline>\r
                </div>\r
            </div>\r
        </section>\r
    </main>\r
</div>\r
`),e.put(`src/app/core/layouts/components/footer/footer.component.html`,`<footer class="border-top bg-body-tertiary">\r
    <div class="container-xl px-3 px-md-4 px-xl-5 py-4">\r
        <div class="row justify-content-center">\r
            <div class="col-lg-10 col-xxl-8 text-center">\r
                <a class="d-inline-flex align-items-center justify-content-center gap-2 fw-semibold text-body text-decoration-none mb-2" ui-sref="docs.home">\r
                    <span class="d-inline-flex align-items-center justify-content-center rounded-2 bg-primary text-white p-2">\r
                        <i class="bi bi-braces" aria-hidden="true"></i>\r
                    </span>\r
                    <span>ngb-js</span>\r
                </a>\r
                <p class="small text-body-secondary mb-0">\r
                    An independent AngularJS port. Not affiliated with or endorsed by the ng-bootstrap team.\r
                </p>\r
\r
                <hr class="mx-auto my-3" style="max-width: 4rem;">\r
\r
                <div class="small text-body-secondary">\r
                    <p class="mb-2">\r
                        Portions of the code are derived from\r
                        <a href="https://github.com/ng-bootstrap/ng-bootstrap" target="_blank" rel="noopener noreferrer">ng-bootstrap</a>\r
                        under the\r
                        <a href="https://github.com/ng-bootstrap/ng-bootstrap/blob/master/LICENSE" target="_blank" rel="noopener noreferrer">MIT License</a>.\r
                    </p>\r
                    <p class="mb-0">\r
                        Portions of this documentation are adapted from the\r
                        <a href="https://ng-bootstrap.github.io/" target="_blank" rel="noopener noreferrer">ng-bootstrap documentation</a>\r
                        under\r
                        <a href="https://creativecommons.org/licenses/by/3.0/" target="_blank" rel="noopener noreferrer">CC BY 3.0</a>.\r
                        Changes were made for AngularJS and NgbJS.\r
                    </p>\r
                </div>\r
            </div>\r
        </div>\r
...
`),e.put(`src/app/core/layouts/components/header/header.component.html`,`<ng-template ng-ref="searchModal" ng-ref-read="ngTemplate">\r
    <div class="modal-header border-bottom-0 pb-0">\r
        <div>\r
            <h2 class="modal-title fs-5">Search documentation</h2>\r
            <p class="small text-body-secondary mb-0">Find components, guides and examples.</p>\r
        </div>\r
    </div>\r
\r
    <div class="modal-body pt-3">\r
        <label class="visually-hidden" for="docs-search">Search documentation</label>\r
        <div class="input-group input-group-lg">\r
            <span class="input-group-text bg-body border-end-0">\r
                <i class="bi bi-search text-body-secondary" aria-hidden="true"></i>\r
            </span>\r
            <input id="docs-search" class="form-control border-start-0 ps-0" type="search" placeholder="Search the docs..." autocomplete="off" autofocus>\r
        </div>\r
\r
        <div class="d-flex align-items-center justify-content-between mt-3">\r
            <small class="text-body-secondary">Start typing to see results</small>\r
            <kbd>ESC</kbd>\r
        </div>\r
    </div>\r
</ng-template>\r
\r
<ng-template ng-ref="themeChanger">\r
    <button class="btn btn-link text-body btn-lg d-inline-flex align-items-center justify-content-center" ng-click="$.themeService.toggle()" type="button" aria-label="Toggle color theme">\r
        <i ng-if="$.themeService.activeTheme == $.themes.dark" class="bi bi-moon-fill" aria-hidden="true"></i>\r
        <i ng-if="$.themeService.activeTheme == $.themes.light" class="bi bi-brightness-high-fill" aria-hidden="true"></i>\r
    </button>\r
\r
    <div class="vr mx-1 d-none d-sm-block"></div>\r
\r
    <a\r
        class="btn btn-link text-body btn-lg d-none d-sm-inline-flex align-items-center justify-content-center"\r
        href="https://github.com/IonCna/ngb-js"\r
        target="_blank"\r
        rel="noopener noreferrer"\r
        aria-label="NgbJS GitHub repository">\r
        <i class="bi bi-github" aria-hidden="true"></i>\r
    </a>\r
</ng-template>\r
\r
<header class="navbar sticky-top container-fluid px-2 px-sm-3 py-2 bg-body-tertiary border-bottom shadow-sm">\r
    <section class="row w-100 g-2 align-items-center d-none d-lg-flex">\r
        <div class="col-3">\r
            <a class="navbar-brand d-inline-flex align-items-center gap-2 mb-0" ui-sref="docs.home">\r
                <span class="fw-bold">ngb-js</span>\r
                <span class="badge text-bg-primary rounded-pill">Docs</span>\r
            </a>\r
        </div>\r
\r
        <div class="col-6 d-flex justify-content-center">\r
            <button ng-click="$.openModal()" class="btn btn-outline-secondary w-75 d-inline-flex justify-content-between align-items-center text-body-secondary" type="button">\r
                <span>\r
                    <i class="bi bi-search me-2" aria-hidden="true"></i>\r
                    <span>Search documentation</span>\r
                </span>\r
\r
                <span class="d-flex align-items-center gap-1">\r
                    <kbd>CTRL</kbd>\r
                    <kbd>K</kbd>\r
                </span>\r
            </button>\r
...
\r
        <div class="col-3 d-flex align-items-center justify-content-end">\r
            <ng-container ng-template-outlet="themeChanger">\r
            </ng-container>\r
        </div>\r
    </section>\r
\r
    <section class="d-flex w-100 align-items-center d-lg-none">\r
        <button ng-click="$.menuService.toggleMenu()" class="btn btn-link text-body btn-lg d-inline-flex align-items-center justify-content-center" type="button" aria-label="Open navigation menu">\r
                <i class="bi bi-list" aria-hidden="true"></i>\r
        </button>\r
\r
        <a class="navbar-brand fw-bold ms-1 me-auto mb-0" ui-sref="docs.home">ngb-js</a>\r
\r
        <div class="d-flex align-items-center">\r
            <button ng-click="$.openModal()" class="btn btn-link text-body btn-lg d-inline-flex align-items-center justify-content-center" type="button" aria-label="Open search">\r
                <i class="bi bi-search" aria-hidden="true"></i>\r
            </button>\r
\r
            <ng-container ng-template-outlet="themeChanger">\r
            </ng-container>\r
