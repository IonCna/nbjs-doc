...
`,Yb=`import type { IComponentController, IComponentOptions } from "angular";
...
`,Zb=`<ngb-alert type="custom" dismissible="false" animation="false">
...
`,Qb=`<div class="alert alert-light border d-flex align-items-start gap-3" role="note">
...
`,$b=`import type { IComponentController, IComponentOptions } from "angular";
...
`,ex=`<div class="d-flex align-items-center justify-content-between gap-3 mb-3">
    <p class="small text-body-secondary mb-0">
...
`,tx=`import type { INgbAlert } from "ngb-js";
...
`,nx=`<ngb-alert type="primary" dismissible="false" animation="false">
    <strong>Heads up!</strong> This is a simple alert rendered with NgbJS.
</ngb-alert>
`,rx=class e{examples={simple:{html:nx},closeable:{html:Jb,typescript:Yb},selfClosing:{html:ex,typescript:tx},custom:{html:Zb,css:Xb},global:{html:Qb,typescript:$b}};static get $name(){return`docsAlertExamplesPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/alert-examples-page/alert-examples-page.component.html`,controllerAs:`$`}}},ix=class e{static get $name(){return`docsAccordionApiPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/accordion-api-page/accordion-api-page.component.html`,controllerAs:`$`}}},ax=`<div ngb-accordion animation="true" close-others="false" destroy-on-hide="false">
...
`,sx=`<div ngb-accordion animation="true" close-others="false" destroy-on-hide="true">
...
`,cx=`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>
    <div>
        <p class="fw-semibold mb-1">Global defaults used by this example</p>
        <p class="small text-body-secondary mb-0">
...
`,ux=`<ng-template ng-ref="templateHeader">
...
`,dx=`<div class="d-flex flex-wrap gap-2 mb-3">
...
`,px=`<div ngb-accordion animation="true" close-others="true" destroy-on-hide="true">
...
`,mx=class e{examples={simple:{html:ux},onePanel:{html:px},togglePanels:{html:dx,typescript:fx},customHeader:{html:sx},content:{html:ax,typescript:ox},global:{html:cx,typescript:lx}};static get $name(){return`docsAccordionExamplesPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/accordion-examples-page/accordion-examples-page.component.html`,controllerAs:`$`}}},hx=class e{static get $name(){return`docsCarouselApiPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/carousel-api-page/carousel-api-page.component.html`,controllerAs:`$`}}},gx=`<div class="d-flex flex-column gap-3">
    <div class="row g-3">
        <div class="col-sm-6">
...
`,_x=`import type { IAugmentedJQuery, IComponentController, IComponentOptions, ITimeoutService } from "angular";
...
`,vx=`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>
    <div>
        <p class="fw-semibold mb-1">Global defaults used by this example</p>
        <p class="small text-body-secondary mb-0">
...
`,bx=`<p class="small text-body-secondary mb-3">
...
`,xx=`<ngb-carousel aria-label="Featured landscapes">
...
`,Sx=class e{examples={simple:{html:xx},keyboard:{html:bx},controls:{html:gx,typescript:_x},global:{html:vx,typescript:yx}};static get $name(){return`docsCarouselExamplesPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/carousel-examples-page/carousel-examples-page.component.html`,controllerAs:`$`}}},Cx=class e{static get $name(){return`docsCollapseApiPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/collapse-api-page/collapse-api-page.component.html`,controllerAs:`$`}}},wx=`<button
    type="button"
...
`,Ex=`<p class="text-body-secondary mb-3">
...
`,Ox=`<div class="d-flex flex-wrap gap-2 mb-3">
    <button
        type="button"
...
`,qx=`<ng-template ng-ref="example.customDay" let-date let-data="data" let-selected="selected" let-today="today" let-focused="focused">
...
`,Jx=`import "@/features/lib/components/datepicker-custom-day/datepicker-custom-day.component.css";
...
`,Xx=`<ng-template ng-ref="example.content" let-datepicker>
...
`,Zx=`import "@/features/lib/components/datepicker-custom-month/datepicker-custom-month.component.css";
import type { IComponentController, IComponentOptions } from "angular";
...
`,hS=`<ng-template ng-ref="example.day" let-date let-focused="focused">
...
`,vS=`<ng-template ng-ref="example.day" let-date let-focused="focused">
...
<p class="small text-body-secondary mt-3 mb-0">From <code>{{ example.fromDate | json }}</code> to <code>{{ example.toDate | json }}</code></p>
`,yS=`import "@/features/lib/components/range-popup-datepicker/range-popup-datepicker.component.css";
import type { IComponentController, IComponentOptions } from "angular";
import { NgbCalendarGregorian, NgbDate } from "ngb-js";
...
`,CS=`<div class="d-flex flex-wrap gap-3">
...
`,wS=`<div class="form-check form-switch mb-3">
    <input
        class="form-check-input"
        type="checkbox"
        role="switch"
...
`,ES=`<div ngb-dropdown auto-close="'outside'">
...
`,OS=`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>
    <div>
        <p class="fw-semibold mb-1">Global defaults used by this example</p>
        <p class="small text-body-secondary mb-0">
...
`,AS=`<nav class="navbar bg-body-tertiary border rounded px-3">
...
`,jS=`<div class="d-flex flex-wrap gap-2 mb-3">
...
`,NS=`<div class="d-flex flex-wrap align-items-center gap-3 py-5">
...
`,PS=class e{examples={simple:{html:NS},manual:{html:jS,typescript:MS},buttonGroups:{html:CS},disabledItems:{html:wS,typescript:TS},form:{html:ES,typescript:DS},body:{html:SS},navbar:{html:AS},global:{html:OS,typescript:kS}};static get $name(){return`docsDropdownExamplesPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/dropdown-examples-page/dropdown-examples-page.component.html`,controllerAs:`$`}}},FS=class e{static get $name(){return`docsModalApiPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/modal-api-page/modal-api-page.component.html`,controllerAs:`$`}}},IS=`<button type="button" class="btn btn-primary" ng-click="example.open()">Open component modal</button>
...
`,RS=`<button type="button" class="btn btn-primary" ng-click="example.open()">Open default modal</button>
...
`,HS=`<p class="text-body-secondary">
...
`,KS=`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>
    <div>
        <p class="fw-semibold mb-1">Global defaults used by this example</p>
        <p class="small text-body-secondary mb-0">
...
`,JS=`.modal-window-custom .modal-content {
...
`,YS=`<div class="d-flex flex-wrap gap-2">
...
`,XS=`import "@/features/lib/components/modal-options/modal-options.component.css";
import type { IComponentController, IComponentOptions } from "angular";
import { ModalDemoContentComponent } from "@/features/lib/components/modal-demo-content/modal-demo-content.component"
...
`,ZS=`<button type="button" class="btn btn-primary" ng-click="example.openStack()">Open three modals</button>
`,QS=`import type { IComponentController, IComponentOptions } from "angular";
...
`,tC=`<button type="button" class="btn btn-primary" ng-click="example.open()">Open updatable modal</button>
...
<div ngb-nav-outlet="example.nav"></div>
`,dC=`import "@/features/lib/components/custom-nav/custom-nav.component.css";
import type { IComponentController, IComponentOptions } from "angular";
...
`,fC=`<div class="d-flex flex-wrap gap-2 mb-3">
...
`,vC=`<div class="d-flex flex-wrap gap-2 mb-3">
...
`,SC=`<div class="d-flex align-items-start gap-3">
    <div
        ngb-nav
        ng-ref="example.nav"
        ng-ref-read="ngbNav"
...
`,wC=class e{examples={simple:{html:bC,typescript:xC},alternative:{html:sC,typescript:cC},vertical:{html:SC,typescript:CC},selecting:{html:vC,typescript:yC},keepContent:{html:mC,typescript:hC},dynamic:{html:fC,typescript:pC},custom:{html:uC,typescript:dC,css:lC},global:{html:gC,typescript:_C}};static get $name(){return`docsNavExamplesPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/nav-examples-page/nav-examples-page.component.html`,controllerAs:`$`}}},TC=class e{static get $name(){return`docsOffcanvasApiPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/offcanvas-api-page/offcanvas-api-page.component.html`,controllerAs:`$`}}},EC=`<button type="button" class="btn btn-primary" ng-click="example.open()">Open component offcanvas</button>
<p class="small text-body-secondary mt-2 mb-0">{{ example.lastResult }}</p>
...
`,OC=`<button type="button" class="btn btn-primary" ng-click="example.open()">Open default offcanvas</button>
...
`,MC=`<p class="text-body-secondary">
    The first focusable element receives focus by default. Add <code>ngbAutofocus</code> to choose another target.
</p>
...
`,IC=`<div class="alert alert-light border d-flex gap-3 align-items-start" role="note">
    <i class="bi bi-gear text-primary mt-1" aria-hidden="true"></i>
    <div>
        <p class="fw-semibold mb-1">Global defaults used by this example</p>
        <p class="small text-body-secondary mb-0">
...
`,zC=`<div class="d-flex flex-wrap gap-2">
...
`,BC=`import "@/features/lib/components/offcanvas-options/offcanvas-options.component.css";
import type { IComponentController, IComponentOptions } from "angular";
import { OffcanvasDemoContentComponent } from "@/features/lib/components/offcanvas-demo-content/offcanvas-demo-content.component"
...
`,YC=`<div class="form-check form-switch mb-3">
...
`,rw=class e{examples={basic:{html:GC,typescript:KC},advanced:{html:UC,typescript:WC},custom:{html:qC,typescript:JC},size:{html:tw,typescript:nw},alignment:{html:ZC,typescript:QC},disabled:{html:YC,typescript:XC},global:{html:$C,typescript:ew}};static get $name(){return`docsPaginationExamplesPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/pagination-examples-page/pagination-examples-page.component.html`,controllerAs:`$`}}},iw=class e{static get $name(){return`docsPopoverApiPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/popover-api-page/popover-api-page.component.html`,controllerAs:`$`}}},aw=`<p>Every popover also closes with <kbd>Esc</kbd>.</p>
...
`,uw=`import type { IComponentController, IComponentOptions } from "angular";
import type { NgbPopover } from "ngb-js";
...
`,fw=`<button type="button" class="btn btn-outline-primary" ngb-popover="'A small custom skin layered on top of Bootstrap variables.'" popover-title="'NgbJS popover'" popover-class="docs-popover-custom">
    Popover with custom class
</button>
`,pw=`import "@/features/lib/components/popover-custom-class/popover-custom-class.component.css";
import type { IComponentController, IComponentOptions } from "angular";
...
`,zw=`import type { IComponentController, IComponentOptions } from "angular";
...
`,Gw=`import type { IComponentController, IComponentOptions } from "angular";
...
`,Zw=`<p>Bootstrap Icons are rendered through a child <code>ng-template</code>.</p>
...
<hr>
<p class="mb-0">Rate: <strong>{{ example.rating }}</strong></p>
`,Qw=`import "@/features/lib/components/rating-custom-template/rating-custom-template.component.css";
import type { IComponentController, IComponentOptions } from "angular";
...
`,eT=`<ng-template ng-ref="example.heartTemplate" let-fill="fill">
...
`,tT=`import "@/features/lib/components/rating-decimal/rating-decimal.component.css";
import type { IComponentController, IComponentOptions } from "angular";
import type { TemplateRef } from "ngjs-core";
...
`,rT=`import type { IComponentController, IComponentOptions } from "angular";
...
`,aT=`import type { IComponentController, IComponentOptions, IFormController } from "angular";
...
`,sT=`import type { IComponentController, IComponentOptions } from "angular";
...
`,fT=`<div class="d-flex flex-column">
    <div
...
`,mT=`<div class="d-flex flex-wrap align-items-center gap-2 mb-3">
...
`,hT=`import type { IAugmentedJQuery, IComponentController, IComponentOptions } from "angular";
...
`,gT=class e{examples={basic:{html:uT},menuItems:{html:dT},nested:{html:pT},navbar:{html:fT},service:{html:mT,typescript:hT}};static get $name(){return`docsScrollspyExamplesPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/scrollspy-examples-page/scrollspy-examples-page.component.html`,controllerAs:`$`}}},_T=class e{static get $name(){return`docsTimepickerApiPage`}static get $factory(){return{controller:e,templateUrl:`/src/app/features/lib/pages/timepicker-api-page/timepicker-api-page.component.html`,controllerAs:`$`}}},vT=`<p>This adapter represents the application model as an <code>HH:mm:ss</code> string.</p>
...
`,TT=`import type { IComponentController, IComponentOptions } from "angular";
import type { NgbTimeStruct } from "ngb-js";
...
`,kT=`import type { IComponentController, IComponentOptions } from "angular";
import type { NgbTimeStruct } from "ngb-js";
...
<hr>
<pre class="w-100 mb-0">Selected time: {{ example.time | json }}</pre>
`,NT=`import type { IComponentController, IComponentOptions, IDirective, INgModelController } from "angular";
import type { NgbTimeStruct } from "ngb-js";
...
`,LT=`import type { IComponentController, IComponentOptions, IPromise, ITimeoutService } from "angular";
...
`,zT=`import type { IComponentController, IComponentOptions } from "angular";
...
`,UT=`import type { IComponentController, IComponentOptions, ITimeoutService } from "angular";
...
`,$T=`import type { IComponentController, IComponentOptions } from "angular";
...
`,tE=`<button type="button" class="btn btn-outline-primary" ngb-tooltip="'A custom skin layered on top of Bootstrap tooltip variables.'" tooltip-class="docs-tooltip-custom">
    Tooltip with custom class
</button>
`,nE=`import "@/features/lib/components/tooltip-custom-class/tooltip-custom-class.component.css";
import type { IComponentController, IComponentOptions } from "angular";
...
`,cE=`import type { IComponentController, IComponentOptions } from "angular";
...
`,wE=`import type { IComponentController, IComponentOptions } from "angular";
...
<pre class="mt-3 mb-0">Model: {{ example.model | json }}</pre>
`,AE=`import type { IComponentController, IComponentOptions } from "angular";
import type { TemplateRef } from "ngjs-core";
import { debounceTime, map, type OperatorFunction } from "rxjs";
...
<p class="small text-body-secondary mt-2 mb-0">Model: <strong>{{ example.model || 'empty' }}</strong></p>
`,ME=`import type { IComponentController, IComponentOptions, IHttpService } from "angular";
