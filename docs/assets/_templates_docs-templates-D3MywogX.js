import{n as e,t}from"./angular-noCWnJ_q.js";e(t()).default.module(`docs.templates`,[]).run([`$templateCache`,function(e){e.put(`src/app/shared/components/title-heading/title-heading.component.html`,`<header class="mb-4 mb-lg-5" ng-if="$.visible">
    <div class="pt-2 pb-4">
