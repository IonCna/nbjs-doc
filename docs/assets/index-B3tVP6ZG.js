...
`,mx=class e{examples={simple:{html:ux},onePanel:{html:px},togglePanels:{html:dx,typescript:fx},customHeader:{html:sx},content:{html:ax,typescript:ox},global:{html:cx,typescript:lx}};static get $name(){return`docsAccordionExamplesPage`}static get $factory(){return{controller:e,templateUrl:`accordion-examples-page.component-7c1ad343.html`,controllerAs:`$`}}},hx=class e{static get $name(){return`docsCarouselApiPage`}static get $factory(){return{controller:e,templateUrl:`carousel-api-page.component-965012ed.html`,controllerAs:`$`}}},gx=`<div class="d-flex flex-column gap-3">\r
    <div class="row g-3">\r
...
`,Sx=class e{examples={simple:{html:xx},keyboard:{html:bx},controls:{html:gx,typescript:_x},global:{html:vx,typescript:yx}};static get $name(){return`docsCarouselExamplesPage`}static get $factory(){return{controller:e,templateUrl:`carousel-examples-page.component-d6242745.html`,controllerAs:`$`}}},Cx=class e{static get $name(){return`docsCollapseApiPage`}static get $factory(){return{controller:e,templateUrl:`collapse-api-page.component-40bae877.html`,controllerAs:`$`}}},wx=`<button\r
    type="button"\r
...
`,PS=class e{examples={simple:{html:NS},manual:{html:jS,typescript:MS},buttonGroups:{html:CS},disabledItems:{html:wS,typescript:TS},form:{html:ES,typescript:DS},body:{html:SS},navbar:{html:AS},global:{html:OS,typescript:kS}};static get $name(){return`docsDropdownExamplesPage`}static get $factory(){return{controller:e,templateUrl:`dropdown-examples-page.component-ff4fe9ac.html`,controllerAs:`$`}}},FS=class e{static get $name(){return`docsModalApiPage`}static get $factory(){return{controller:e,templateUrl:`modal-api-page.component-6b40d5bf.html`,controllerAs:`$`}}},IS=`<button type="button" class="btn btn-primary" ng-click="example.open()">Open component modal</button>\r
...
`,rw=class e{examples={basic:{html:GC,typescript:KC},advanced:{html:UC,typescript:WC},custom:{html:qC,typescript:JC},size:{html:tw,typescript:nw},alignment:{html:ZC,typescript:QC},disabled:{html:YC,typescript:XC},global:{html:$C,typescript:ew}};static get $name(){return`docsPaginationExamplesPage`}static get $factory(){return{controller:e,templateUrl:`pagination-examples-page.component-7fda2ca9.html`,controllerAs:`$`}}},iw=class e{static get $name(){return`docsPopoverApiPage`}static get $factory(){return{controller:e,templateUrl:`popover-api-page.component-429bc48b.html`,controllerAs:`$`}}},aw=`<p>Every popover also closes with <kbd>Esc</kbd>.</p>\r
...
`,Kw=class e{examples={simple:{html:Bw,typescript:Vw},contextual:{html:Mw,typescript:Nw},striped:{html:Ww,typescript:Gw},labels:{html:Rw,typescript:zw},height:{html:Iw,typescript:Lw},stacked:{html:Hw,typescript:Uw},global:{html:Pw,typescript:Fw}};static get $name(){return`docsProgressbarExamplesPage`}static get $factory(){return{controller:e,templateUrl:`progressbar-examples-page.component-dc104fde.html`,controllerAs:`$`}}},qw=class e{static get $name(){return`docsRatingApiPage`}static get $factory(){return{controller:e,templateUrl:`rating-api-page.component-64204213.html`,controllerAs:`$`}}},Jw=`<ngb-rating rate="example.rating" rate-change="example.setRating($event)"></ngb-rating>\r
<hr>\r
...
`,gT=class e{examples={basic:{html:uT},menuItems:{html:dT},nested:{html:pT},navbar:{html:fT},service:{html:mT,typescript:hT}};static get $name(){return`docsScrollspyExamplesPage`}static get $factory(){return{controller:e,templateUrl:`scrollspy-examples-page.component-bb3c59a8.html`,controllerAs:`$`}}},_T=class e{static get $name(){return`docsTimepickerApiPage`}static get $factory(){return{controller:e,templateUrl:`timepicker-api-page.component-9ad97a30.html`,controllerAs:`$`}}},vT=`<p>This adapter represents the application model as an <code>HH:mm:ss</code> string.</p>\r
